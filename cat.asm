 ...
 419:	85 d2                	test   %edx,%edx
{
 ...
 447:	f7 f1                	div    %ecx
 449:	0f b6 92 9c 09 00 00 	movzbl 0x99c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 94 09 00 00       	mov    $0x994,%ebx
        while(*s != 0){
...
void* pmalloc(){
 ...
 814:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 817:	68 ad 09 00 00       	push   $0x9ad
 81c:	6a 01                	push   $0x1
 81e:	e8 8d fc ff ff       	call   4b0 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 823:	8b 1d 40 0f 00 00    	mov    0xf40,%ebx
 829:	83 c4 10             	add    $0x10,%esp
 82c:	85 db                	test   %ebx,%ebx
 82e:	75 0e                	jne    83e <pmalloc+0x2e>
 830:	eb 2e                	jmp    860 <pmalloc+0x50>
 ...
 863:	ff 35 0c 0d 00 00    	pushl  0xd0c
 869:	e8 7c fb ff ff       	call   3ea <sbrk>
 86e:	a3 40 0f 00 00       	mov    %eax,0xf40
    plink_freep->next = 0;
 873:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 879:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 87c:	8b 1d 40 0f 00 00    	mov    0xf40,%ebx
 ...
 899:	e8 4c fb ff ff       	call   3ea <sbrk>
    pl->next = 0;
 89e:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
    pl->isFree = 0;
 8a4:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    return pl->next;
 8ab:	83 c4 10             	add    $0x10,%esp
 8ae:	31 db                	xor    %ebx,%ebx
 8b0:	eb a0                	jmp    852 <pmalloc+0x42>
...
int protect_page(void* ap){
 ...
 8c0:	a1 40 0f 00 00       	mov    0xf40,%eax
int protect_page(void* ap){
 8c5:	55                   	push   %ebp
...
int protect_page(void* ap){
 8ca:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 8cd:	74 13                	je     8e2 <protect_page+0x22>
    if(pl == ap){
 8cf:	39 d0                	cmp    %edx,%eax
 8d1:	75 09                	jne    8dc <protect_page+0x1c>
 8d3:	eb 1b                	jmp    8f0 <protect_page+0x30>
 8d5:	8d 76 00             	lea    0x0(%esi),%esi
 8d8:	39 c2                	cmp    %eax,%edx
 8da:	74 14                	je     8f0 <protect_page+0x30>
      // add system call 
      return 1;
    }
    pl = pl->next;
 ...
 8e0:	75 f6                	jne    8d8 <protect_page+0x18>
  }
	return -1;
...
int pfree(void* ap){
 ...
 907:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 90a:	68 b6 09 00 00       	push   $0x9b6
 90f:	6a 01                	push   $0x1
 911:	e8 9a fb ff ff       	call   4b0 <printf>
  struct plink *pl = plink_freep;
 916:	a1 40 0f 00 00       	mov    0xf40,%eax
  while(pl){
 91b:	83 c4 10             	add    $0x10,%esp
 91e:	85 c0                	test   %eax,%eax
 920:	74 18                	je     93a <pfree+0x3a>
    if(pl == ap){
 922:	39 d8                	cmp    %ebx,%eax
 924:	75 0e                	jne    934 <pfree+0x34>
 926:	eb 20                	jmp    948 <pfree+0x48>
 928:	90                   	nop
 929:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 930:	39 c3                	cmp    %eax,%ebx
 932:	74 14                	je     948 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 944:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 948:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;

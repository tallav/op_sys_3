 ...
 419:	85 d2                	test   %edx,%edx
{
 ...
 447:	f7 f1                	div    %ecx
 449:	0f b6 92 80 09 00 00 	movzbl 0x980(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 78 09 00 00       	mov    $0x978,%ebx
        while(*s != 0){
 ...
 681:	a1 00 0d 00 00       	mov    0xd00,%eax
{
 ...
 6bd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6bf:	a3 00 0d 00 00       	mov    %eax,0xd00
}
 6c4:	5b                   	pop    %ebx
 6c5:	5e                   	pop    %esi
 6c6:	5f                   	pop    %edi
 ...
 6d6:	72 ce                	jb     6a6 <free+0x26>
{
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fa:	a3 00 0d 00 00       	mov    %eax,0xd00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 71c:	8b 15 00 0d 00 00    	mov    0xd00,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 47                	jae    7a8 <malloc+0x98>
    ...
    if(p == freep)
 761:	39 05 00 0d 00 00    	cmp    %eax,0xd00
 ...
 786:	e8 f5 fe ff ff       	call   680 <free>
  return freep;
 78b:	8b 15 00 0d 00 00    	mov    0xd00,%edx
 ...
 7b4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7b7:	89 15 00 0d 00 00    	mov    %edx,0xd00
}
 ...
 7d7:	0d 00 00 
 7da:	c7 05 04 0d 00 00 04 	movl   $0xd04,0xd04
 7e1:	0d 00 00 
    base.s.size = 0;
 7e4:	b8 04 0d 00 00       	mov    $0xd04,%eax
 7e9:	c7 05 08 0d 00 00 00 	movl   $0x0,0xd08
 7f0:	00 00 00 
...
void* pmalloc(){
 ...
 817:	8b 1d 20 0f 00 00    	mov    0xf20,%ebx
 81d:	85 db                	test   %ebx,%ebx
 81f:	75 0d                	jne    82e <pmalloc+0x1e>
 821:	eb 5d                	jmp    880 <pmalloc+0x70>
 823:	90                   	nop
 ...
 82a:	75 0f                	jne    83b <pmalloc+0x2b>
 82c:	89 c3                	mov    %eax,%ebx
  while(pl->next){
 82e:	8b 03                	mov    (%ebx),%eax
 830:	8b 53 04             	mov    0x4(%ebx),%edx
 833:	85 c0                	test   %eax,%eax
 835:	75 f1                	jne    828 <pmalloc+0x18>
      pl->isFree = 0;
      return pl;
    }
    pl = pl->next;
 ...
 837:	85 d2                	test   %edx,%edx
 839:	74 15                	je     850 <pmalloc+0x40>
    pl->isFree = 0;
 83b:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    //printf(1, "plink=%d\n", pl->next);
    pl->next->next = 0;
    pl->next->isFree = 0;
    return pl->next;
 ...
 853:	ff 35 e4 0c 00 00    	pushl  0xce4
 859:	e8 8c fb ff ff       	call   3ea <sbrk>
 85e:	89 03                	mov    %eax,(%ebx)
    pl->next->next = 0;
 860:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return pl->next;
 866:	83 c4 10             	add    $0x10,%esp
    pl->next->isFree = 0;
 869:	8b 03                	mov    (%ebx),%eax
 86b:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    return pl->next;
 872:	8b 1b                	mov    (%ebx),%ebx
}
 874:	89 d8                	mov    %ebx,%eax
 ...
 883:	ff 35 e4 0c 00 00    	pushl  0xce4
 889:	e8 5c fb ff ff       	call   3ea <sbrk>
 88e:	a3 20 0f 00 00       	mov    %eax,0xf20
    plink_freep->next = 0;
 893:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 899:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 89c:	8b 1d 20 0f 00 00    	mov    0xf20,%ebx
 8a2:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
 8a9:	89 d8                	mov    %ebx,%eax
 8ab:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 8ae:	c9                   	leave  
 8af:	c3                   	ret    

000008b0 <protect_page>:
...
int protect_page(void* ap){
 ...
 8b6:	a1 20 0f 00 00       	mov    0xf20,%eax
int protect_page(void* ap){
 8bb:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 8be:	85 c0                	test   %eax,%eax
 8c0:	74 18                	je     8da <protect_page+0x2a>
    if(pl == ap){
 8c2:	39 d0                	cmp    %edx,%eax
 8c4:	75 0e                	jne    8d4 <protect_page+0x24>
 8c6:	eb 20                	jmp    8e8 <protect_page+0x38>
 8c8:	90                   	nop
 8c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 8d0:	39 c2                	cmp    %eax,%edx
 8d2:	74 14                	je     8e8 <protect_page+0x38>
      protectPage(pl);
      return 1;
    }
    pl = pl->next;
 ...
 8d8:	75 f6                	jne    8d0 <protect_page+0x20>
  }
	return -1;
 ...
 8eb:	52                   	push   %edx
 8ec:	e8 11 fb ff ff       	call   402 <protectPage>
      return 1;
...
int pfree(void* ap){
  struct plink *pl = plink_freep;
 900:	a1 20 0f 00 00       	mov    0xf20,%eax
int pfree(void* ap){
 905:	55                   	push   %ebp
...
int pfree(void* ap){
 90a:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 90d:	74 13                	je     922 <pfree+0x22>
    if(pl == ap){
 90f:	39 d0                	cmp    %edx,%eax
 911:	75 09                	jne    91c <pfree+0x1c>
 913:	eb 1b                	jmp    930 <pfree+0x30>
 915:	8d 76 00             	lea    0x0(%esi),%esi
 918:	39 c2                	cmp    %eax,%edx
 91a:	74 14                	je     930 <pfree+0x30>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 929:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 930:	c7 42 04 01 00 00 00 	movl   $0x1,0x4(%edx)
      return 1;

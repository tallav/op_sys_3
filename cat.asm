 ...
 419:	85 d2                	test   %edx,%edx
{
 ...
 447:	f7 f1                	div    %ecx
 449:	0f b6 92 ac 09 00 00 	movzbl 0x9ac(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb a4 09 00 00       	mov    $0x9a4,%ebx
        while(*s != 0){
...
void* pmalloc(){
 ...
 863:	ff 35 1c 0d 00 00    	pushl  0xd1c
 ...
 893:	ff 35 1c 0d 00 00    	pushl  0xd1c
...
int protect_page(void* ap){
 ...
 8c6:	a1 40 0f 00 00       	mov    0xf40,%eax
int protect_page(void* ap){
 ...
 8fb:	52                   	push   %edx
 8fc:	e8 01 fb ff ff       	call   402 <protectPage>
      return 1;
...
int pfree(void* ap){
 ...
 917:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 91a:	68 c6 09 00 00       	push   $0x9c6
 91f:	6a 01                	push   $0x1
 921:	e8 8a fb ff ff       	call   4b0 <printf>
  struct plink *pl = plink_freep;
 926:	a1 40 0f 00 00       	mov    0xf40,%eax
  while(pl){
 92b:	83 c4 10             	add    $0x10,%esp
 92e:	85 c0                	test   %eax,%eax
 930:	74 18                	je     94a <pfree+0x3a>
    if(pl == ap){
 932:	39 d8                	cmp    %ebx,%eax
 934:	75 0e                	jne    944 <pfree+0x34>
 936:	eb 20                	jmp    958 <pfree+0x48>
 938:	90                   	nop
 939:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 940:	39 c3                	cmp    %eax,%ebx
 942:	74 14                	je     958 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 954:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 958:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;
 95f:	b8 01 00 00 00       	mov    $0x1,%eax
}
 964:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 967:	c9                   	leave  
 968:	c3                   	ret    

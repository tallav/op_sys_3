...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     126:	68 14 3f 00 00       	push   $0x3f14
     12b:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     131:	e8 ba 38 00 00       	call   39f0 <printf>
  if(mkdir("iputdir") < 0){
     136:	c7 04 24 a7 3e 00 00 	movl   $0x3ea7,(%esp)
  ...
  if(chdir("iputdir") < 0){
     ...
     14c:	68 a7 3e 00 00       	push   $0x3ea7
  ...
  if(unlink("../iputdir") < 0){
     ...
     164:	68 a4 3e 00 00       	push   $0x3ea4
  ...
  if(chdir("/") < 0){
     ...
     178:	68 c9 3e 00 00       	push   $0x3ec9
  ...
  printf(stdout, "iput test ok\n");
     ...
     18c:	68 4c 3f 00 00       	push   $0x3f4c
     191:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "mkdir failed\n");
     1a1:	50                   	push   %eax
     1a2:	50                   	push   %eax
     1a3:	68 80 3e 00 00       	push   $0x3e80
     1a8:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 cb 3e 00 00       	push   $0x3ecb
     1bf:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 af 3e 00 00       	push   $0x3eaf
     1d6:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 8e 3e 00 00       	push   $0x3e8e
     1ed:	ff 35 b4 5f 00 00    	pushl  0x5fb4
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     206:	68 db 3e 00 00       	push   $0x3edb
     20b:	ff 35 b4 5f 00 00    	pushl  0x5fb4
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     22b:	68 a7 3e 00 00       	push   $0x3ea7
    ...
    if(chdir("iputdir") < 0){
     ...
     243:	68 a7 3e 00 00       	push   $0x3ea7
    ...
    if(unlink("../iputdir") < 0){
     ...
     257:	68 a4 3e 00 00       	push   $0x3ea4
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     278:	68 fe 3e 00 00       	push   $0x3efe
     27d:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     ...
     293:	68 af 3e 00 00       	push   $0x3eaf
     298:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "fork failed\n");
     2a8:	51                   	push   %ecx
     2a9:	51                   	push   %ecx
     2aa:	68 c1 4d 00 00       	push   $0x4dc1
     2af:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    exit();
     ...
     2bf:	50                   	push   %eax
     2c0:	50                   	push   %eax
     2c1:	68 ea 3e 00 00       	push   $0x3eea
     2c6:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     ...
     2d6:	52                   	push   %edx
     2d7:	52                   	push   %edx
     2d8:	68 80 3e 00 00       	push   $0x3e80
     2dd:	ff 35 b4 5f 00 00    	pushl  0x5fb4
...
000002f0 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     2f6:	68 10 3f 00 00       	push   $0x3f10
     2fb:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     301:	e8 ea 36 00 00       	call   39f0 <printf>
  if(mkdir("oidir") < 0){
     306:	c7 04 24 1f 3f 00 00 	movl   $0x3f1f,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     32f:	6a 02                	push   $0x2
     331:	68 1f 3f 00 00       	push   $0x3f1f
    ...
    if(fd >= 0){
     ...
     345:	68 a4 4e 00 00       	push   $0x4ea4
     34a:	ff 35 b4 5f 00 00    	pushl  0x5fb4
  ...
  if(unlink("oidir") != 0){
     36a:	c7 04 24 1f 3f 00 00 	movl   $0x3f1f,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     ...
     385:	68 48 3f 00 00       	push   $0x3f48
     38a:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "mkdir oidir failed\n");
     3a5:	51                   	push   %ecx
     3a6:	51                   	push   %ecx
     3a7:	68 25 3f 00 00       	push   $0x3f25
     3ac:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "fork failed\n");
     3bc:	52                   	push   %edx
     3bd:	52                   	push   %edx
     3be:	68 c1 4d 00 00       	push   $0x4dc1
     3c3:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "unlink failed\n");
     3d3:	50                   	push   %eax
     3d4:	50                   	push   %eax
     3d5:	68 39 3f 00 00       	push   $0x3f39
     3da:	ff 35 b4 5f 00 00    	pushl  0x5fb4
...
000003f0 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     3f6:	68 5a 3f 00 00       	push   $0x3f5a
     3fb:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     401:	e8 ea 35 00 00       	call   39f0 <printf>
  fd = open("echo", 0);
     406:	58                   	pop    %eax
     407:	5a                   	pop    %edx
     408:	6a 00                	push   $0x0
     40a:	68 65 3f 00 00       	push   $0x3f65
  ...
  fd = open("doesnotexist", 0);
     ...
     425:	59                   	pop    %ecx
     426:	6a 00                	push   $0x0
     428:	68 7d 3f 00 00       	push   $0x3f7d
  ...
  printf(stdout, "open test ok\n");
     ...
     43c:	68 a8 3f 00 00       	push   $0x3fa8
     441:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "open echo failed!\n");
     451:	50                   	push   %eax
     452:	50                   	push   %eax
     453:	68 6a 3f 00 00       	push   $0x3f6a
     458:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     468:	50                   	push   %eax
     469:	50                   	push   %eax
     46a:	68 8a 3f 00 00       	push   $0x3f8a
     46f:	ff 35 b4 5f 00 00    	pushl  0x5fb4
...
00000480 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     488:	68 b6 3f 00 00       	push   $0x3fb6
     48d:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     493:	e8 58 35 00 00       	call   39f0 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     498:	58                   	pop    %eax
     499:	5a                   	pop    %edx
     49a:	68 02 02 00 00       	push   $0x202
     49f:	68 c7 3f 00 00       	push   $0x3fc7
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4bb:	68 cd 3f 00 00       	push   $0x3fcd
     4c0:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4d3:	6a 0a                	push   $0xa
     4d5:	68 04 40 00 00       	push   $0x4004
     4da:	56                   	push   %esi
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     4ef:	6a 0a                	push   $0xa
     4f1:	68 0f 40 00 00       	push   $0x400f
     4f6:	56                   	push   %esi
  ...
  printf(stdout, "writes ok\n");
     ...
     513:	68 1a 40 00 00       	push   $0x401a
     518:	ff 35 b4 5f 00 00    	pushl  0x5fb4
  ...
  fd = open("small", O_RDONLY);
     ...
     52c:	5e                   	pop    %esi
     52d:	6a 00                	push   $0x0
     52f:	68 c7 3f 00 00       	push   $0x3fc7
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     549:	68 25 40 00 00       	push   $0x4025
     54e:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     554:	e8 97 34 00 00       	call   39f0 <printf>
  i = read(fd, buf, 2000);
     559:	83 c4 0c             	add    $0xc,%esp
     55c:	68 d0 07 00 00       	push   $0x7d0
     561:	68 a0 87 00 00       	push   $0x87a0
     566:	53                   	push   %ebx
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     57d:	68 59 40 00 00       	push   $0x4059
     582:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     588:	e8 63 34 00 00       	call   39f0 <printf>
  close(fd);
     58d:	89 1c 24             	mov    %ebx,(%esp)
     590:	e8 35 33 00 00       	call   38ca <close>
  if(unlink("small") < 0){
     595:	c7 04 24 c7 3f 00 00 	movl   $0x3fc7,(%esp)
  ...
  printf(stdout, "small file test ok\n");
     ...
     5ab:	68 81 40 00 00       	push   $0x4081
     5b0:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     ...
     5c8:	53                   	push   %ebx
     5c9:	68 c8 4e 00 00       	push   $0x4ec8
     5ce:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     ...
     5e1:	53                   	push   %ebx
     5e2:	68 ec 4e 00 00       	push   $0x4eec
     5e7:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "error: open small failed!\n");
     5f7:	51                   	push   %ecx
     5f8:	51                   	push   %ecx
     5f9:	68 3e 40 00 00       	push   $0x403e
     5fe:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "read failed\n");
     60e:	52                   	push   %edx
     60f:	52                   	push   %edx
     610:	68 85 43 00 00       	push   $0x4385
     615:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "unlink small failed\n");
     625:	50                   	push   %eax
     626:	50                   	push   %eax
     627:	68 6c 40 00 00       	push   $0x406c
     62c:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "error: creat small failed!\n");
     63c:	50                   	push   %eax
     63d:	50                   	push   %eax
     63e:	68 e8 3f 00 00       	push   $0x3fe8
     643:	ff 35 b4 5f 00 00    	pushl  0x5fb4
...
00000660 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     668:	68 95 40 00 00       	push   $0x4095
     66d:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     673:	e8 78 33 00 00       	call   39f0 <printf>
  fd = open("big", O_CREATE|O_RDWR);
     678:	58                   	pop    %eax
     679:	5a                   	pop    %edx
     67a:	68 02 02 00 00       	push   $0x202
     67f:	68 0f 41 00 00       	push   $0x410f
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     6a3:	89 1d a0 87 00 00    	mov    %ebx,0x87a0
    if(write(fd, buf, 512) != 512){
     6a9:	68 00 02 00 00       	push   $0x200
     6ae:	68 a0 87 00 00       	push   $0x87a0
     6b3:	56                   	push   %esi
  ...
  fd = open("big", O_RDONLY);
     ...
     6dc:	5e                   	pop    %esi
     6dd:	6a 00                	push   $0x0
     6df:	68 0f 41 00 00       	push   $0x410f
  ...
  n = 0;
    ...
    if(((int*)buf)[0] != n){
     70b:	a1 a0 87 00 00       	mov    0x87a0,%eax
    ...
    i = read(fd, buf, 512);
     ...
     71f:	68 a0 87 00 00       	push   $0x87a0
     724:	56                   	push   %esi
  ...
  if(unlink("big") < 0){
     746:	c7 04 24 0f 41 00 00 	movl   $0x410f,(%esp)
  ...
  printf(stdout, "big files ok\n");
     ...
     760:	68 36 41 00 00       	push   $0x4136
     765:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     ...
     77d:	53                   	push   %ebx
     77e:	68 bf 40 00 00       	push   $0x40bf
     783:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     ...
     793:	50                   	push   %eax
     794:	53                   	push   %ebx
     795:	68 10 4f 00 00       	push   $0x4f10
     79a:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     ...
     7ad:	50                   	push   %eax
     7ae:	68 13 41 00 00       	push   $0x4113
     7b3:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     ...
     7c9:	68 f6 40 00 00       	push   $0x40f6
     7ce:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "error: open big failed!\n");
     7de:	51                   	push   %ecx
     7df:	51                   	push   %ecx
     7e0:	68 dd 40 00 00       	push   $0x40dd
     7e5:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "error: creat big failed!\n");
     7f5:	50                   	push   %eax
     7f6:	50                   	push   %eax
     7f7:	68 a5 40 00 00       	push   $0x40a5
     7fc:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "unlink big failed\n");
     80c:	50                   	push   %eax
     80d:	50                   	push   %eax
     80e:	68 23 41 00 00       	push   $0x4123
     813:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     ...
     834:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     83c:	68 30 4f 00 00       	push   $0x4f30
     841:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     847:	e8 a4 31 00 00       	call   39f0 <printf>
  name[0] = 'a';
     84c:	c6 05 a0 a7 00 00 61 	movb   $0x61,0xa7a0
  name[2] = '\0';
     853:	c6 05 a2 a7 00 00 00 	movb   $0x0,0xa7a2
     85a:	83 c4 10             	add    $0x10,%esp
     85d:	8d 76 00             	lea    0x0(%esi),%esi
    fd = open(name, O_CREATE|O_RDWR);
     860:	83 ec 08             	sub    $0x8,%esp
    name[1] = '0' + i;
     863:	88 1d a1 a7 00 00    	mov    %bl,0xa7a1
     869:	83 c3 01             	add    $0x1,%ebx
    fd = open(name, O_CREATE|O_RDWR);
     86c:	68 02 02 00 00       	push   $0x202
     871:	68 a0 a7 00 00       	push   $0xa7a0
  ...
  name[0] = 'a';
     88b:	c6 05 a0 a7 00 00 61 	movb   $0x61,0xa7a0
  name[2] = '\0';
     892:	c6 05 a2 a7 00 00 00 	movb   $0x0,0xa7a2
     899:	bb 30 00 00 00       	mov    $0x30,%ebx
     89e:	66 90                	xchg   %ax,%ax
    unlink(name);
     8a0:	83 ec 0c             	sub    $0xc,%esp
    name[1] = '0' + i;
     8a3:	88 1d a1 a7 00 00    	mov    %bl,0xa7a1
     8a9:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     8ac:	68 a0 a7 00 00       	push   $0xa7a0
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8c1:	68 58 4f 00 00       	push   $0x4f58
     8c6:	ff 35 b4 5f 00 00    	pushl  0x5fb4
...
000008e0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     8e6:	68 44 41 00 00       	push   $0x4144
     8eb:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     8f1:	e8 fa 30 00 00       	call   39f0 <printf>
  if(mkdir("dir0") < 0){
     8f6:	c7 04 24 50 41 00 00 	movl   $0x4150,(%esp)
  ...
  if(chdir("dir0") < 0){
     ...
     90c:	68 50 41 00 00       	push   $0x4150
  ...
  if(chdir("..") < 0){
     ...
     924:	68 f5 46 00 00       	push   $0x46f5
  ...
  if(unlink("dir0") < 0){
     ...
     938:	68 50 41 00 00       	push   $0x4150
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     94c:	68 8d 41 00 00       	push   $0x418d
     951:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "mkdir failed\n");
     961:	50                   	push   %eax
     962:	50                   	push   %eax
     963:	68 80 3e 00 00       	push   $0x3e80
     968:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "unlink dir0 failed\n");
     978:	50                   	push   %eax
     979:	50                   	push   %eax
     97a:	68 79 41 00 00       	push   $0x4179
     97f:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "chdir .. failed\n");
     98f:	52                   	push   %edx
     990:	52                   	push   %edx
     991:	68 68 41 00 00       	push   $0x4168
     996:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    printf(stdout, "chdir dir0 failed\n");
     9a6:	51                   	push   %ecx
     9a7:	51                   	push   %ecx
     9a8:	68 55 41 00 00       	push   $0x4155
     9ad:	ff 35 b4 5f 00 00    	pushl  0x5fb4
...
000009c0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     9c6:	68 9c 41 00 00       	push   $0x419c
     9cb:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     9d1:	e8 1a 30 00 00       	call   39f0 <printf>
  if(exec("echo", echoargv) < 0){
     9d6:	5a                   	pop    %edx
     9d7:	59                   	pop    %ecx
     9d8:	68 b8 5f 00 00       	push   $0x5fb8
     9dd:	68 65 3f 00 00       	push   $0x3f65
    ...
    printf(stdout, "exec echo failed\n");
     9f0:	50                   	push   %eax
     9f1:	50                   	push   %eax
     9f2:	68 a7 41 00 00       	push   $0x41a7
     9f7:	ff 35 b4 5f 00 00    	pushl  0x5fb4
     ...
     a16:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a60:	57                   	push   %edi
     a61:	68 a0 87 00 00       	push   $0x87a0
     ...
     a7e:	f7 d9                	neg    %ecx
     a80:	38 9c 0b a0 87 00 00 	cmp    %bl,0x87a0(%ebx,%ecx,1)
     ...
     aaa:	68 d6 41 00 00       	push   $0x41d6
     aaf:	6a 01                	push   $0x1
    ...
    close(fds[0]);
     ...
     ade:	66 90                	xchg   %ax,%ax
        buf[i] = seq++;
     ae0:	88 84 03 a0 87 00 00 	mov    %al,0x87a0(%ebx,%eax,1)
     ...
     af6:	68 a0 87 00 00       	push   $0x87a0
  ...
  printf(1, "pipe1 ok\n");
     b3d:	5a                   	pop    %edx
     b3e:	59                   	pop    %ecx
     b3f:	68 fb 41 00 00       	push   $0x41fb
     b44:	6a 01                	push   $0x1
     ...
     b5a:	68 e4 41 00 00       	push   $0x41e4
     b5f:	6a 01                	push   $0x1
    ...
    printf(1, "pipe() failed\n");
     b6b:	57                   	push   %edi
     b6c:	57                   	push   %edi
     b6d:	68 b9 41 00 00       	push   $0x41b9
     b72:	6a 01                	push   $0x1
    ...
    printf(1, "fork() failed\n");
     b7e:	50                   	push   %eax
     b7f:	50                   	push   %eax
     b80:	68 05 42 00 00       	push   $0x4205
     b85:	6a 01                	push   $0x1
    ...
    exit();
     ...
     b91:	56                   	push   %esi
     b92:	56                   	push   %esi
     b93:	68 c8 41 00 00       	push   $0x41c8
     b98:	6a 01                	push   $0x1
...
00000bb0 <preempt>:
{
  ...
  printf(1, "preempt: ");
     bb9:	68 14 42 00 00       	push   $0x4214
     bbe:	6a 01                	push   $0x1
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     c0a:	6a 01                	push   $0x1
     c0c:	68 d9 47 00 00       	push   $0x47d9
     ...
     c21:	50                   	push   %eax
     c22:	50                   	push   %eax
     c23:	68 1e 42 00 00       	push   $0x421e
     c28:	6a 01                	push   $0x1
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c55:	68 a0 87 00 00       	push   $0x87a0
    ...
    printf(1, "preempt read error");
     c6a:	50                   	push   %eax
     c6b:	50                   	push   %eax
     c6c:	68 32 42 00 00       	push   $0x4232
     c71:	6a 01                	push   $0x1
  ...
  printf(1, "kill... ");
     c8e:	58                   	pop    %eax
     c8f:	5a                   	pop    %edx
     c90:	68 45 42 00 00       	push   $0x4245
     c95:	6a 01                	push   $0x1
  ...
  printf(1, "wait... ");
     cb4:	59                   	pop    %ecx
     cb5:	5b                   	pop    %ebx
     cb6:	68 4e 42 00 00       	push   $0x424e
     cbb:	6a 01                	push   $0x1
  ...
  printf(1, "preempt ok\n");
     cd1:	5e                   	pop    %esi
     cd2:	5f                   	pop    %edi
     cd3:	68 57 42 00 00       	push   $0x4257
     cd8:	6a 01                	push   $0x1
...
00000cf0 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     d1e:	68 c1 4d 00 00       	push   $0x4dc1
     d23:	6a 01                	push   $0x1
     ...
     d3b:	68 63 42 00 00       	push   $0x4263
     d40:	6a 01                	push   $0x1
  ...
  printf(1, "exitwait ok\n");
     ...
     d5b:	68 73 42 00 00       	push   $0x4273
     d60:	6a 01                	push   $0x1
...
00000d80 <mem>:
{
  ...
  printf(1, "mem test\n");
     d8b:	68 80 42 00 00       	push   $0x4280
     d90:	6a 01                	push   $0x1
  ...
  if((pid = fork()) == 0){
    ...
    printf(1, "mem ok\n");
     e01:	58                   	pop    %eax
     e02:	5a                   	pop    %edx
     e03:	68 a4 42 00 00       	push   $0x42a4
     e08:	6a 01                	push   $0x1
    ...
    exit();
     ...
     e1b:	68 8a 42 00 00       	push   $0x428a
     e20:	6a 01                	push   $0x1
...
00000e50 <sharedfd>:
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     edf:	68 ac 4f 00 00       	push   $0x4fac
     ee4:	6a 01                	push   $0x1
  ...
  fd = open("sharedfd", 0);
     ...
     f0c:	5a                   	pop    %edx
     f0d:	6a 00                	push   $0x0
     f0f:	68 bb 42 00 00       	push   $0x42bb
  ...
  unlink("sharedfd");
     f81:	c7 04 24 bb 42 00 00 	movl   $0x42bb,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     fa3:	68 c4 42 00 00       	push   $0x42c4
     fa8:	6a 01                	push   $0x1
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fc3:	68 80 4f 00 00       	push   $0x4f80
     fc8:	6a 01                	push   $0x1
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fdd:	68 cc 4f 00 00       	push   $0x4fcc
     fe2:	6a 01                	push   $0x1
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ff9:	53                   	push   %ebx
     ffa:	57                   	push   %edi
     ffb:	68 d1 42 00 00       	push   $0x42d1
    1000:	6a 01                	push   $0x1
...
00001010 <fourfiles>:
{
  ...
  printf(1, "fourfiles test\n");
    1016:	be e6 42 00 00       	mov    $0x42e6,%esi
  for(pi = 0; pi < 4; pi++){
    101b:	31 db                	xor    %ebx,%ebx
{
    101d:	83 ec 34             	sub    $0x34,%esp
  char *names[] = { "f0", "f1", "f2", "f3" };
    1020:	c7 45 d8 e6 42 00 00 	movl   $0x42e6,-0x28(%ebp)
    1027:	c7 45 dc 2f 44 00 00 	movl   $0x442f,-0x24(%ebp)
  printf(1, "fourfiles test\n");
    102e:	68 ec 42 00 00       	push   $0x42ec
    1033:	6a 01                	push   $0x1
  char *names[] = { "f0", "f1", "f2", "f3" };
    1035:	c7 45 e0 33 44 00 00 	movl   $0x4433,-0x20(%ebp)
    103c:	c7 45 e4 e9 42 00 00 	movl   $0x42e9,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
  ...
  for(i = 0; i < 2; i++){
    ...
    108e:	c7 45 d0 e6 42 00 00 	movl   $0x42e6,-0x30(%ebp)
    fd = open(fname, 0);
    ...
    10b8:	68 a0 87 00 00       	push   $0x87a0
    ...
    10ce:	66 90                	xchg   %ax,%ax
        if(buf[j] != '0'+i){
    10d0:	0f be b2 a0 87 00 00 	movsbl 0x87a0(%edx),%esi
  ...
  printf(1, "fourfiles ok\n");
    ...
    1122:	68 2a 43 00 00       	push   $0x432a
    1127:	6a 01                	push   $0x1
    ...
    1171:	68 a0 87 00 00       	push   $0x87a0
    ...
    1186:	68 a0 87 00 00       	push   $0x87a0
    118b:	56                   	push   %esi
    ...
    11a8:	68 0d 43 00 00       	push   $0x430d
    11ad:	6a 01                	push   $0x1
    ...
    11b9:	51                   	push   %ecx
    11ba:	51                   	push   %ecx
    11bb:	68 87 45 00 00       	push   $0x4587
    11c0:	6a 01                	push   $0x1
    ...
    11cc:	53                   	push   %ebx
    11cd:	53                   	push   %ebx
    11ce:	68 c1 4d 00 00       	push   $0x4dc1
    11d3:	6a 01                	push   $0x1
    ...
    11df:	50                   	push   %eax
    11e0:	53                   	push   %ebx
    11e1:	68 19 43 00 00       	push   $0x4319
    11e6:	6a 01                	push   $0x1
    ...
    11f2:	52                   	push   %edx
    11f3:	50                   	push   %eax
    11f4:	68 fc 42 00 00       	push   $0x42fc
    11f9:	6a 01                	push   $0x1
    ...
    1216:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    121b:	68 38 43 00 00       	push   $0x4338
    1220:	6a 01                	push   $0x1
  ...
  printf(1, "createdelete ok\n");
    ...
    1314:	68 4b 43 00 00       	push   $0x434b
    1319:	6a 01                	push   $0x1
    ...
    13b2:	52                   	push   %edx
    13b3:	52                   	push   %edx
    13b4:	68 39 3f 00 00       	push   $0x3f39
    13b9:	6a 01                	push   $0x1
    ...
    13d0:	57                   	push   %edi
    13d1:	68 f8 4f 00 00       	push   $0x4ff8
    13d6:	6a 01                	push   $0x1
    ...
    13e2:	51                   	push   %ecx
    13e3:	51                   	push   %ecx
    13e4:	68 87 45 00 00       	push   $0x4587
    13e9:	6a 01                	push   $0x1
    ...
    13f5:	53                   	push   %ebx
    13f6:	53                   	push   %ebx
    13f7:	68 c1 4d 00 00       	push   $0x4dc1
    13fc:	6a 01                	push   $0x1
    ...
    1410:	50                   	push   %eax
    1411:	57                   	push   %edi
    1412:	68 1c 50 00 00       	push   $0x501c
    1417:	6a 01                	push   $0x1
...
00001430 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1438:	68 5c 43 00 00       	push   $0x435c
    143d:	6a 01                	push   $0x1
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    144b:	68 6d 43 00 00       	push   $0x436d
  ...
  write(fd, "hello", 5);
    ...
    1465:	6a 05                	push   $0x5
    1467:	68 92 43 00 00       	push   $0x4392
    146c:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    147b:	5a                   	pop    %edx
    147c:	6a 02                	push   $0x2
    147e:	68 6d 43 00 00       	push   $0x436d
  ...
  if(unlink("unlinkread") != 0){
    ...
    1498:	68 6d 43 00 00       	push   $0x436d
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14b5:	68 6d 43 00 00       	push   $0x436d
  ...
  write(fd1, "yyy", 3);
    14c4:	6a 03                	push   $0x3
    14c6:	68 ca 43 00 00       	push   $0x43ca
    14cb:	50                   	push   %eax
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    14e1:	68 a0 87 00 00       	push   $0x87a0
    14e6:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    14f8:	80 3d a0 87 00 00 68 	cmpb   $0x68,0x87a0
    14ff:	75 6b                	jne    156c <unlinkread+0x13c>
  if(write(fd, buf, 10) != 10){
    1501:	83 ec 04             	sub    $0x4,%esp
    1504:	6a 0a                	push   $0xa
    1506:	68 a0 87 00 00       	push   $0x87a0
    150b:	53                   	push   %ebx
  ...
  unlink("unlinkread");
    1522:	c7 04 24 6d 43 00 00 	movl   $0x436d,(%esp)
    1529:	e8 c4 23 00 00       	call   38f2 <unlink>
  printf(1, "unlinkread ok\n");
    152e:	58                   	pop    %eax
    152f:	5a                   	pop    %edx
    1530:	68 15 44 00 00       	push   $0x4415
    1535:	6a 01                	push   $0x1
    ...
    1546:	51                   	push   %ecx
    1547:	51                   	push   %ecx
    1548:	68 78 43 00 00       	push   $0x4378
    154d:	6a 01                	push   $0x1
    ...
    1559:	51                   	push   %ecx
    155a:	51                   	push   %ecx
    155b:	68 fc 43 00 00       	push   $0x43fc
    1560:	6a 01                	push   $0x1
    ...
    156c:	53                   	push   %ebx
    156d:	53                   	push   %ebx
    156e:	68 e5 43 00 00       	push   $0x43e5
    1573:	6a 01                	push   $0x1
    ...
    157f:	56                   	push   %esi
    1580:	56                   	push   %esi
    1581:	68 ce 43 00 00       	push   $0x43ce
    1586:	6a 01                	push   $0x1
    ...
    1592:	50                   	push   %eax
    1593:	50                   	push   %eax
    1594:	68 b0 43 00 00       	push   $0x43b0
    1599:	6a 01                	push   $0x1
    ...
    15a5:	50                   	push   %eax
    15a6:	50                   	push   %eax
    15a7:	68 98 43 00 00       	push   $0x4398
    15ac:	6a 01                	push   $0x1
...
000015c0 <linktest>:
{
  ...
  printf(1, "linktest\n");
    15c7:	68 24 44 00 00       	push   $0x4424
    15cc:	6a 01                	push   $0x1
    15ce:	e8 1d 24 00 00       	call   39f0 <printf>
  unlink("lf1");
    15d3:	c7 04 24 2e 44 00 00 	movl   $0x442e,(%esp)
    15da:	e8 13 23 00 00       	call   38f2 <unlink>
  unlink("lf2");
    15df:	c7 04 24 32 44 00 00 	movl   $0x4432,(%esp)
    15e6:	e8 07 23 00 00       	call   38f2 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    15eb:	58                   	pop    %eax
    15ec:	5a                   	pop    %edx
    15ed:	68 02 02 00 00       	push   $0x202
    15f2:	68 2e 44 00 00       	push   $0x442e
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    160c:	6a 05                	push   $0x5
    160e:	68 92 43 00 00       	push   $0x4392
    1613:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    162e:	5b                   	pop    %ebx
    162f:	58                   	pop    %eax
    1630:	68 32 44 00 00       	push   $0x4432
    1635:	68 2e 44 00 00       	push   $0x442e
  ...
  unlink("lf1");
    ...
    164d:	68 2e 44 00 00       	push   $0x442e
    1652:	e8 9b 22 00 00       	call   38f2 <unlink>
  if(open("lf1", 0) >= 0){
    1657:	58                   	pop    %eax
    1658:	5a                   	pop    %edx
    1659:	6a 00                	push   $0x0
    165b:	68 2e 44 00 00       	push   $0x442e
  ...
  fd = open("lf2", 0);
    ...
    1673:	6a 00                	push   $0x0
    1675:	68 32 44 00 00       	push   $0x4432
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1694:	68 a0 87 00 00       	push   $0x87a0
    1699:	50                   	push   %eax
  ...
  if(link("lf2", "lf2") >= 0){
    16b4:	58                   	pop    %eax
    16b5:	5a                   	pop    %edx
    16b6:	68 32 44 00 00       	push   $0x4432
    16bb:	68 32 44 00 00       	push   $0x4432
  ...
  unlink("lf2");
    ...
    16d3:	68 32 44 00 00       	push   $0x4432
    16d8:	e8 15 22 00 00       	call   38f2 <unlink>
  if(link("lf2", "lf1") >= 0){
    16dd:	59                   	pop    %ecx
    16de:	5b                   	pop    %ebx
    16df:	68 2e 44 00 00       	push   $0x442e
    16e4:	68 32 44 00 00       	push   $0x4432
  ...
  if(link(".", "lf1") >= 0){
    ...
    16f8:	68 2e 44 00 00       	push   $0x442e
    16fd:	68 f6 46 00 00       	push   $0x46f6
  ...
  printf(1, "linktest ok\n");
    ...
    1711:	68 cc 44 00 00       	push   $0x44cc
    1716:	6a 01                	push   $0x1
    ...
    1725:	50                   	push   %eax
    1726:	50                   	push   %eax
    1727:	68 36 44 00 00       	push   $0x4436
    172c:	6a 01                	push   $0x1
    ...
    1738:	50                   	push   %eax
    1739:	50                   	push   %eax
    173a:	68 b0 44 00 00       	push   $0x44b0
    173f:	6a 01                	push   $0x1
    ...
    174b:	52                   	push   %edx
    174c:	52                   	push   %edx
    174d:	68 64 50 00 00       	push   $0x5064
    1752:	6a 01                	push   $0x1
    ...
    175e:	50                   	push   %eax
    175f:	50                   	push   %eax
    1760:	68 92 44 00 00       	push   $0x4492
    1765:	6a 01                	push   $0x1
    ...
    1771:	51                   	push   %ecx
    1772:	51                   	push   %ecx
    1773:	68 81 44 00 00       	push   $0x4481
    1778:	6a 01                	push   $0x1
    ...
    1784:	53                   	push   %ebx
    1785:	53                   	push   %ebx
    1786:	68 70 44 00 00       	push   $0x4470
    178b:	6a 01                	push   $0x1
    ...
    1797:	50                   	push   %eax
    1798:	50                   	push   %eax
    1799:	68 3c 50 00 00       	push   $0x503c
    179e:	6a 01                	push   $0x1
    ...
    17aa:	51                   	push   %ecx
    17ab:	51                   	push   %ecx
    17ac:	68 5b 44 00 00       	push   $0x445b
    17b1:	6a 01                	push   $0x1
    ...
    17bd:	50                   	push   %eax
    17be:	50                   	push   %eax
    17bf:	68 49 44 00 00       	push   $0x4449
    17c4:	6a 01                	push   $0x1
    ...
    17db:	bf ab aa aa aa       	mov    $0xaaaaaaab,%edi
{
  ...
  printf(1, "concreate test\n");
    17e3:	68 d9 44 00 00       	push   $0x44d9
    17e8:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 40; i++){
    ...
    1895:	53                   	push   %ebx
    1896:	68 ec 44 00 00       	push   $0x44ec
    189b:	6a 01                	push   $0x1
    ...
    18b3:	53                   	push   %ebx
    18b4:	68 e9 44 00 00       	push   $0x44e9
  ...
  for(i = 0; i < 40; i++){
    18d3:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    18d6:	53                   	push   %ebx
    18d7:	68 e9 44 00 00       	push   $0x44e9
  ...
  fd = open(".", 0);
    ...
    1903:	58                   	pop    %eax
    1904:	6a 00                	push   $0x0
    1906:	68 f6 46 00 00       	push   $0x46f6
  ...
  printf(1, "concreate ok\n");
    ...
    1a53:	68 3e 45 00 00       	push   $0x453e
    1a58:	6a 01                	push   $0x1
    ...
    1a6a:	68 c1 4d 00 00       	push   $0x4dc1
    1a6f:	6a 01                	push   $0x1
    ...
    1a7b:	51                   	push   %ecx
    1a7c:	51                   	push   %ecx
    1a7d:	68 88 50 00 00       	push   $0x5088
    1a82:	6a 01                	push   $0x1
    ...
    1a91:	53                   	push   %ebx
    1a92:	50                   	push   %eax
    1a93:	68 21 45 00 00       	push   $0x4521
    1a98:	6a 01                	push   $0x1
    ...
    1aa7:	56                   	push   %esi
    1aa8:	50                   	push   %eax
    1aa9:	68 08 45 00 00       	push   $0x4508
    1aae:	6a 01                	push   $0x1
...
00001ad0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1ad9:	68 4c 45 00 00       	push   $0x454c
    1ade:	6a 01                	push   $0x1
    1ae0:	e8 0b 1f 00 00       	call   39f0 <printf>
  unlink("x");
    1ae5:	c7 04 24 d9 47 00 00 	movl   $0x47d9,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b28:	68 d9 47 00 00       	push   $0x47d9
  ...
  for(i = 0; i < 100; i++){
    ...
    1b5d:	68 d9 47 00 00       	push   $0x47d9
  ...
  printf(1, "linkunlink ok\n");
    ...
    1b86:	68 61 45 00 00       	push   $0x4561
    1b8b:	6a 01                	push   $0x1
    ...
    1ba3:	68 d9 47 00 00       	push   $0x47d9
    1ba8:	68 5d 45 00 00       	push   $0x455d
    ...
    1bba:	52                   	push   %edx
    1bbb:	52                   	push   %edx
    1bbc:	68 c1 4d 00 00       	push   $0x4dc1
    1bc1:	6a 01                	push   $0x1
...
00001be0 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1be9:	68 70 45 00 00       	push   $0x4570
    1bee:	6a 01                	push   $0x1
    1bf0:	e8 fb 1d 00 00       	call   39f0 <printf>
  unlink("bd");
    1bf5:	c7 04 24 7d 45 00 00 	movl   $0x457d,(%esp)
    1bfc:	e8 f1 1c 00 00       	call   38f2 <unlink>
  fd = open("bd", O_CREATE);
    1c01:	5a                   	pop    %edx
    1c02:	59                   	pop    %ecx
    1c03:	68 00 02 00 00       	push   $0x200
    1c08:	68 7d 45 00 00       	push   $0x457d
  ...
  close(fd);
    ...
    if(link("bd", name) != 0){
    1c3c:	57                   	push   %edi
    1c3d:	68 7d 45 00 00       	push   $0x457d
    name[1] = '0' + (i / 64);
  ...
  unlink("bd");
    ...
    1c73:	68 7d 45 00 00       	push   $0x457d
  ...
  printf(1, "bigdir ok\n");
    ...
    1cbc:	68 bf 45 00 00       	push   $0x45bf
    1cc1:	6a 01                	push   $0x1
    ...
    1cd6:	68 96 45 00 00       	push   $0x4596
    1cdb:	6a 01                	push   $0x1
    ...
    1cea:	68 aa 45 00 00       	push   $0x45aa
    1cef:	6a 01                	push   $0x1
    ...
    1cfb:	50                   	push   %eax
    1cfc:	50                   	push   %eax
    1cfd:	68 80 45 00 00       	push   $0x4580
    1d02:	6a 01                	push   $0x1
...
00001d10 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1d17:	68 ca 45 00 00       	push   $0x45ca
    1d1c:	6a 01                	push   $0x1
    1d1e:	e8 cd 1c 00 00       	call   39f0 <printf>
  unlink("ff");
    1d23:	c7 04 24 53 46 00 00 	movl   $0x4653,(%esp)
    1d2a:	e8 c3 1b 00 00       	call   38f2 <unlink>
  if(mkdir("dd") != 0){
    1d2f:	c7 04 24 f0 46 00 00 	movl   $0x46f0,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d4e:	68 29 46 00 00       	push   $0x4629
  ...
  write(fd, "ff", 2);
    ...
    1d68:	6a 02                	push   $0x2
    1d6a:	68 53 46 00 00       	push   $0x4653
    1d6f:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1d7d:	c7 04 24 f0 46 00 00 	movl   $0x46f0,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d97:	68 04 46 00 00       	push   $0x4604
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1db4:	68 26 46 00 00       	push   $0x4626
  ...
  write(fd, "FF", 2);
    ...
    1dce:	6a 02                	push   $0x2
    1dd0:	68 47 46 00 00       	push   $0x4647
    1dd5:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1de4:	5a                   	pop    %edx
    1de5:	6a 00                	push   $0x0
    1de7:	68 4a 46 00 00       	push   $0x464a
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e06:	68 a0 87 00 00       	push   $0x87a0
    1e0b:	50                   	push   %eax
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e1d:	80 3d a0 87 00 00 66 	cmpb   $0x66,0x87a0
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e33:	5b                   	pop    %ebx
    1e34:	58                   	pop    %eax
    1e35:	68 8a 46 00 00       	push   $0x468a
    1e3a:	68 26 46 00 00       	push   $0x4626
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e52:	68 26 46 00 00       	push   $0x4626
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e6a:	6a 00                	push   $0x0
    1e6c:	68 26 46 00 00       	push   $0x4626
  ...
  if(chdir("dd") != 0){
    ...
    1e84:	68 f0 46 00 00       	push   $0x46f0
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1e9c:	68 be 46 00 00       	push   $0x46be
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1eb4:	68 e4 46 00 00       	push   $0x46e4
  ...
  if(chdir("./..") != 0){
    ...
    1ecc:	68 f3 46 00 00       	push   $0x46f3
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ee4:	6a 00                	push   $0x0
    1ee6:	68 8a 46 00 00       	push   $0x468a
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f05:	68 a0 87 00 00       	push   $0x87a0
    1f0a:	50                   	push   %eax
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1f26:	5b                   	pop    %ebx
    1f27:	6a 00                	push   $0x0
    1f29:	68 26 46 00 00       	push   $0x4626
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f46:	68 3e 47 00 00       	push   $0x473e
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f63:	68 63 47 00 00       	push   $0x4763
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f80:	68 f0 46 00 00       	push   $0x46f0
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f98:	6a 02                	push   $0x2
    1f9a:	68 f0 46 00 00       	push   $0x46f0
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fb2:	6a 01                	push   $0x1
    1fb4:	68 f0 46 00 00       	push   $0x46f0
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fcc:	68 d2 47 00 00       	push   $0x47d2
    1fd1:	68 3e 47 00 00       	push   $0x473e
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1fe9:	68 d2 47 00 00       	push   $0x47d2
    1fee:	68 63 47 00 00       	push   $0x4763
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2006:	68 8a 46 00 00       	push   $0x468a
    200b:	68 29 46 00 00       	push   $0x4629
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2023:	68 3e 47 00 00       	push   $0x473e
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    203b:	68 63 47 00 00       	push   $0x4763
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2053:	68 8a 46 00 00       	push   $0x468a
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    206b:	68 63 47 00 00       	push   $0x4763
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2083:	68 3e 47 00 00       	push   $0x473e
  ...
  if(chdir("dd/ff") == 0){
    ...
    209b:	68 29 46 00 00       	push   $0x4629
  ...
  if(chdir("dd/xx") == 0){
    ...
    20b3:	68 d5 47 00 00       	push   $0x47d5
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20cb:	68 8a 46 00 00       	push   $0x468a
  ...
  if(unlink("dd/ff") != 0){
    ...
    20e3:	68 29 46 00 00       	push   $0x4629
  ...
  if(unlink("dd") == 0){
    ...
    20fb:	68 f0 46 00 00       	push   $0x46f0
  ...
  if(unlink("dd/dd") < 0){
    ...
    2113:	68 05 46 00 00       	push   $0x4605
  ...
  if(unlink("dd") < 0){
    ...
    212b:	68 f0 46 00 00       	push   $0x46f0
  ...
  printf(1, "subdir ok\n");
    ...
    2143:	68 d2 48 00 00       	push   $0x48d2
    2148:	6a 01                	push   $0x1
    ...
    2157:	50                   	push   %eax
    2158:	50                   	push   %eax
    2159:	68 6f 46 00 00       	push   $0x466f
    215e:	6a 01                	push   $0x1
    ...
    216a:	50                   	push   %eax
    216b:	50                   	push   %eax
    216c:	68 ca 46 00 00       	push   $0x46ca
    2171:	6a 01                	push   $0x1
    ...
    217d:	52                   	push   %edx
    217e:	52                   	push   %edx
    217f:	68 95 46 00 00       	push   $0x4695
    2184:	6a 01                	push   $0x1
    ...
    2190:	50                   	push   %eax
    2191:	50                   	push   %eax
    2192:	68 47 47 00 00       	push   $0x4747
    2197:	6a 01                	push   $0x1
    ...
    21a3:	52                   	push   %edx
    21a4:	52                   	push   %edx
    21a5:	68 2c 51 00 00       	push   $0x512c
    21aa:	6a 01                	push   $0x1
    ...
    21b6:	52                   	push   %edx
    21b7:	52                   	push   %edx
    21b8:	68 db 47 00 00       	push   $0x47db
    21bd:	6a 01                	push   $0x1
    ...
    21c9:	51                   	push   %ecx
    21ca:	51                   	push   %ecx
    21cb:	68 9c 51 00 00       	push   $0x519c
    21d0:	6a 01                	push   $0x1
    ...
    21dc:	50                   	push   %eax
    21dd:	50                   	push   %eax
    21de:	68 56 46 00 00       	push   $0x4656
    21e3:	6a 01                	push   $0x1
    ...
    21ef:	51                   	push   %ecx
    21f0:	51                   	push   %ecx
    21f1:	68 2f 46 00 00       	push   $0x462f
    21f6:	6a 01                	push   $0x1
    ...
    2202:	50                   	push   %eax
    2203:	50                   	push   %eax
    2204:	68 f8 46 00 00       	push   $0x46f8
    2209:	6a 01                	push   $0x1
    ...
    2215:	51                   	push   %ecx
    2216:	51                   	push   %ecx
    2217:	68 e4 50 00 00       	push   $0x50e4
    221c:	6a 01                	push   $0x1
    ...
    2228:	53                   	push   %ebx
    2229:	53                   	push   %ebx
    222a:	68 78 51 00 00       	push   $0x5178
    222f:	6a 01                	push   $0x1
    ...
    223b:	50                   	push   %eax
    223c:	50                   	push   %eax
    223d:	68 54 51 00 00       	push   $0x5154
    2242:	6a 01                	push   $0x1
    ...
    224e:	50                   	push   %eax
    224f:	50                   	push   %eax
    2250:	68 b7 47 00 00       	push   $0x47b7
    2255:	6a 01                	push   $0x1
    ...
    2261:	50                   	push   %eax
    2262:	50                   	push   %eax
    2263:	68 9e 47 00 00       	push   $0x479e
    2268:	6a 01                	push   $0x1
    ...
    2274:	50                   	push   %eax
    2275:	50                   	push   %eax
    2276:	68 88 47 00 00       	push   $0x4788
    227b:	6a 01                	push   $0x1
    ...
    2287:	50                   	push   %eax
    2288:	50                   	push   %eax
    2289:	68 6c 47 00 00       	push   $0x476c
    228e:	6a 01                	push   $0x1
    ...
    229a:	50                   	push   %eax
    229b:	50                   	push   %eax
    229c:	68 ad 46 00 00       	push   $0x46ad
    22a1:	6a 01                	push   $0x1
    ...
    22ad:	50                   	push   %eax
    22ae:	50                   	push   %eax
    22af:	68 08 51 00 00       	push   $0x5108
    22b4:	6a 01                	push   $0x1
    ...
    22c0:	53                   	push   %ebx
    22c1:	53                   	push   %ebx
    22c2:	68 0b 46 00 00       	push   $0x460b
    22c7:	6a 01                	push   $0x1
    ...
    22d3:	50                   	push   %eax
    22d4:	50                   	push   %eax
    22d5:	68 bc 50 00 00       	push   $0x50bc
    22da:	6a 01                	push   $0x1
    ...
    22e6:	50                   	push   %eax
    22e7:	50                   	push   %eax
    22e8:	68 ef 45 00 00       	push   $0x45ef
    22ed:	6a 01                	push   $0x1
    ...
    22f9:	50                   	push   %eax
    22fa:	50                   	push   %eax
    22fb:	68 d7 45 00 00       	push   $0x45d7
    2300:	6a 01                	push   $0x1
    ...
    230c:	50                   	push   %eax
    230d:	50                   	push   %eax
    230e:	68 c0 48 00 00       	push   $0x48c0
    2313:	6a 01                	push   $0x1
    ...
    231f:	52                   	push   %edx
    2320:	52                   	push   %edx
    2321:	68 ab 48 00 00       	push   $0x48ab
    2326:	6a 01                	push   $0x1
    ...
    2332:	51                   	push   %ecx
    2333:	51                   	push   %ecx
    2334:	68 c0 51 00 00       	push   $0x51c0
    2339:	6a 01                	push   $0x1
    ...
    2345:	53                   	push   %ebx
    2346:	53                   	push   %ebx
    2347:	68 96 48 00 00       	push   $0x4896
    234c:	6a 01                	push   $0x1
    ...
    2358:	50                   	push   %eax
    2359:	50                   	push   %eax
    235a:	68 7e 48 00 00       	push   $0x487e
    235f:	6a 01                	push   $0x1
    ...
    236b:	50                   	push   %eax
    236c:	50                   	push   %eax
    236d:	68 66 48 00 00       	push   $0x4866
    2372:	6a 01                	push   $0x1
    ...
    237e:	50                   	push   %eax
    237f:	50                   	push   %eax
    2380:	68 4a 48 00 00       	push   $0x484a
    2385:	6a 01                	push   $0x1
    ...
    2391:	50                   	push   %eax
    2392:	50                   	push   %eax
    2393:	68 2e 48 00 00       	push   $0x482e
    2398:	6a 01                	push   $0x1
    ...
    23a4:	50                   	push   %eax
    23a5:	50                   	push   %eax
    23a6:	68 11 48 00 00       	push   $0x4811
    23ab:	6a 01                	push   $0x1
    ...
    23b7:	50                   	push   %eax
    23b8:	50                   	push   %eax
    23b9:	68 f6 47 00 00       	push   $0x47f6
    23be:	6a 01                	push   $0x1
    ...
    23ca:	50                   	push   %eax
    23cb:	50                   	push   %eax
    23cc:	68 23 47 00 00       	push   $0x4723
    23d1:	6a 01                	push   $0x1
    ...
    23dd:	50                   	push   %eax
    23de:	50                   	push   %eax
    23df:	68 0b 47 00 00       	push   $0x470b
    23e4:	6a 01                	push   $0x1
...
000023f0 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    23fd:	68 dd 48 00 00       	push   $0x48dd
    2402:	6a 01                	push   $0x1
    2404:	e8 e7 15 00 00       	call   39f0 <printf>
  unlink("bigwrite");
    2409:	c7 04 24 ec 48 00 00 	movl   $0x48ec,(%esp)
    ...
    2428:	68 ec 48 00 00       	push   $0x48ec
    ...
    243e:	53                   	push   %ebx
    243f:	68 a0 87 00 00       	push   $0x87a0
    2444:	50                   	push   %eax
    ...
    2454:	53                   	push   %ebx
    2455:	68 a0 87 00 00       	push   $0x87a0
    245a:	56                   	push   %esi
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    unlink("bigwrite");
    2476:	c7 04 24 ec 48 00 00 	movl   $0x48ec,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    ...
    2490:	68 1f 49 00 00       	push   $0x491f
    2495:	6a 01                	push   $0x1
    ...
    24a6:	50                   	push   %eax
    24a7:	53                   	push   %ebx
    24a8:	68 0d 49 00 00       	push   $0x490d
    24ad:	6a 01                	push   $0x1
    ...
    24bc:	68 f5 48 00 00       	push   $0x48f5
    24c1:	6a 01                	push   $0x1
...
000024d0 <bigfile>:
{
  ...
  fd = open("bigfile", 0);
    ...
    255e:	5f                   	pop    %edi
    255f:	6a 00                	push   $0x0
    2561:	68 48 49 00 00       	push   $0x4948
  ...
  for(i = 0; ; i++){
    ...
    258b:	0f be 05 a0 87 00 00 	movsbl 0x87a0,%eax
    2592:	89 fa                	mov    %edi,%edx
    2594:	d1 fa                	sar    %edx
    2596:	39 d0                	cmp    %edx,%eax
    2598:	75 6e                	jne    2608 <bigfile+0x138>
    259a:	0f be 15 cb 88 00 00 	movsbl 0x88cb,%edx
  ...
  for(i = 0; ; i++){
    ...
    25b6:	68 a0 87 00 00       	push   $0x87a0
    25bb:	56                   	push   %esi
  ...
  unlink("bigfile");
    ...
    25e5:	68 48 49 00 00       	push   $0x4948
    25ea:	e8 03 13 00 00       	call   38f2 <unlink>
  printf(1, "bigfile test ok\n");
    25ef:	58                   	pop    %eax
    25f0:	5a                   	pop    %edx
    25f1:	68 d7 49 00 00       	push   $0x49d7
    25f6:	6a 01                	push   $0x1
    ...
    260b:	68 a4 49 00 00       	push   $0x49a4
    2610:	6a 01                	push   $0x1
    ...
    261f:	68 90 49 00 00       	push   $0x4990
    2624:	6a 01                	push   $0x1
    ...
    2633:	68 7b 49 00 00       	push   $0x497b
    2638:	6a 01                	push   $0x1
    ...
    2647:	68 50 49 00 00       	push   $0x4950
    264c:	6a 01                	push   $0x1
    ...
    2658:	53                   	push   %ebx
    2659:	53                   	push   %ebx
    265a:	68 66 49 00 00       	push   $0x4966
    265f:	6a 01                	push   $0x1
    ...
    266b:	50                   	push   %eax
    266c:	50                   	push   %eax
    266d:	68 3a 49 00 00       	push   $0x493a
    2672:	6a 01                	push   $0x1
    ...
    267e:	51                   	push   %ecx
    267f:	51                   	push   %ecx
    2680:	68 bd 49 00 00       	push   $0x49bd
    2685:	6a 01                	push   $0x1
...
000026a0 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    26a6:	68 e8 49 00 00       	push   $0x49e8
    26ab:	6a 01                	push   $0x1
    26ad:	e8 3e 13 00 00       	call   39f0 <printf>
  if(mkdir("12345678901234") != 0){
    26b2:	c7 04 24 23 4a 00 00 	movl   $0x4a23,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26cc:	68 e0 51 00 00       	push   $0x51e0
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26e9:	68 30 52 00 00       	push   $0x5230
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2708:	5a                   	pop    %edx
    2709:	6a 00                	push   $0x0
    270b:	68 a0 52 00 00       	push   $0x52a0
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    2725:	c7 04 24 14 4a 00 00 	movl   $0x4a14,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    273b:	68 3c 53 00 00       	push   $0x533c
  ...
  printf(1, "fourteen ok\n");
    ...
    274f:	68 32 4a 00 00       	push   $0x4a32
    2754:	6a 01                	push   $0x1
    ...
    2760:	50                   	push   %eax
    2761:	50                   	push   %eax
    2762:	68 f7 49 00 00       	push   $0x49f7
    2767:	6a 01                	push   $0x1
    ...
    2773:	50                   	push   %eax
    2774:	50                   	push   %eax
    2775:	68 5c 53 00 00       	push   $0x535c
    277a:	6a 01                	push   $0x1
    ...
    2786:	52                   	push   %edx
    2787:	52                   	push   %edx
    2788:	68 0c 53 00 00       	push   $0x530c
    278d:	6a 01                	push   $0x1
    ...
    2799:	51                   	push   %ecx
    279a:	51                   	push   %ecx
    279b:	68 d0 52 00 00       	push   $0x52d0
    27a0:	6a 01                	push   $0x1
    ...
    27ac:	51                   	push   %ecx
    27ad:	51                   	push   %ecx
    27ae:	68 60 52 00 00       	push   $0x5260
    27b3:	6a 01                	push   $0x1
    ...
    27bf:	50                   	push   %eax
    27c0:	50                   	push   %eax
    27c1:	68 00 52 00 00       	push   $0x5200
    27c6:	6a 01                	push   $0x1
...
000027e0 <rmdot>:
{
  ...
  printf(1, "rmdot test\n");
    27e6:	68 3f 4a 00 00       	push   $0x4a3f
    27eb:	6a 01                	push   $0x1
    27ed:	e8 fe 11 00 00       	call   39f0 <printf>
  if(mkdir("dots") != 0){
    27f2:	c7 04 24 4b 4a 00 00 	movl   $0x4a4b,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    280c:	68 4b 4a 00 00       	push   $0x4a4b
  ...
  if(unlink(".") == 0){
    ...
    2824:	68 f6 46 00 00       	push   $0x46f6
  ...
  if(unlink("..") == 0){
    ...
    283c:	68 f5 46 00 00       	push   $0x46f5
  ...
  if(chdir("/") != 0){
    ...
    2854:	68 c9 3e 00 00       	push   $0x3ec9
  ...
  if(unlink("dots/.") == 0){
    ...
    286c:	68 93 4a 00 00       	push   $0x4a93
  ...
  if(unlink("dots/..") == 0){
    ...
    2880:	68 b1 4a 00 00       	push   $0x4ab1
  ...
  if(unlink("dots") != 0){
    ...
    2894:	68 4b 4a 00 00       	push   $0x4a4b
  ...
  printf(1, "rmdot ok\n");
    ...
    28a8:	68 e6 4a 00 00       	push   $0x4ae6
    28ad:	6a 01                	push   $0x1
    ...
    28b9:	50                   	push   %eax
    28ba:	50                   	push   %eax
    28bb:	68 50 4a 00 00       	push   $0x4a50
    28c0:	6a 01                	push   $0x1
    ...
    28cc:	50                   	push   %eax
    28cd:	50                   	push   %eax
    28ce:	68 d1 4a 00 00       	push   $0x4ad1
    28d3:	6a 01                	push   $0x1
    ...
    28df:	52                   	push   %edx
    28e0:	52                   	push   %edx
    28e1:	68 b9 4a 00 00       	push   $0x4ab9
    28e6:	6a 01                	push   $0x1
    ...
    28f2:	51                   	push   %ecx
    28f3:	51                   	push   %ecx
    28f4:	68 9a 4a 00 00       	push   $0x4a9a
    28f9:	6a 01                	push   $0x1
    ...
    2905:	50                   	push   %eax
    2906:	50                   	push   %eax
    2907:	68 cb 3e 00 00       	push   $0x3ecb
    290c:	6a 01                	push   $0x1
    ...
    2918:	50                   	push   %eax
    2919:	50                   	push   %eax
    291a:	68 84 4a 00 00       	push   $0x4a84
    291f:	6a 01                	push   $0x1
    ...
    292b:	50                   	push   %eax
    292c:	50                   	push   %eax
    292d:	68 76 4a 00 00       	push   $0x4a76
    2932:	6a 01                	push   $0x1
    ...
    293e:	50                   	push   %eax
    293f:	50                   	push   %eax
    2940:	68 63 4a 00 00       	push   $0x4a63
    2945:	6a 01                	push   $0x1
...
00002960 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    2967:	68 f0 4a 00 00       	push   $0x4af0
    296c:	6a 01                	push   $0x1
  ...
  fd = open("dirfile", O_CREATE);
    ...
    297a:	68 fd 4a 00 00       	push   $0x4afd
  ...
  if(chdir("dirfile") == 0){
    2998:	c7 04 24 fd 4a 00 00 	movl   $0x4afd,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    29b2:	6a 00                	push   $0x0
    29b4:	68 36 4b 00 00       	push   $0x4b36
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29d1:	68 36 4b 00 00       	push   $0x4b36
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29e9:	68 36 4b 00 00       	push   $0x4b36
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a01:	68 36 4b 00 00       	push   $0x4b36
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a19:	68 36 4b 00 00       	push   $0x4b36
    2a1e:	68 9a 4b 00 00       	push   $0x4b9a
  ...
  if(unlink("dirfile") != 0){
    ...
    2a36:	68 fd 4a 00 00       	push   $0x4afd
  ...
  fd = open(".", O_RDWR);
    ...
    2a4e:	6a 02                	push   $0x2
    2a50:	68 f6 46 00 00       	push   $0x46f6
  ...
  fd = open(".", 0);
    ...
    2a68:	6a 00                	push   $0x0
    2a6a:	68 f6 46 00 00       	push   $0x46f6
  ...
  if(write(fd, "x", 1) > 0){
    2a79:	6a 01                	push   $0x1
    2a7b:	68 d9 47 00 00       	push   $0x47d9
    2a80:	50                   	push   %eax
  ...
  printf(1, "dir vs file OK\n");
    2a96:	58                   	pop    %eax
    2a97:	5a                   	pop    %edx
    2a98:	68 cd 4b 00 00       	push   $0x4bcd
    2a9d:	6a 01                	push   $0x1
    ...
    2aac:	50                   	push   %eax
    2aad:	50                   	push   %eax
    2aae:	68 41 4b 00 00       	push   $0x4b41
    2ab3:	6a 01                	push   $0x1
    ...
    2abf:	50                   	push   %eax
    2ac0:	50                   	push   %eax
    2ac1:	68 1c 4b 00 00       	push   $0x4b1c
    2ac6:	6a 01                	push   $0x1
    ...
    2ad2:	52                   	push   %edx
    2ad3:	52                   	push   %edx
    2ad4:	68 05 4b 00 00       	push   $0x4b05
    2ad9:	6a 01                	push   $0x1
    ...
    2ae5:	51                   	push   %ecx
    2ae6:	51                   	push   %ecx
    2ae7:	68 b9 4b 00 00       	push   $0x4bb9
    2aec:	6a 01                	push   $0x1
    ...
    2af8:	53                   	push   %ebx
    2af9:	53                   	push   %ebx
    2afa:	68 b0 53 00 00       	push   $0x53b0
    2aff:	6a 01                	push   $0x1
    ...
    2b0b:	50                   	push   %eax
    2b0c:	50                   	push   %eax
    2b0d:	68 a1 4b 00 00       	push   $0x4ba1
    2b12:	6a 01                	push   $0x1
    ...
    2b1e:	50                   	push   %eax
    2b1f:	50                   	push   %eax
    2b20:	68 90 53 00 00       	push   $0x5390
    2b25:	6a 01                	push   $0x1
    ...
    2b31:	50                   	push   %eax
    2b32:	50                   	push   %eax
    2b33:	68 7c 4b 00 00       	push   $0x4b7c
    2b38:	6a 01                	push   $0x1
    ...
    2b44:	50                   	push   %eax
    2b45:	50                   	push   %eax
    2b46:	68 5f 4b 00 00       	push   $0x4b5f
    2b4b:	6a 01                	push   $0x1
    ...
    2b64:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    2b6c:	68 dd 4b 00 00       	push   $0x4bdd
    2b71:	6a 01                	push   $0x1
    ...
    2b83:	68 ee 4b 00 00       	push   $0x4bee
    ...
    2b9b:	68 ee 4b 00 00       	push   $0x4bee
    ...
    2bb3:	68 a3 42 00 00       	push   $0x42a3
    2bb8:	e8 4d 0d 00 00       	call   390a <mkdir>
    link("README", "");
    2bbd:	59                   	pop    %ecx
    2bbe:	58                   	pop    %eax
    2bbf:	68 a3 42 00 00       	push   $0x42a3
    2bc4:	68 9a 4b 00 00       	push   $0x4b9a
    2bc9:	e8 34 0d 00 00       	call   3902 <link>
    fd = open("", O_CREATE);
    2bce:	58                   	pop    %eax
    2bcf:	5a                   	pop    %edx
    2bd0:	68 00 02 00 00       	push   $0x200
    2bd5:	68 a3 42 00 00       	push   $0x42a3
    ...
    2bfa:	68 d8 47 00 00       	push   $0x47d8
    ...
    2c1a:	68 d8 47 00 00       	push   $0x47d8
  ...
  chdir("/");
    ...
    2c33:	68 c9 3e 00 00       	push   $0x3ec9
    2c38:	e8 d5 0c 00 00       	call   3912 <chdir>
  printf(1, "empty file name OK\n");
    2c3d:	58                   	pop    %eax
    2c3e:	5a                   	pop    %edx
    2c3f:	68 1c 4c 00 00       	push   $0x4c1c
    2c44:	6a 01                	push   $0x1
    ...
    2c56:	68 f4 4b 00 00       	push   $0x4bf4
    2c5b:	6a 01                	push   $0x1
    ...
    2c6a:	68 08 4c 00 00       	push   $0x4c08
    2c6f:	6a 01                	push   $0x1
    ...
    2c84:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    2c89:	68 30 4c 00 00       	push   $0x4c30
    2c8e:	6a 01                	push   $0x1
  ...
  printf(1, "fork test OK\n");
    ...
    2cdb:	68 62 4c 00 00       	push   $0x4c62
    2ce0:	6a 01                	push   $0x1
    ...
    2cf3:	68 d0 53 00 00       	push   $0x53d0
    2cf8:	6a 01                	push   $0x1
    ...
    2d0c:	68 3b 4c 00 00       	push   $0x4c3b
    2d11:	6a 01                	push   $0x1
    ...
    2d1d:	50                   	push   %eax
    2d1e:	50                   	push   %eax
    2d1f:	68 4f 4c 00 00       	push   $0x4c4f
    2d24:	6a 01                	push   $0x1
    ...
    2d36:	31 ff                	xor    %edi,%edi
{
  ...
  printf(stdout, "sbrk test\n");
    2d3b:	68 70 4c 00 00       	push   $0x4c70
    2d40:	ff 35 b4 5f 00 00    	pushl  0x5fb4
  ...
  *lastaddr = 99;
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f5a:	6a 01                	push   $0x1
    2f5c:	68 d9 47 00 00       	push   $0x47d9
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fce:	68 18 4d 00 00       	push   $0x4d18
    2fd3:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    2fed:	56                   	push   %esi
    2fee:	57                   	push   %edi
    2fef:	68 7b 4c 00 00       	push   $0x4c7b
    2ff4:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    3020:	50                   	push   %eax
    3021:	50                   	push   %eax
    3022:	68 fd 4c 00 00       	push   $0x4cfd
    3027:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    3037:	52                   	push   %edx
    3038:	52                   	push   %edx
    3039:	68 b9 41 00 00       	push   $0x41b9
    303e:	6a 01                	push   $0x1
    ...
    304d:	50                   	push   %eax
    304e:	56                   	push   %esi
    304f:	68 e4 4c 00 00       	push   $0x4ce4
    3054:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    306c:	51                   	push   %ecx
    306d:	51                   	push   %ecx
    306e:	68 c1 4d 00 00       	push   $0x4dc1
    3073:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    3083:	50                   	push   %eax
    3084:	56                   	push   %esi
    3085:	68 c4 54 00 00       	push   $0x54c4
    308a:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    309a:	53                   	push   %ebx
    309b:	53                   	push   %ebx
    309c:	68 94 54 00 00       	push   $0x5494
    30a1:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    30b1:	57                   	push   %edi
    30b2:	56                   	push   %esi
    30b3:	68 6c 54 00 00       	push   $0x546c
    30b8:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    30c8:	50                   	push   %eax
    30c9:	56                   	push   %esi
    30ca:	68 34 54 00 00       	push   $0x5434
    30cf:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    30df:	56                   	push   %esi
    30e0:	56                   	push   %esi
    30e1:	68 c9 4c 00 00       	push   $0x4cc9
    30e6:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    30f6:	57                   	push   %edi
    30f7:	57                   	push   %edi
    30f8:	68 f4 53 00 00       	push   $0x53f4
    30fd:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    3112:	50                   	push   %eax
    3113:	50                   	push   %eax
    3114:	68 ad 4c 00 00       	push   $0x4cad
    3119:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    3129:	50                   	push   %eax
    312a:	50                   	push   %eax
    312b:	68 96 4c 00 00       	push   $0x4c96
    3130:	ff 35 b4 5f 00 00    	pushl  0x5fb4
...
00003150 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    315a:	68 26 4d 00 00       	push   $0x4d26
    315f:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    319f:	5a                   	pop    %edx
    31a0:	53                   	push   %ebx
    31a1:	68 35 4d 00 00       	push   $0x4d35
  ...
  printf(stdout, "validate ok\n");
    ...
    31c4:	68 59 4d 00 00       	push   $0x4d59
    31c9:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    31e6:	68 40 4d 00 00       	push   $0x4d40
    31eb:	ff 35 b4 5f 00 00    	pushl  0x5fb4
...
00003200 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    3206:	68 66 4d 00 00       	push   $0x4d66
    320b:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    3211:	e8 da 07 00 00       	call   39f0 <printf>
    if(uninit[i] != '\0'){
    3216:	83 c4 10             	add    $0x10,%esp
    3219:	80 3d 80 60 00 00 00 	cmpb   $0x0,0x6080
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    if(uninit[i] != '\0'){
    3230:	80 b8 80 60 00 00 00 	cmpb   $0x0,0x6080(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    3246:	68 81 4d 00 00       	push   $0x4d81
    324b:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    325e:	68 70 4d 00 00       	push   $0x4d70
    3263:	ff 35 b4 5f 00 00    	pushl  0x5fb4
...
00003280 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    3286:	68 8e 4d 00 00       	push   $0x4d8e
  ...
  fd = open("bigarg-ok", 0);
    ...
    32aa:	6a 00                	push   $0x0
    32ac:	68 8e 4d 00 00       	push   $0x4d8e
  ...
  unlink("bigarg-ok");
    32ca:	c7 04 24 8e 4d 00 00 	movl   $0x4d8e,(%esp)
    32d1:	e8 1c 06 00 00       	call   38f2 <unlink>
}
    32d6:	83 c4 10             	add    $0x10,%esp
    32d9:	c9                   	leave  
    32da:	c3                   	ret    
    32db:	b8 e0 5f 00 00       	mov    $0x5fe0,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    32e0:	c7 00 e8 54 00 00    	movl   $0x54e8,(%eax)
    32e6:	83 c0 04             	add    $0x4,%eax
    for(i = 0; i < MAXARG-1; i++)
    32e9:	3d 5c 60 00 00       	cmp    $0x605c,%eax
    32ee:	75 f0                	jne    32e0 <bigargtest+0x60>
    printf(stdout, "bigarg test\n");
    32f0:	51                   	push   %ecx
    32f1:	51                   	push   %ecx
    32f2:	68 98 4d 00 00       	push   $0x4d98
    32f7:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    args[MAXARG-1] = 0;
    32fd:	c7 05 5c 60 00 00 00 	movl   $0x0,0x605c
    3304:	00 00 00 
    printf(stdout, "bigarg test\n");
    ...
    330c:	58                   	pop    %eax
    330d:	5a                   	pop    %edx
    330e:	68 e0 5f 00 00       	push   $0x5fe0
    3313:	68 65 3f 00 00       	push   $0x3f65
    3318:	e8 bd 05 00 00       	call   38da <exec>
    printf(stdout, "bigarg test ok\n");
    331d:	59                   	pop    %ecx
    331e:	58                   	pop    %eax
    331f:	68 a5 4d 00 00       	push   $0x4da5
    3324:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    332a:	e8 c1 06 00 00       	call   39f0 <printf>
    fd = open("bigarg-ok", O_CREATE);
    332f:	58                   	pop    %eax
    3330:	5a                   	pop    %edx
    3331:	68 00 02 00 00       	push   $0x200
    3336:	68 8e 4d 00 00       	push   $0x4d8e
    ...
    334d:	50                   	push   %eax
    334e:	50                   	push   %eax
    334f:	68 ce 4d 00 00       	push   $0x4dce
    3354:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    3364:	52                   	push   %edx
    3365:	52                   	push   %edx
    3366:	68 b5 4d 00 00       	push   $0x4db5
    336b:	ff 35 b4 5f 00 00    	pushl  0x5fb4
    ...
    3386:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    338b:	68 e3 4d 00 00       	push   $0x4de3
    3390:	6a 01                	push   $0x1
    ...
    3413:	50                   	push   %eax
    3414:	68 f0 4d 00 00       	push   $0x4df0
    3419:	6a 01                	push   $0x1
    ...
    344a:	68 a0 87 00 00       	push   $0x87a0
    344f:	57                   	push   %edi
    ...
    3462:	56                   	push   %esi
    3463:	68 0c 4e 00 00       	push   $0x4e0c
    3468:	6a 01                	push   $0x1
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3496:	50                   	push   %eax
    3497:	68 fc 4d 00 00       	push   $0x4dfc
    349c:	6a 01                	push   $0x1
  ...
  printf(1, "fsfull test finished\n");
    ...
    352a:	68 1c 4e 00 00       	push   $0x4e1c
    352f:	6a 01                	push   $0x1
...
00003550 <uio>:
{
  ...
  printf(1, "uio test\n");
    3556:	68 32 4e 00 00       	push   $0x4e32
    355b:	6a 01                	push   $0x1
  ...
  printf(1, "uio test done\n");
    ...
    3578:	68 3c 4e 00 00       	push   $0x4e3c
    357d:	6a 01                	push   $0x1
    ...
    359a:	52                   	push   %edx
    359b:	52                   	push   %edx
    359c:	68 c8 55 00 00       	push   $0x55c8
    35a1:	6a 01                	push   $0x1
    ...
    35ad:	50                   	push   %eax
    35ae:	50                   	push   %eax
    35af:	68 c1 4d 00 00       	push   $0x4dc1
    35b4:	6a 01                	push   $0x1
...
000035c0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    35c7:	6a 00                	push   $0x0
    35c9:	68 4b 4e 00 00       	push   $0x4e4b
  ...
  printf(1, "arg test passed\n");
    35fd:	58                   	pop    %eax
    35fe:	5a                   	pop    %edx
    35ff:	68 5d 4e 00 00       	push   $0x4e5d
    3604:	6a 01                	push   $0x1
    ...
    3613:	51                   	push   %ecx
    3614:	51                   	push   %ecx
    3615:	68 50 4e 00 00       	push   $0x4e50
    361a:	6a 02                	push   $0x2
...
00003630 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3630:	69 05 b0 5f 00 00 0d 	imul   $0x19660d,0x5fb0,%eax
    3637:	66 19 00 
{
    363a:	55                   	push   %ebp
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    3643:	a3 b0 5f 00 00       	mov    %eax,0x5fb0
}
    3648:	c3                   	ret    
    ...
    3959:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    3987:	f7 f1                	div    %ecx
    3989:	0f b6 92 20 56 00 00 	movzbl 0x5620(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3ba4:	e9 8f fe ff ff       	jmp    3a38 <printf+0x48>
          s = "(null)";
    3ba9:	bb 18 56 00 00       	mov    $0x5618,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3bc1:	a1 60 60 00 00       	mov    0x6060,%eax
{
  ...
  freep = p;
    3bff:	a3 60 60 00 00       	mov    %eax,0x6060
}
    3c04:	5b                   	pop    %ebx
    3c05:	5e                   	pop    %esi
    3c06:	5f                   	pop    %edi
    ...
    3c16:	72 ce                	jb     3be6 <free+0x26>
{
  ...
  freep = p;
    3c3a:	a3 60 60 00 00       	mov    %eax,0x6060
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){ // no free list yet
    3c5c:	8b 15 60 60 00 00    	mov    0x6060,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3ca1:	39 05 60 60 00 00    	cmp    %eax,0x6060
  ...
  return freep;
    3ccb:	8b 15 60 60 00 00    	mov    0x6060,%edx
    ...
    3cf4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    3cf7:	89 15 60 60 00 00    	mov    %edx,0x6060
}
    ...
    base.s.ptr = freep = prevp = &base;
    3d10:	c7 05 60 60 00 00 64 	movl   $0x6064,0x6060
    3d17:	60 00 00 
    3d1a:	c7 05 64 60 00 00 64 	movl   $0x6064,0x6064
    3d21:	60 00 00 
    base.s.size = 0;
    3d24:	b8 64 60 00 00       	mov    $0x6064,%eax
    3d29:	c7 05 68 60 00 00 00 	movl   $0x0,0x6068
    3d30:	00 00 00 
...
void* pmalloc(){
    ...
    3d53:	53                   	push   %ebx
    3d54:	83 ec 04             	sub    $0x4,%esp
  struct plink *pl;
  if(!plink_freep){ // empty list
    3d57:	8b 1d a4 a7 00 00    	mov    0xa7a4,%ebx
    3d5d:	85 db                	test   %ebx,%ebx
    3d5f:	75 0d                	jne    3d6e <pmalloc+0x1e>
    3d61:	eb 5d                	jmp    3dc0 <pmalloc+0x70>
    3d63:	90                   	nop
    3d64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  while(pl->next){
    if(pl->isFree){
    3d68:	85 d2                	test   %edx,%edx
    3d6a:	75 0f                	jne    3d7b <pmalloc+0x2b>
    3d6c:	89 c3                	mov    %eax,%ebx
  while(pl->next){
    3d6e:	8b 03                	mov    (%ebx),%eax
    3d70:	8b 53 04             	mov    0x4(%ebx),%edx
    3d73:	85 c0                	test   %eax,%eax
    3d75:	75 f1                	jne    3d68 <pmalloc+0x18>
      pl->isFree = 0;
      return pl;
    }
    pl = pl->next;
  ...
  if(pl->isFree){ // reached last link
    3d77:	85 d2                	test   %edx,%edx
    3d79:	74 15                	je     3d90 <pmalloc+0x40>
    pl->isFree = 0;
    3d7b:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    //printf(1, "plink=%d\n", pl->next);
    pl->next->next = 0;
    pl->next->isFree = 0;
    return pl->next;
    ...
    3d82:	89 d8                	mov    %ebx,%eax
    3d84:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3d87:	c9                   	leave  
    3d88:	c3                   	ret    
    3d89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    pl->next = (struct plink*)sbrk(pageSize);
    3d90:	83 ec 0c             	sub    $0xc,%esp
    3d93:	ff 35 d0 5f 00 00    	pushl  0x5fd0
    3d99:	e8 8c fb ff ff       	call   392a <sbrk>
    3d9e:	89 03                	mov    %eax,(%ebx)
    pl->next->next = 0;
    3da0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return pl->next;
    3da6:	83 c4 10             	add    $0x10,%esp
    pl->next->isFree = 0;
    3da9:	8b 03                	mov    (%ebx),%eax
    3dab:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    return pl->next;
    3db2:	8b 1b                	mov    (%ebx),%ebx
}
    3db4:	89 d8                	mov    %ebx,%eax
    3db6:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3db9:	c9                   	leave  
    3dba:	c3                   	ret    
    3dbb:	90                   	nop
    ...
    3dc3:	ff 35 d0 5f 00 00    	pushl  0x5fd0
    3dc9:	e8 5c fb ff ff       	call   392a <sbrk>
    3dce:	a3 a4 a7 00 00       	mov    %eax,0xa7a4
    plink_freep->next = 0;
    3dd3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
    3dd9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
    3ddc:	8b 1d a4 a7 00 00    	mov    0xa7a4,%ebx
    3de2:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
    3de9:	89 d8                	mov    %ebx,%eax
    3deb:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3dee:	c9                   	leave  
    3def:	c3                   	ret    

00003df0 <protect_page>:
...
int protect_page(void* ap){
    ...
    3df3:	83 ec 08             	sub    $0x8,%esp
  struct plink *pl = plink_freep;
    3df6:	a1 a4 a7 00 00       	mov    0xa7a4,%eax
int protect_page(void* ap){
    3dfb:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
    3dfe:	85 c0                	test   %eax,%eax
    3e00:	74 18                	je     3e1a <protect_page+0x2a>
    if(pl == ap){
    3e02:	39 d0                	cmp    %edx,%eax
    3e04:	75 0e                	jne    3e14 <protect_page+0x24>
    3e06:	eb 20                	jmp    3e28 <protect_page+0x38>
    3e08:	90                   	nop
    3e09:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3e10:	39 c2                	cmp    %eax,%edx
    3e12:	74 14                	je     3e28 <protect_page+0x38>
      protectPage(pl);
      return 1;
    }
    pl = pl->next;
  ...
  while(pl){
    ...
    3e18:	75 f6                	jne    3e10 <protect_page+0x20>
  }
	return -1;
    3e1a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    3e1f:	c9                   	leave  
    3e20:	c3                   	ret    
    3e21:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      protectPage(pl);
    3e28:	83 ec 0c             	sub    $0xc,%esp
    3e2b:	52                   	push   %edx
    3e2c:	e8 11 fb ff ff       	call   3942 <protectPage>
      return 1;
    3e31:	83 c4 10             	add    $0x10,%esp
    3e34:	b8 01 00 00 00       	mov    $0x1,%eax
}
    3e39:	c9                   	leave  
    3e3a:	c3                   	ret    
    3e3b:	90                   	nop
    3e3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
int pfree(void* ap){
  struct plink *pl = plink_freep;
    3e40:	a1 a4 a7 00 00       	mov    0xa7a4,%eax
int pfree(void* ap){
    3e45:	55                   	push   %ebp
    3e46:	89 e5                	mov    %esp,%ebp
  while(pl){
    3e48:	85 c0                	test   %eax,%eax
int pfree(void* ap){
    3e4a:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
    3e4d:	74 13                	je     3e62 <pfree+0x22>
    if(pl == ap){
    3e4f:	39 d0                	cmp    %edx,%eax
    3e51:	75 09                	jne    3e5c <pfree+0x1c>
    3e53:	eb 1b                	jmp    3e70 <pfree+0x30>
    3e55:	8d 76 00             	lea    0x0(%esi),%esi
    3e58:	39 c2                	cmp    %eax,%edx
    3e5a:	74 14                	je     3e70 <pfree+0x30>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
  ...
  while(pl){
    ...
    3e60:	75 f6                	jne    3e58 <pfree+0x18>
  }
	return -1;
    3e62:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    3e67:	5d                   	pop    %ebp
    3e68:	c3                   	ret    
    3e69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
    3e70:	c7 42 04 01 00 00 00 	movl   $0x1,0x4(%edx)
      return 1;
    3e77:	b8 01 00 00 00       	mov    $0x1,%eax
}
    3e7c:	5d                   	pop    %ebp
    3e7d:	c3                   	ret    

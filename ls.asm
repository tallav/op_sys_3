 ...
 639:	85 d2                	test   %edx,%edx
{
 ...
 667:	f7 f1                	div    %ecx
 669:	0f b6 92 d0 0b 00 00 	movzbl 0xbd0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 884:	e9 8f fe ff ff       	jmp    718 <printf+0x48>
          s = "(null)";
 889:	bb c6 0b 00 00       	mov    $0xbc6,%ebx
        while(*s != 0){
...
void* pmalloc(){
 ...
 a34:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 a37:	68 e1 0b 00 00       	push   $0xbe1
 a3c:	6a 01                	push   $0x1
 a3e:	e8 8d fc ff ff       	call   6d0 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 a43:	8b 1d a4 0f 00 00    	mov    0xfa4,%ebx
 ...
 a83:	ff 35 84 0f 00 00    	pushl  0xf84
 a89:	e8 7c fb ff ff       	call   60a <sbrk>
 a8e:	a3 a4 0f 00 00       	mov    %eax,0xfa4
    plink_freep->next = 0;
 a93:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 a99:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 a9c:	8b 1d a4 0f 00 00    	mov    0xfa4,%ebx
 ...
 ab3:	ff 35 84 0f 00 00    	pushl  0xf84
...
int protect_page(void* ap){
 ...
 ae0:	a1 a4 0f 00 00       	mov    0xfa4,%eax
int protect_page(void* ap){
 ae5:	55                   	push   %ebp
...
int protect_page(void* ap){
 aea:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 aed:	74 13                	je     b02 <protect_page+0x22>
    if(pl == ap){
 aef:	39 d0                	cmp    %edx,%eax
 af1:	75 09                	jne    afc <protect_page+0x1c>
 af3:	eb 1b                	jmp    b10 <protect_page+0x30>
 af5:	8d 76 00             	lea    0x0(%esi),%esi
 af8:	39 c2                	cmp    %eax,%edx
 afa:	74 14                	je     b10 <protect_page+0x30>
      // add system call 
      return 1;
    }
    pl = pl->next;
 ...
 b00:	75 f6                	jne    af8 <protect_page+0x18>
  }
	return -1;
 b02:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 b07:	5d                   	pop    %ebp
 b08:	c3                   	ret    
...
int pfree(void* ap){
 ...
 b27:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 b2a:	68 ea 0b 00 00       	push   $0xbea
 b2f:	6a 01                	push   $0x1
 b31:	e8 9a fb ff ff       	call   6d0 <printf>
  struct plink *pl = plink_freep;
 b36:	a1 a4 0f 00 00       	mov    0xfa4,%eax
  while(pl){
 b3b:	83 c4 10             	add    $0x10,%esp
 b3e:	85 c0                	test   %eax,%eax
 b40:	74 18                	je     b5a <pfree+0x3a>
    if(pl == ap){
 b42:	39 d8                	cmp    %ebx,%eax
 b44:	75 0e                	jne    b54 <pfree+0x34>
 b46:	eb 20                	jmp    b68 <pfree+0x48>
 b48:	90                   	nop
 b49:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 b50:	39 c3                	cmp    %eax,%ebx
 b52:	74 14                	je     b68 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 b58:	75 f6                	jne    b50 <pfree+0x30>
  }
	return -1;
 b5a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 b5f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 b62:	c9                   	leave  
 b63:	c3                   	ret    
 b64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 b68:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;
 b6f:	b8 01 00 00 00       	mov    $0x1,%eax
}
 b74:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 b77:	c9                   	leave  
 b78:	c3                   	ret    

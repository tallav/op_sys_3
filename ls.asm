 ...
 639:	85 d2                	test   %edx,%edx
{
 ...
 667:	f7 f1                	div    %ecx
 669:	0f b6 92 b4 0b 00 00 	movzbl 0xbb4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 884:	e9 8f fe ff ff       	jmp    718 <printf+0x48>
          s = "(null)";
 889:	bb aa 0b 00 00       	mov    $0xbaa,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8a1:	a1 70 0f 00 00       	mov    0xf70,%eax
{
 ...
 8dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 8df:	a3 70 0f 00 00       	mov    %eax,0xf70
}
 8e4:	5b                   	pop    %ebx
 8e5:	5e                   	pop    %esi
 8e6:	5f                   	pop    %edi
 ...
 8f6:	72 ce                	jb     8c6 <free+0x26>
{
 ...
 917:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 91a:	a3 70 0f 00 00       	mov    %eax,0xf70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 93c:	8b 15 70 0f 00 00    	mov    0xf70,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 97f:	73 47                	jae    9c8 <malloc+0x98>
    ...
    if(p == freep)
 981:	39 05 70 0f 00 00    	cmp    %eax,0xf70
 ...
 9a6:	e8 f5 fe ff ff       	call   8a0 <free>
  return freep;
 9ab:	8b 15 70 0f 00 00    	mov    0xf70,%edx
 ...
 9d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 9d7:	89 15 70 0f 00 00    	mov    %edx,0xf70
}
 ...
 9e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 9f0:	c7 05 70 0f 00 00 74 	movl   $0xf74,0xf70
 9f7:	0f 00 00 
 9fa:	c7 05 74 0f 00 00 74 	movl   $0xf74,0xf74
 a01:	0f 00 00 
    base.s.size = 0;
 a04:	b8 74 0f 00 00       	mov    $0xf74,%eax
 a09:	c7 05 78 0f 00 00 00 	movl   $0x0,0xf78
 a10:	00 00 00 
...
void* pmalloc(){
 ...
 a37:	8b 1d 7c 0f 00 00    	mov    0xf7c,%ebx
 a3d:	85 db                	test   %ebx,%ebx
 a3f:	75 0d                	jne    a4e <pmalloc+0x1e>
 a41:	eb 5d                	jmp    aa0 <pmalloc+0x70>
 a43:	90                   	nop
 ...
 a4a:	75 0f                	jne    a5b <pmalloc+0x2b>
 a4c:	89 c3                	mov    %eax,%ebx
  while(pl->next){
 a4e:	8b 03                	mov    (%ebx),%eax
 a50:	8b 53 04             	mov    0x4(%ebx),%edx
 a53:	85 c0                	test   %eax,%eax
 a55:	75 f1                	jne    a48 <pmalloc+0x18>
      pl->isFree = 0;
      return pl;
    }
    pl = pl->next;
 ...
 a57:	85 d2                	test   %edx,%edx
 a59:	74 15                	je     a70 <pmalloc+0x40>
    pl->isFree = 0;
 a5b:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    //printf(1, "plink=%d\n", pl->next);
    pl->next->next = 0;
    pl->next->isFree = 0;
    return pl->next;
 ...
 a64:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 a67:	c9                   	leave  
 a68:	c3                   	ret    
 a69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    pl->next = (struct plink*)sbrk(pageSize);
 a70:	83 ec 0c             	sub    $0xc,%esp
 a73:	ff 35 5c 0f 00 00    	pushl  0xf5c
 a79:	e8 8c fb ff ff       	call   60a <sbrk>
 a7e:	89 03                	mov    %eax,(%ebx)
    pl->next->next = 0;
 a80:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return pl->next;
 a86:	83 c4 10             	add    $0x10,%esp
    pl->next->isFree = 0;
 a89:	8b 03                	mov    (%ebx),%eax
 a8b:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    return pl->next;
 a92:	8b 1b                	mov    (%ebx),%ebx
}
 ...
 aa3:	ff 35 5c 0f 00 00    	pushl  0xf5c
 aa9:	e8 5c fb ff ff       	call   60a <sbrk>
 aae:	a3 7c 0f 00 00       	mov    %eax,0xf7c
    plink_freep->next = 0;
 ab3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 ab9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 abc:	8b 1d 7c 0f 00 00    	mov    0xf7c,%ebx
 ac2:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
...
int protect_page(void* ap){
 ...
 ad6:	a1 7c 0f 00 00       	mov    0xf7c,%eax
int protect_page(void* ap){
 adb:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 ade:	85 c0                	test   %eax,%eax
 ae0:	74 18                	je     afa <protect_page+0x2a>
    if(pl == ap){
 ae2:	39 d0                	cmp    %edx,%eax
 ae4:	75 0e                	jne    af4 <protect_page+0x24>
 ae6:	eb 20                	jmp    b08 <protect_page+0x38>
 ae8:	90                   	nop
 ae9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 af0:	39 c2                	cmp    %eax,%edx
 af2:	74 14                	je     b08 <protect_page+0x38>
      protectPage(pl);
      return 1;
    }
    pl = pl->next;
 ...
 af8:	75 f6                	jne    af0 <protect_page+0x20>
  }
	return -1;
 afa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 aff:	c9                   	leave  
 b00:	c3                   	ret    
 ...
 b0b:	52                   	push   %edx
 b0c:	e8 11 fb ff ff       	call   622 <protectPage>
      return 1;
 b11:	83 c4 10             	add    $0x10,%esp
 b14:	b8 01 00 00 00       	mov    $0x1,%eax
}
 b19:	c9                   	leave  
 b1a:	c3                   	ret    
 b1b:	90                   	nop
...
int pfree(void* ap){
  struct plink *pl = plink_freep;
 b20:	a1 7c 0f 00 00       	mov    0xf7c,%eax
int pfree(void* ap){
 b25:	55                   	push   %ebp
...
int pfree(void* ap){
 b2a:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 b2d:	74 13                	je     b42 <pfree+0x22>
    if(pl == ap){
 b2f:	39 d0                	cmp    %edx,%eax
 b31:	75 09                	jne    b3c <pfree+0x1c>
 b33:	eb 1b                	jmp    b50 <pfree+0x30>
 b35:	8d 76 00             	lea    0x0(%esi),%esi
 b38:	39 c2                	cmp    %eax,%edx
 b3a:	74 14                	je     b50 <pfree+0x30>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 b49:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 b50:	c7 42 04 01 00 00 00 	movl   $0x1,0x4(%edx)
      return 1;

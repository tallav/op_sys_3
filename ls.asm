...
printf(int fd, char *fmt, ...)
{
 ...
 884:	e9 8f fe ff ff       	jmp    718 <printf+0x48>
          s = "(null)";
 889:	bb d6 0b 00 00       	mov    $0xbd6,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8a1:	a1 a8 0f 00 00       	mov    0xfa8,%eax
{
 ...
 8dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 8df:	a3 a8 0f 00 00       	mov    %eax,0xfa8
}
 8e4:	5b                   	pop    %ebx
 8e5:	5e                   	pop    %esi
 8e6:	5f                   	pop    %edi
 ...
 8f6:	72 ce                	jb     8c6 <free+0x26>
{
 ...
 917:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 91a:	a3 a8 0f 00 00       	mov    %eax,0xfa8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 93c:	8b 15 a8 0f 00 00    	mov    0xfa8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 97f:	73 47                	jae    9c8 <malloc+0x98>
    ...
    if(p == freep)
 981:	39 05 a8 0f 00 00    	cmp    %eax,0xfa8
 ...
 9a6:	e8 f5 fe ff ff       	call   8a0 <free>
  return freep;
 9ab:	8b 15 a8 0f 00 00    	mov    0xfa8,%edx
 ...
 9d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 9d7:	89 15 a8 0f 00 00    	mov    %edx,0xfa8
}
 ...
 9e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 9f0:	c7 05 a8 0f 00 00 ac 	movl   $0xfac,0xfa8
 9f7:	0f 00 00 
 9fa:	c7 05 ac 0f 00 00 ac 	movl   $0xfac,0xfac
 a01:	0f 00 00 
    base.s.size = 0;
 a04:	b8 ac 0f 00 00       	mov    $0xfac,%eax
 a09:	c7 05 b0 0f 00 00 00 	movl   $0x0,0xfb0
 a10:	00 00 00 
...
void* pmalloc(){
 ...
 a34:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 a37:	68 f1 0b 00 00       	push   $0xbf1
 a3c:	6a 01                	push   $0x1
 a3e:	e8 8d fc ff ff       	call   6d0 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 a43:	8b 1d b4 0f 00 00    	mov    0xfb4,%ebx
 a49:	83 c4 10             	add    $0x10,%esp
 a4c:	85 db                	test   %ebx,%ebx
 a4e:	75 0e                	jne    a5e <pmalloc+0x2e>
 a50:	eb 2e                	jmp    a80 <pmalloc+0x50>
 ...
 a5a:	75 0f                	jne    a6b <pmalloc+0x3b>
 a5c:	89 c3                	mov    %eax,%ebx
  while(pl->next){
 a5e:	8b 03                	mov    (%ebx),%eax
 a60:	8b 53 04             	mov    0x4(%ebx),%edx
 a63:	85 c0                	test   %eax,%eax
 a65:	75 f1                	jne    a58 <pmalloc+0x28>
      pl->isFree = 0;
      return pl;
    }
    pl = pl->next;
 ...
 a67:	85 d2                	test   %edx,%edx
 a69:	74 45                	je     ab0 <pmalloc+0x80>
    pl->isFree = 0;
 a6b:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
 ...
 a74:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 a77:	c9                   	leave  
 a78:	c3                   	ret    
 a79:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    plink_freep = (struct plink*)sbrk(pageSize);
 a80:	83 ec 0c             	sub    $0xc,%esp
 a83:	ff 35 94 0f 00 00    	pushl  0xf94
 a89:	e8 7c fb ff ff       	call   60a <sbrk>
 a8e:	a3 b4 0f 00 00       	mov    %eax,0xfb4
    plink_freep->next = 0;
 a93:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 a99:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 a9c:	8b 1d b4 0f 00 00    	mov    0xfb4,%ebx
 aa2:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
 ...
 ab3:	ff 35 94 0f 00 00    	pushl  0xf94
 ab9:	e8 4c fb ff ff       	call   60a <sbrk>
    pl->next = 0;
 abe:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
    pl->isFree = 0;
 ac4:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    return pl->next;
 acb:	83 c4 10             	add    $0x10,%esp
 ace:	31 db                	xor    %ebx,%ebx
 ad0:	eb a0                	jmp    a72 <pmalloc+0x42>
 ad2:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 ad9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00000ae0 <protect_page>:
...
int protect_page(void* ap){
 ...
 ae6:	a1 b4 0f 00 00       	mov    0xfb4,%eax
int protect_page(void* ap){
 aeb:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 aee:	85 c0                	test   %eax,%eax
 af0:	74 18                	je     b0a <protect_page+0x2a>
    if(pl == ap){
 af2:	39 d0                	cmp    %edx,%eax
 af4:	75 0e                	jne    b04 <protect_page+0x24>
 af6:	eb 20                	jmp    b18 <protect_page+0x38>
 af8:	90                   	nop
 af9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 b00:	39 c2                	cmp    %eax,%edx
 b02:	74 14                	je     b18 <protect_page+0x38>
      protectPage(pl);
      return 1;
    }
    pl = pl->next;
 ...
 b08:	75 f6                	jne    b00 <protect_page+0x20>
  }
	return -1;
 ...
 b1b:	52                   	push   %edx
 b1c:	e8 01 fb ff ff       	call   622 <protectPage>
      return 1;
 b21:	83 c4 10             	add    $0x10,%esp
 b24:	b8 01 00 00 00       	mov    $0x1,%eax
}
 b29:	c9                   	leave  
 b2a:	c3                   	ret    
 b2b:	90                   	nop
...
int pfree(void* ap){
 ...
 b37:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 b3a:	68 fa 0b 00 00       	push   $0xbfa
 b3f:	6a 01                	push   $0x1
 b41:	e8 8a fb ff ff       	call   6d0 <printf>
  struct plink *pl = plink_freep;
 b46:	a1 b4 0f 00 00       	mov    0xfb4,%eax
  while(pl){
 b4b:	83 c4 10             	add    $0x10,%esp
 b4e:	85 c0                	test   %eax,%eax
 b50:	74 18                	je     b6a <pfree+0x3a>
    if(pl == ap){
 b52:	39 d8                	cmp    %ebx,%eax
 b54:	75 0e                	jne    b64 <pfree+0x34>
 b56:	eb 20                	jmp    b78 <pfree+0x48>
 b58:	90                   	nop
 b59:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 b60:	39 c3                	cmp    %eax,%ebx
 b62:	74 14                	je     b78 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 b68:	75 f6                	jne    b60 <pfree+0x30>
  }
	return -1;
 b6a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 b6f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 b72:	c9                   	leave  
 b73:	c3                   	ret    
 b74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 b78:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;
 b7f:	b8 01 00 00 00       	mov    $0x1,%eax
}

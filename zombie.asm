 ...
 339:	85 d2                	test   %edx,%edx
{
 ...
 367:	f7 f1                	div    %ecx
 369:	0f b6 92 84 08 00 00 	movzbl 0x884(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 584:	e9 8f fe ff ff       	jmp    418 <printf+0x48>
          s = "(null)";
 589:	bb 7c 08 00 00       	mov    $0x87c,%ebx
        while(*s != 0){
...
void* pmalloc(){
 ...
 734:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 737:	68 95 08 00 00       	push   $0x895
 73c:	6a 01                	push   $0x1
 73e:	e8 8d fc ff ff       	call   3d0 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 743:	8b 1d cc 0b 00 00    	mov    0xbcc,%ebx
 ...
 783:	ff 35 bc 0b 00 00    	pushl  0xbbc
 789:	e8 7c fb ff ff       	call   30a <sbrk>
 78e:	a3 cc 0b 00 00       	mov    %eax,0xbcc
    plink_freep->next = 0;
 793:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 799:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 79c:	8b 1d cc 0b 00 00    	mov    0xbcc,%ebx
 ...
 7b3:	ff 35 bc 0b 00 00    	pushl  0xbbc
...
int protect_page(void* ap){
 ...
 7e0:	a1 cc 0b 00 00       	mov    0xbcc,%eax
int protect_page(void* ap){
 7e5:	55                   	push   %ebp
...
int protect_page(void* ap){
 7ea:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 7ed:	74 13                	je     802 <protect_page+0x22>
    if(pl == ap){
 7ef:	39 d0                	cmp    %edx,%eax
 7f1:	75 09                	jne    7fc <protect_page+0x1c>
 7f3:	eb 1b                	jmp    810 <protect_page+0x30>
 7f5:	8d 76 00             	lea    0x0(%esi),%esi
 7f8:	39 c2                	cmp    %eax,%edx
 7fa:	74 14                	je     810 <protect_page+0x30>
      // add system call 
      return 1;
    }
    pl = pl->next;
 ...
 800:	75 f6                	jne    7f8 <protect_page+0x18>
  }
	return -1;
...
int pfree(void* ap){
 ...
 827:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 82a:	68 9e 08 00 00       	push   $0x89e
 82f:	6a 01                	push   $0x1
 831:	e8 9a fb ff ff       	call   3d0 <printf>
  struct plink *pl = plink_freep;
 836:	a1 cc 0b 00 00       	mov    0xbcc,%eax
  while(pl){
 83b:	83 c4 10             	add    $0x10,%esp
 83e:	85 c0                	test   %eax,%eax
 840:	74 18                	je     85a <pfree+0x3a>
    if(pl == ap){
 842:	39 d8                	cmp    %ebx,%eax
 844:	75 0e                	jne    854 <pfree+0x34>
 846:	eb 20                	jmp    868 <pfree+0x48>
 848:	90                   	nop
 849:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 850:	39 c3                	cmp    %eax,%ebx
 852:	74 14                	je     868 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 864:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 868:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;

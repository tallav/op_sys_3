 ...
 339:	85 d2                	test   %edx,%edx
{
 ...
 367:	f7 f1                	div    %ecx
 369:	0f b6 92 68 08 00 00 	movzbl 0x868(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 584:	e9 8f fe ff ff       	jmp    418 <printf+0x48>
          s = "(null)";
 589:	bb 60 08 00 00       	mov    $0x860,%ebx
        while(*s != 0){
 ...
 5a1:	a1 98 0b 00 00       	mov    0xb98,%eax
{
 ...
 5dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5df:	a3 98 0b 00 00       	mov    %eax,0xb98
}
 5e4:	5b                   	pop    %ebx
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
 ...
 5f6:	72 ce                	jb     5c6 <free+0x26>
{
 ...
 617:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61a:	a3 98 0b 00 00       	mov    %eax,0xb98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 63c:	8b 15 98 0b 00 00    	mov    0xb98,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67f:	73 47                	jae    6c8 <malloc+0x98>
    ...
    if(p == freep)
 681:	39 05 98 0b 00 00    	cmp    %eax,0xb98
 ...
 6a6:	e8 f5 fe ff ff       	call   5a0 <free>
  return freep;
 6ab:	8b 15 98 0b 00 00    	mov    0xb98,%edx
 ...
 6d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6d7:	89 15 98 0b 00 00    	mov    %edx,0xb98
}
 ...
 6e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 98 0b 00 00 9c 	movl   $0xb9c,0xb98
 6f7:	0b 00 00 
 6fa:	c7 05 9c 0b 00 00 9c 	movl   $0xb9c,0xb9c
 701:	0b 00 00 
    base.s.size = 0;
 704:	b8 9c 0b 00 00       	mov    $0xb9c,%eax
 709:	c7 05 a0 0b 00 00 00 	movl   $0x0,0xba0
 710:	00 00 00 
...
void* pmalloc(){
 ...
 737:	8b 1d a4 0b 00 00    	mov    0xba4,%ebx
 73d:	85 db                	test   %ebx,%ebx
 73f:	75 0d                	jne    74e <pmalloc+0x1e>
 741:	eb 5d                	jmp    7a0 <pmalloc+0x70>
 743:	90                   	nop
 ...
 74a:	75 0f                	jne    75b <pmalloc+0x2b>
 74c:	89 c3                	mov    %eax,%ebx
  while(pl->next){
 74e:	8b 03                	mov    (%ebx),%eax
 750:	8b 53 04             	mov    0x4(%ebx),%edx
 753:	85 c0                	test   %eax,%eax
 755:	75 f1                	jne    748 <pmalloc+0x18>
      pl->isFree = 0;
      return pl;
    }
    pl = pl->next;
 ...
 759:	74 15                	je     770 <pmalloc+0x40>
    pl->isFree = 0;
 75b:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    //printf(1, "plink=%d\n", pl->next);
    pl->next->next = 0;
    pl->next->isFree = 0;
    return pl->next;
 ...
 773:	ff 35 94 0b 00 00    	pushl  0xb94
 779:	e8 8c fb ff ff       	call   30a <sbrk>
 77e:	89 03                	mov    %eax,(%ebx)
    pl->next->next = 0;
 780:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return pl->next;
 786:	83 c4 10             	add    $0x10,%esp
    pl->next->isFree = 0;
 789:	8b 03                	mov    (%ebx),%eax
 78b:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    return pl->next;
 792:	8b 1b                	mov    (%ebx),%ebx
}
 ...
 7a3:	ff 35 94 0b 00 00    	pushl  0xb94
 7a9:	e8 5c fb ff ff       	call   30a <sbrk>
 7ae:	a3 a4 0b 00 00       	mov    %eax,0xba4
    plink_freep->next = 0;
 7b3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 7b9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 7bc:	8b 1d a4 0b 00 00    	mov    0xba4,%ebx
...
int protect_page(void* ap){
 ...
 7d6:	a1 a4 0b 00 00       	mov    0xba4,%eax
int protect_page(void* ap){
 7db:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 7de:	85 c0                	test   %eax,%eax
 7e0:	74 18                	je     7fa <protect_page+0x2a>
    if(pl == ap){
 7e2:	39 d0                	cmp    %edx,%eax
 7e4:	75 0e                	jne    7f4 <protect_page+0x24>
 7e6:	eb 20                	jmp    808 <protect_page+0x38>
 7e8:	90                   	nop
 7e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 7f0:	39 c2                	cmp    %eax,%edx
 7f2:	74 14                	je     808 <protect_page+0x38>
      protectPage(pl);
      return 1;
    }
    pl = pl->next;
 ...
 7f8:	75 f6                	jne    7f0 <protect_page+0x20>
  }
	return -1;
 ...
 80b:	52                   	push   %edx
 80c:	e8 11 fb ff ff       	call   322 <protectPage>
      return 1;
...
int pfree(void* ap){
 82a:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 82d:	74 13                	je     842 <pfree+0x22>
    if(pl == ap){
 82f:	39 d0                	cmp    %edx,%eax
 831:	75 09                	jne    83c <pfree+0x1c>
 833:	eb 1b                	jmp    850 <pfree+0x30>
 835:	8d 76 00             	lea    0x0(%esi),%esi
 838:	39 c2                	cmp    %eax,%edx
 83a:	74 14                	je     850 <pfree+0x30>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 840:	75 f6                	jne    838 <pfree+0x18>
  }
	return -1;
 842:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 847:	5d                   	pop    %ebp
 848:	c3                   	ret    
 849:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 850:	c7 42 04 01 00 00 00 	movl   $0x1,0x4(%edx)
      return 1;
 857:	b8 01 00 00 00       	mov    $0x1,%eax
}
 85c:	5d                   	pop    %ebp
 85d:	c3                   	ret    

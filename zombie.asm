 ...
 339:	85 d2                	test   %edx,%edx
{
 ...
 367:	f7 f1                	div    %ecx
 369:	0f b6 92 94 08 00 00 	movzbl 0x894(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 584:	e9 8f fe ff ff       	jmp    418 <printf+0x48>
          s = "(null)";
 589:	bb 8c 08 00 00       	mov    $0x88c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5a1:	a1 d0 0b 00 00       	mov    0xbd0,%eax
{
 ...
 5dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5df:	a3 d0 0b 00 00       	mov    %eax,0xbd0
}
 5e4:	5b                   	pop    %ebx
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
 ...
 5f6:	72 ce                	jb     5c6 <free+0x26>
{
 ...
 617:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61a:	a3 d0 0b 00 00       	mov    %eax,0xbd0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 63c:	8b 15 d0 0b 00 00    	mov    0xbd0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67f:	73 47                	jae    6c8 <malloc+0x98>
    ...
    if(p == freep)
 681:	39 05 d0 0b 00 00    	cmp    %eax,0xbd0
 ...
 6a6:	e8 f5 fe ff ff       	call   5a0 <free>
  return freep;
 6ab:	8b 15 d0 0b 00 00    	mov    0xbd0,%edx
 ...
 6d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6d7:	89 15 d0 0b 00 00    	mov    %edx,0xbd0
}
 ...
 6e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 d0 0b 00 00 d4 	movl   $0xbd4,0xbd0
 6f7:	0b 00 00 
 6fa:	c7 05 d4 0b 00 00 d4 	movl   $0xbd4,0xbd4
 701:	0b 00 00 
    base.s.size = 0;
 704:	b8 d4 0b 00 00       	mov    $0xbd4,%eax
 709:	c7 05 d8 0b 00 00 00 	movl   $0x0,0xbd8
 710:	00 00 00 
...
void* pmalloc(){
 ...
 734:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 737:	68 a5 08 00 00       	push   $0x8a5
 73c:	6a 01                	push   $0x1
 73e:	e8 8d fc ff ff       	call   3d0 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 743:	8b 1d dc 0b 00 00    	mov    0xbdc,%ebx
 749:	83 c4 10             	add    $0x10,%esp
 74c:	85 db                	test   %ebx,%ebx
 74e:	75 0e                	jne    75e <pmalloc+0x2e>
 750:	eb 2e                	jmp    780 <pmalloc+0x50>
 ...
 75a:	75 0f                	jne    76b <pmalloc+0x3b>
 75c:	89 c3                	mov    %eax,%ebx
  while(pl->next){
 75e:	8b 03                	mov    (%ebx),%eax
 760:	8b 53 04             	mov    0x4(%ebx),%edx
 763:	85 c0                	test   %eax,%eax
 765:	75 f1                	jne    758 <pmalloc+0x28>
      pl->isFree = 0;
      return pl;
    }
    pl = pl->next;
 ...
 767:	85 d2                	test   %edx,%edx
 769:	74 45                	je     7b0 <pmalloc+0x80>
    pl->isFree = 0;
 76b:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
 ...
 783:	ff 35 cc 0b 00 00    	pushl  0xbcc
 789:	e8 7c fb ff ff       	call   30a <sbrk>
 78e:	a3 dc 0b 00 00       	mov    %eax,0xbdc
    plink_freep->next = 0;
 793:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 799:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 79c:	8b 1d dc 0b 00 00    	mov    0xbdc,%ebx
 7a2:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
 ...
 7b3:	ff 35 cc 0b 00 00    	pushl  0xbcc
 7b9:	e8 4c fb ff ff       	call   30a <sbrk>
    pl->next = 0;
 7be:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
    pl->isFree = 0;
 7c4:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    return pl->next;
 7cb:	83 c4 10             	add    $0x10,%esp
 7ce:	31 db                	xor    %ebx,%ebx
 7d0:	eb a0                	jmp    772 <pmalloc+0x42>
...
int protect_page(void* ap){
 ...
 7e6:	a1 dc 0b 00 00       	mov    0xbdc,%eax
int protect_page(void* ap){
 7eb:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 7ee:	85 c0                	test   %eax,%eax
 7f0:	74 18                	je     80a <protect_page+0x2a>
    if(pl == ap){
 7f2:	39 d0                	cmp    %edx,%eax
 7f4:	75 0e                	jne    804 <protect_page+0x24>
 7f6:	eb 20                	jmp    818 <protect_page+0x38>
 7f8:	90                   	nop
 7f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 800:	39 c2                	cmp    %eax,%edx
 802:	74 14                	je     818 <protect_page+0x38>
      protectPage(pl);
      return 1;
    }
    pl = pl->next;
 ...
 808:	75 f6                	jne    800 <protect_page+0x20>
  }
	return -1;
 80a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 80f:	c9                   	leave  
 810:	c3                   	ret    
 ...
 81b:	52                   	push   %edx
 81c:	e8 01 fb ff ff       	call   322 <protectPage>
      return 1;
...
int pfree(void* ap){
 ...
 837:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 83a:	68 ae 08 00 00       	push   $0x8ae
 83f:	6a 01                	push   $0x1
 841:	e8 8a fb ff ff       	call   3d0 <printf>
  struct plink *pl = plink_freep;
 846:	a1 dc 0b 00 00       	mov    0xbdc,%eax
  while(pl){
 84b:	83 c4 10             	add    $0x10,%esp
 84e:	85 c0                	test   %eax,%eax
 850:	74 18                	je     86a <pfree+0x3a>
    if(pl == ap){
 852:	39 d8                	cmp    %ebx,%eax
 854:	75 0e                	jne    864 <pfree+0x34>
 856:	eb 20                	jmp    878 <pfree+0x48>
 858:	90                   	nop
 859:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 860:	39 c3                	cmp    %eax,%ebx
 862:	74 14                	je     878 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 868:	75 f6                	jne    860 <pfree+0x30>
  }
	return -1;
 86a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 86f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 872:	c9                   	leave  
 873:	c3                   	ret    
 874:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 878:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;
 87f:	b8 01 00 00 00       	mov    $0x1,%eax
}

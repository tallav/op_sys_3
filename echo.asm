...
main(int argc, char *argv[])
{
  ...
  28:	68 bc 08 00 00       	push   $0x8bc
  2d:	50                   	push   %eax
  2e:	68 be 08 00 00       	push   $0x8be
  33:	6a 01                	push   $0x1
  ...
  47:	68 e4 08 00 00       	push   $0x8e4
  4c:	50                   	push   %eax
  4d:	68 be 08 00 00       	push   $0x8be
  52:	6a 01                	push   $0x1
 ...
 379:	85 d2                	test   %edx,%edx
{
 ...
 3a7:	f7 f1                	div    %ecx
 3a9:	0f b6 92 cc 08 00 00 	movzbl 0x8cc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
          s = "(null)";
 5c9:	bb c3 08 00 00       	mov    $0x8c3,%ebx
        while(*s != 0){
...
void* pmalloc(){
 ...
 774:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 777:	68 dd 08 00 00       	push   $0x8dd
 77c:	6a 01                	push   $0x1
 77e:	e8 8d fc ff ff       	call   410 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 783:	8b 1d 1c 0c 00 00    	mov    0xc1c,%ebx
 ...
 7c3:	ff 35 0c 0c 00 00    	pushl  0xc0c
 7c9:	e8 7c fb ff ff       	call   34a <sbrk>
 7ce:	a3 1c 0c 00 00       	mov    %eax,0xc1c
    plink_freep->next = 0;
 7d3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 7d9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 7dc:	8b 1d 1c 0c 00 00    	mov    0xc1c,%ebx
 ...
 7f3:	ff 35 0c 0c 00 00    	pushl  0xc0c
...
int protect_page(void* ap){
 ...
 820:	a1 1c 0c 00 00       	mov    0xc1c,%eax
int protect_page(void* ap){
 825:	55                   	push   %ebp
...
int protect_page(void* ap){
 82a:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 82d:	74 13                	je     842 <protect_page+0x22>
    if(pl == ap){
 82f:	39 d0                	cmp    %edx,%eax
 831:	75 09                	jne    83c <protect_page+0x1c>
 833:	eb 1b                	jmp    850 <protect_page+0x30>
 835:	8d 76 00             	lea    0x0(%esi),%esi
 838:	39 c2                	cmp    %eax,%edx
 83a:	74 14                	je     850 <protect_page+0x30>
      // add system call 
      return 1;
    }
    pl = pl->next;
 ...
 840:	75 f6                	jne    838 <protect_page+0x18>
  }
	return -1;
...
int pfree(void* ap){
 ...
 867:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 86a:	68 e6 08 00 00       	push   $0x8e6
 86f:	6a 01                	push   $0x1
 871:	e8 9a fb ff ff       	call   410 <printf>
  struct plink *pl = plink_freep;
 876:	a1 1c 0c 00 00       	mov    0xc1c,%eax
  while(pl){

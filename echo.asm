...
main(int argc, char *argv[])
{
  ...
  47:	68 f4 08 00 00       	push   $0x8f4
  4c:	50                   	push   %eax
  4d:	68 ce 08 00 00       	push   $0x8ce
  52:	6a 01                	push   $0x1
 ...
 379:	85 d2                	test   %edx,%edx
{
 ...
 3a7:	f7 f1                	div    %ecx
 3a9:	0f b6 92 dc 08 00 00 	movzbl 0x8dc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
          s = "(null)";
 5c9:	bb d3 08 00 00       	mov    $0x8d3,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 20 0c 00 00       	mov    0xc20,%eax
{
 ...
 61d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 61f:	a3 20 0c 00 00       	mov    %eax,0xc20
}
 624:	5b                   	pop    %ebx
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
 ...
 636:	72 ce                	jb     606 <free+0x26>
{
 ...
 657:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65a:	a3 20 0c 00 00       	mov    %eax,0xc20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 67c:	8b 15 20 0c 00 00    	mov    0xc20,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 47                	jae    708 <malloc+0x98>
    ...
    if(p == freep)
 6c1:	39 05 20 0c 00 00    	cmp    %eax,0xc20
 ...
 6e6:	e8 f5 fe ff ff       	call   5e0 <free>
  return freep;
 6eb:	8b 15 20 0c 00 00    	mov    0xc20,%edx
 ...
 714:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 717:	89 15 20 0c 00 00    	mov    %edx,0xc20
}
 ...
 729:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 20 0c 00 00 24 	movl   $0xc24,0xc20
 737:	0c 00 00 
 73a:	c7 05 24 0c 00 00 24 	movl   $0xc24,0xc24
 741:	0c 00 00 
    base.s.size = 0;
 744:	b8 24 0c 00 00       	mov    $0xc24,%eax
 749:	c7 05 28 0c 00 00 00 	movl   $0x0,0xc28
 750:	00 00 00 
...
void* pmalloc(){
 ...
 774:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 777:	68 ed 08 00 00       	push   $0x8ed
 77c:	6a 01                	push   $0x1
 77e:	e8 8d fc ff ff       	call   410 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 783:	8b 1d 2c 0c 00 00    	mov    0xc2c,%ebx
 789:	83 c4 10             	add    $0x10,%esp
 78c:	85 db                	test   %ebx,%ebx
 78e:	75 0e                	jne    79e <pmalloc+0x2e>
 790:	eb 2e                	jmp    7c0 <pmalloc+0x50>
 ...
 79a:	75 0f                	jne    7ab <pmalloc+0x3b>
 79c:	89 c3                	mov    %eax,%ebx
  while(pl->next){
 79e:	8b 03                	mov    (%ebx),%eax
 7a0:	8b 53 04             	mov    0x4(%ebx),%edx
 7a3:	85 c0                	test   %eax,%eax
 7a5:	75 f1                	jne    798 <pmalloc+0x28>
      pl->isFree = 0;
      return pl;
    }
    pl = pl->next;
 ...
 7a9:	74 45                	je     7f0 <pmalloc+0x80>
    pl->isFree = 0;
 7ab:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
 ...
 7c3:	ff 35 1c 0c 00 00    	pushl  0xc1c
 7c9:	e8 7c fb ff ff       	call   34a <sbrk>
 7ce:	a3 2c 0c 00 00       	mov    %eax,0xc2c
    plink_freep->next = 0;
 7d3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 7d9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 7dc:	8b 1d 2c 0c 00 00    	mov    0xc2c,%ebx
 7e2:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
 7e9:	89 d8                	mov    %ebx,%eax
 7eb:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 7ee:	c9                   	leave  
 7ef:	c3                   	ret    
    pl->next = (struct plink*)sbrk(pageSize);
 7f0:	83 ec 0c             	sub    $0xc,%esp
 7f3:	ff 35 1c 0c 00 00    	pushl  0xc1c
 7f9:	e8 4c fb ff ff       	call   34a <sbrk>
    pl->next = 0;
 7fe:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
    pl->isFree = 0;
 804:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    return pl->next;
 80b:	83 c4 10             	add    $0x10,%esp
 80e:	31 db                	xor    %ebx,%ebx
 810:	eb a0                	jmp    7b2 <pmalloc+0x42>
 812:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 819:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00000820 <protect_page>:
...
int protect_page(void* ap){
 ...
 826:	a1 2c 0c 00 00       	mov    0xc2c,%eax
int protect_page(void* ap){
 82b:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 82e:	85 c0                	test   %eax,%eax
 830:	74 18                	je     84a <protect_page+0x2a>
    if(pl == ap){
 832:	39 d0                	cmp    %edx,%eax
 834:	75 0e                	jne    844 <protect_page+0x24>
 836:	eb 20                	jmp    858 <protect_page+0x38>
 838:	90                   	nop
 839:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 840:	39 c2                	cmp    %eax,%edx
 842:	74 14                	je     858 <protect_page+0x38>
      protectPage(pl);
      return 1;
    }
    pl = pl->next;
 ...
 848:	75 f6                	jne    840 <protect_page+0x20>
  }
	return -1;
 ...
 85b:	52                   	push   %edx
 85c:	e8 01 fb ff ff       	call   362 <protectPage>
      return 1;
...
int pfree(void* ap){
 ...
 877:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 87a:	68 f6 08 00 00       	push   $0x8f6
 87f:	6a 01                	push   $0x1
 881:	e8 8a fb ff ff       	call   410 <printf>
  struct plink *pl = plink_freep;
 886:	a1 2c 0c 00 00       	mov    0xc2c,%eax
  while(pl){
 88b:	83 c4 10             	add    $0x10,%esp
 88e:	85 c0                	test   %eax,%eax
 890:	74 18                	je     8aa <pfree+0x3a>
    if(pl == ap){
 892:	39 d8                	cmp    %ebx,%eax
 894:	75 0e                	jne    8a4 <pfree+0x34>
 896:	eb 20                	jmp    8b8 <pfree+0x48>
 898:	90                   	nop
 899:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 8a0:	39 c3                	cmp    %eax,%ebx
 8a2:	74 14                	je     8b8 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 8a8:	75 f6                	jne    8a0 <pfree+0x30>
  }
	return -1;
 8aa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 ...
 8b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 8b8:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;
 8bf:	b8 01 00 00 00       	mov    $0x1,%eax
}

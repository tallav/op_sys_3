...
main(int argc, char *argv[])
{
  ...
  28:	68 a0 08 00 00       	push   $0x8a0
  2d:	50                   	push   %eax
  2e:	68 a2 08 00 00       	push   $0x8a2
  33:	6a 01                	push   $0x1
  ...
  47:	68 a7 08 00 00       	push   $0x8a7
  4c:	50                   	push   %eax
  4d:	68 a2 08 00 00       	push   $0x8a2
  52:	6a 01                	push   $0x1
 ...
 379:	85 d2                	test   %edx,%edx
{
 ...
 3a7:	f7 f1                	div    %ecx
 3a9:	0f b6 92 b0 08 00 00 	movzbl 0x8b0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
          s = "(null)";
 5c9:	bb a9 08 00 00       	mov    $0x8a9,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 e8 0b 00 00       	mov    0xbe8,%eax
{
 ...
 61d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 61f:	a3 e8 0b 00 00       	mov    %eax,0xbe8
}
 624:	5b                   	pop    %ebx
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
 ...
 636:	72 ce                	jb     606 <free+0x26>
{
 ...
 657:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65a:	a3 e8 0b 00 00       	mov    %eax,0xbe8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 67c:	8b 15 e8 0b 00 00    	mov    0xbe8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 47                	jae    708 <malloc+0x98>
    ...
    if(p == freep)
 6c1:	39 05 e8 0b 00 00    	cmp    %eax,0xbe8
 ...
 6e6:	e8 f5 fe ff ff       	call   5e0 <free>
  return freep;
 6eb:	8b 15 e8 0b 00 00    	mov    0xbe8,%edx
 ...
 714:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 717:	89 15 e8 0b 00 00    	mov    %edx,0xbe8
}
 ...
 729:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 e8 0b 00 00 ec 	movl   $0xbec,0xbe8
 737:	0b 00 00 
 73a:	c7 05 ec 0b 00 00 ec 	movl   $0xbec,0xbec
 741:	0b 00 00 
    base.s.size = 0;
 744:	b8 ec 0b 00 00       	mov    $0xbec,%eax
 749:	c7 05 f0 0b 00 00 00 	movl   $0x0,0xbf0
 750:	00 00 00 
...
void* pmalloc(){
 ...
 777:	8b 1d f4 0b 00 00    	mov    0xbf4,%ebx
 77d:	85 db                	test   %ebx,%ebx
 77f:	75 0d                	jne    78e <pmalloc+0x1e>
 781:	eb 5d                	jmp    7e0 <pmalloc+0x70>
 783:	90                   	nop
 ...
 7b3:	ff 35 e4 0b 00 00    	pushl  0xbe4
 7b9:	e8 8c fb ff ff       	call   34a <sbrk>
 7be:	89 03                	mov    %eax,(%ebx)
    pl->next->next = 0;
 7c0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return pl->next;
 7c6:	83 c4 10             	add    $0x10,%esp
    pl->next->isFree = 0;
 7c9:	8b 03                	mov    (%ebx),%eax
 7cb:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    return pl->next;
 7d2:	8b 1b                	mov    (%ebx),%ebx
}
 ...
 7e3:	ff 35 e4 0b 00 00    	pushl  0xbe4
 7e9:	e8 5c fb ff ff       	call   34a <sbrk>
 7ee:	a3 f4 0b 00 00       	mov    %eax,0xbf4
    plink_freep->next = 0;
 7f3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 7f9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 7fc:	8b 1d f4 0b 00 00    	mov    0xbf4,%ebx
 802:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
 809:	89 d8                	mov    %ebx,%eax
 80b:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 80e:	c9                   	leave  
 80f:	c3                   	ret    
...
int protect_page(void* ap){
 ...
 816:	a1 f4 0b 00 00       	mov    0xbf4,%eax
int protect_page(void* ap){
 81b:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 81e:	85 c0                	test   %eax,%eax
 820:	74 18                	je     83a <protect_page+0x2a>
    if(pl == ap){
 822:	39 d0                	cmp    %edx,%eax
 824:	75 0e                	jne    834 <protect_page+0x24>
 826:	eb 20                	jmp    848 <protect_page+0x38>
 828:	90                   	nop
 829:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 830:	39 c2                	cmp    %eax,%edx
 832:	74 14                	je     848 <protect_page+0x38>
      protectPage(pl);
      return 1;
    }
    pl = pl->next;
 ...
 838:	75 f6                	jne    830 <protect_page+0x20>
  }
	return -1;
 ...
 84b:	52                   	push   %edx
 84c:	e8 11 fb ff ff       	call   362 <protectPage>
      return 1;
...
int pfree(void* ap){
  struct plink *pl = plink_freep;
 860:	a1 f4 0b 00 00       	mov    0xbf4,%eax
int pfree(void* ap){
 865:	55                   	push   %ebp
...
int pfree(void* ap){
 86a:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 86d:	74 13                	je     882 <pfree+0x22>
    if(pl == ap){
 86f:	39 d0                	cmp    %edx,%eax
 871:	75 09                	jne    87c <pfree+0x1c>
 873:	eb 1b                	jmp    890 <pfree+0x30>
 875:	8d 76 00             	lea    0x0(%esi),%esi
 878:	39 c2                	cmp    %eax,%edx
 87a:	74 14                	je     890 <pfree+0x30>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 880:	75 f6                	jne    878 <pfree+0x18>
  }
	return -1;
 882:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 887:	5d                   	pop    %ebp
 888:	c3                   	ret    
 889:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 890:	c7 42 04 01 00 00 00 	movl   $0x1,0x4(%edx)
      return 1;

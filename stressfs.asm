 ...
 449:	85 d2                	test   %edx,%edx
{
 ...
 477:	f7 f1                	div    %ecx
 479:	0f b6 92 9c 09 00 00 	movzbl 0x99c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb 93 09 00 00       	mov    $0x993,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b1:	a1 d8 0c 00 00       	mov    0xcd8,%eax
{
 ...
 6ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ef:	a3 d8 0c 00 00       	mov    %eax,0xcd8
}
 6f4:	5b                   	pop    %ebx
 6f5:	5e                   	pop    %esi
 6f6:	5f                   	pop    %edi
 ...
 706:	72 ce                	jb     6d6 <free+0x26>
{
 ...
 727:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 72a:	a3 d8 0c 00 00       	mov    %eax,0xcd8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 74c:	8b 15 d8 0c 00 00    	mov    0xcd8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 47                	jae    7d8 <malloc+0x98>
    ...
    if(p == freep)
 791:	39 05 d8 0c 00 00    	cmp    %eax,0xcd8
 ...
 7b6:	e8 f5 fe ff ff       	call   6b0 <free>
  return freep;
 7bb:	8b 15 d8 0c 00 00    	mov    0xcd8,%edx
 ...
 7e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7e7:	89 15 d8 0c 00 00    	mov    %edx,0xcd8
}
 ...
 7f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 d8 0c 00 00 dc 	movl   $0xcdc,0xcd8
 807:	0c 00 00 
 80a:	c7 05 dc 0c 00 00 dc 	movl   $0xcdc,0xcdc
 811:	0c 00 00 
    base.s.size = 0;
 814:	b8 dc 0c 00 00       	mov    $0xcdc,%eax
 819:	c7 05 e0 0c 00 00 00 	movl   $0x0,0xce0
 820:	00 00 00 
...
void* pmalloc(){
 ...
 847:	8b 1d e4 0c 00 00    	mov    0xce4,%ebx
 84d:	85 db                	test   %ebx,%ebx
 84f:	75 0d                	jne    85e <pmalloc+0x1e>
 851:	eb 5d                	jmp    8b0 <pmalloc+0x70>
 853:	90                   	nop
 ...
 85a:	75 0f                	jne    86b <pmalloc+0x2b>
 85c:	89 c3                	mov    %eax,%ebx
  while(pl->next){
 85e:	8b 03                	mov    (%ebx),%eax
 860:	8b 53 04             	mov    0x4(%ebx),%edx
 863:	85 c0                	test   %eax,%eax
 865:	75 f1                	jne    858 <pmalloc+0x18>
      pl->isFree = 0;
      return pl;
    }
    pl = pl->next;
 ...
 869:	74 15                	je     880 <pmalloc+0x40>
    pl->isFree = 0;
 86b:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    //printf(1, "plink=%d\n", pl->next);
    pl->next->next = 0;
    pl->next->isFree = 0;
    return pl->next;
 ...
 883:	ff 35 d4 0c 00 00    	pushl  0xcd4
 889:	e8 8c fb ff ff       	call   41a <sbrk>
 88e:	89 03                	mov    %eax,(%ebx)
    pl->next->next = 0;
 890:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return pl->next;
 896:	83 c4 10             	add    $0x10,%esp
    pl->next->isFree = 0;
 899:	8b 03                	mov    (%ebx),%eax
 89b:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    return pl->next;
 8a2:	8b 1b                	mov    (%ebx),%ebx
}
 ...
 8b3:	ff 35 d4 0c 00 00    	pushl  0xcd4
 8b9:	e8 5c fb ff ff       	call   41a <sbrk>
 8be:	a3 e4 0c 00 00       	mov    %eax,0xce4
    plink_freep->next = 0;
 8c3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 8c9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 8cc:	8b 1d e4 0c 00 00    	mov    0xce4,%ebx
 8d2:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
...
int protect_page(void* ap){
 ...
 8e6:	a1 e4 0c 00 00       	mov    0xce4,%eax
int protect_page(void* ap){
 8eb:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 8ee:	85 c0                	test   %eax,%eax
 8f0:	74 18                	je     90a <protect_page+0x2a>
    if(pl == ap){
 8f2:	39 d0                	cmp    %edx,%eax
 8f4:	75 0e                	jne    904 <protect_page+0x24>
 8f6:	eb 20                	jmp    918 <protect_page+0x38>
 8f8:	90                   	nop
 8f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 900:	39 c2                	cmp    %eax,%edx
 902:	74 14                	je     918 <protect_page+0x38>
      protectPage(pl);
      return 1;
    }
    pl = pl->next;
 ...
 908:	75 f6                	jne    900 <protect_page+0x20>
  }
	return -1;
 90a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 90f:	c9                   	leave  
 910:	c3                   	ret    
 ...
 91b:	52                   	push   %edx
 91c:	e8 11 fb ff ff       	call   432 <protectPage>
      return 1;
...
int pfree(void* ap){
  struct plink *pl = plink_freep;
 930:	a1 e4 0c 00 00       	mov    0xce4,%eax
int pfree(void* ap){
 935:	55                   	push   %ebp
...
int pfree(void* ap){
 93a:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 93d:	74 13                	je     952 <pfree+0x22>
    if(pl == ap){
 93f:	39 d0                	cmp    %edx,%eax
 941:	75 09                	jne    94c <pfree+0x1c>
 943:	eb 1b                	jmp    960 <pfree+0x30>
 945:	8d 76 00             	lea    0x0(%esi),%esi
 948:	39 c2                	cmp    %eax,%edx
 94a:	74 14                	je     960 <pfree+0x30>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 959:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 960:	c7 42 04 01 00 00 00 	movl   $0x1,0x4(%edx)
      return 1;

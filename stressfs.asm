 ...
 449:	85 d2                	test   %edx,%edx
{
 ...
 477:	f7 f1                	div    %ecx
 479:	0f b6 92 b8 09 00 00 	movzbl 0x9b8(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb af 09 00 00       	mov    $0x9af,%ebx
        while(*s != 0){
...
void* pmalloc(){
 ...
 844:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 847:	68 c9 09 00 00       	push   $0x9c9
 84c:	6a 01                	push   $0x1
 84e:	e8 8d fc ff ff       	call   4e0 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 853:	8b 1d 0c 0d 00 00    	mov    0xd0c,%ebx
 ...
 893:	ff 35 fc 0c 00 00    	pushl  0xcfc
 899:	e8 7c fb ff ff       	call   41a <sbrk>
 89e:	a3 0c 0d 00 00       	mov    %eax,0xd0c
    plink_freep->next = 0;
 8a3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 8a9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 8ac:	8b 1d 0c 0d 00 00    	mov    0xd0c,%ebx
 ...
 8c3:	ff 35 fc 0c 00 00    	pushl  0xcfc
...
int protect_page(void* ap){
 ...
 8f0:	a1 0c 0d 00 00       	mov    0xd0c,%eax
int protect_page(void* ap){
 8f5:	55                   	push   %ebp
...
int protect_page(void* ap){
 8fa:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 8fd:	74 13                	je     912 <protect_page+0x22>
    if(pl == ap){
 8ff:	39 d0                	cmp    %edx,%eax
 901:	75 09                	jne    90c <protect_page+0x1c>
 903:	eb 1b                	jmp    920 <protect_page+0x30>
 905:	8d 76 00             	lea    0x0(%esi),%esi
 908:	39 c2                	cmp    %eax,%edx
 90a:	74 14                	je     920 <protect_page+0x30>
      // add system call 
      return 1;
    }
    pl = pl->next;
 ...
 910:	75 f6                	jne    908 <protect_page+0x18>
  }
	return -1;
...
int pfree(void* ap){
 ...
 937:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 93a:	68 d2 09 00 00       	push   $0x9d2
 93f:	6a 01                	push   $0x1
 941:	e8 9a fb ff ff       	call   4e0 <printf>
  struct plink *pl = plink_freep;
 946:	a1 0c 0d 00 00       	mov    0xd0c,%eax
  while(pl){
 94b:	83 c4 10             	add    $0x10,%esp
 94e:	85 c0                	test   %eax,%eax
 950:	74 18                	je     96a <pfree+0x3a>
    if(pl == ap){
 952:	39 d8                	cmp    %ebx,%eax
 954:	75 0e                	jne    964 <pfree+0x34>
 956:	eb 20                	jmp    978 <pfree+0x48>
 958:	90                   	nop
 959:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 960:	39 c3                	cmp    %eax,%ebx
 962:	74 14                	je     978 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 968:	75 f6                	jne    960 <pfree+0x30>
  }
	return -1;
 96a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 96f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 972:	c9                   	leave  
 973:	c3                   	ret    
 974:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 978:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;
 97f:	b8 01 00 00 00       	mov    $0x1,%eax
}
 984:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 987:	c9                   	leave  
 988:	c3                   	ret    

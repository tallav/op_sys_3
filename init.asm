...
main(void)
{
  ...
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 e0 0c 00 00       	push   $0xce0
  ab:	68 7a 09 00 00       	push   $0x97a
  b0:	e8 c5 02 00 00       	call   37a <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 7d 09 00 00       	push   $0x97d
  bc:	6a 01                	push   $0x1
  ...
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 4c 09 00 00       	push   $0x94c
  d2:	e8 b3 02 00 00       	call   38a <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 4c 09 00 00       	push   $0x94c
 ...
 3f9:	85 d2                	test   %edx,%edx
{
 ...
 427:	f7 f1                	div    %ecx
 429:	0f b6 92 a4 09 00 00 	movzbl 0x9a4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 644:	e9 8f fe ff ff       	jmp    4d8 <printf+0x48>
          s = "(null)";
 649:	bb 9c 09 00 00       	mov    $0x99c,%ebx
        while(*s != 0){
 ...
 661:	a1 ec 0c 00 00       	mov    0xcec,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 ec 0c 00 00       	mov    %eax,0xcec
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
 ...
 6b6:	72 ce                	jb     686 <free+0x26>
{
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 ec 0c 00 00       	mov    %eax,0xcec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6fc:	8b 15 ec 0c 00 00    	mov    0xcec,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 47                	jae    788 <malloc+0x98>
    ...
    if(p == freep)
 741:	39 05 ec 0c 00 00    	cmp    %eax,0xcec
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
  return freep;
 76b:	8b 15 ec 0c 00 00    	mov    0xcec,%edx
 ...
 794:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 797:	89 15 ec 0c 00 00    	mov    %edx,0xcec
}
 ...
 7a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 ec 0c 00 00 f0 	movl   $0xcf0,0xcec
 7b7:	0c 00 00 
 7ba:	c7 05 f0 0c 00 00 f0 	movl   $0xcf0,0xcf0
 7c1:	0c 00 00 
    base.s.size = 0;
 7c4:	b8 f0 0c 00 00       	mov    $0xcf0,%eax
 7c9:	c7 05 f4 0c 00 00 00 	movl   $0x0,0xcf4
 7d0:	00 00 00 
...
void* pmalloc(){
 ...
 7f4:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 7f7:	68 b5 09 00 00       	push   $0x9b5
 7fc:	6a 01                	push   $0x1
 7fe:	e8 8d fc ff ff       	call   490 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 803:	8b 1d f8 0c 00 00    	mov    0xcf8,%ebx
 809:	83 c4 10             	add    $0x10,%esp
 80c:	85 db                	test   %ebx,%ebx
 80e:	75 0e                	jne    81e <pmalloc+0x2e>
 810:	eb 2e                	jmp    840 <pmalloc+0x50>
 ...
 81a:	75 0f                	jne    82b <pmalloc+0x3b>
 81c:	89 c3                	mov    %eax,%ebx
  while(pl->next){
 81e:	8b 03                	mov    (%ebx),%eax
 820:	8b 53 04             	mov    0x4(%ebx),%edx
 823:	85 c0                	test   %eax,%eax
 825:	75 f1                	jne    818 <pmalloc+0x28>
      pl->isFree = 0;
      return pl;
    }
    pl = pl->next;
 ...
 827:	85 d2                	test   %edx,%edx
 829:	74 45                	je     870 <pmalloc+0x80>
    pl->isFree = 0;
 82b:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
 ...
 843:	ff 35 e8 0c 00 00    	pushl  0xce8
 849:	e8 7c fb ff ff       	call   3ca <sbrk>
 84e:	a3 f8 0c 00 00       	mov    %eax,0xcf8
    plink_freep->next = 0;
 853:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 859:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 85c:	8b 1d f8 0c 00 00    	mov    0xcf8,%ebx
 862:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
 ...
 873:	ff 35 e8 0c 00 00    	pushl  0xce8
 879:	e8 4c fb ff ff       	call   3ca <sbrk>
    pl->next = 0;
 87e:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
    pl->isFree = 0;
 884:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    return pl->next;
 88b:	83 c4 10             	add    $0x10,%esp
 88e:	31 db                	xor    %ebx,%ebx
 890:	eb a0                	jmp    832 <pmalloc+0x42>
...
int protect_page(void* ap){
 ...
 8a6:	a1 f8 0c 00 00       	mov    0xcf8,%eax
int protect_page(void* ap){
 8ab:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 8ae:	85 c0                	test   %eax,%eax
 8b0:	74 18                	je     8ca <protect_page+0x2a>
    if(pl == ap){
 8b2:	39 d0                	cmp    %edx,%eax
 8b4:	75 0e                	jne    8c4 <protect_page+0x24>
 8b6:	eb 20                	jmp    8d8 <protect_page+0x38>
 8b8:	90                   	nop
 8b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 8c0:	39 c2                	cmp    %eax,%edx
 8c2:	74 14                	je     8d8 <protect_page+0x38>
      protectPage(pl);
      return 1;
    }
    pl = pl->next;
 ...
 8c8:	75 f6                	jne    8c0 <protect_page+0x20>
  }
	return -1;
 ...
 8db:	52                   	push   %edx
 8dc:	e8 01 fb ff ff       	call   3e2 <protectPage>
      return 1;
...
int pfree(void* ap){
 ...
 8f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 8fa:	68 be 09 00 00       	push   $0x9be
 8ff:	6a 01                	push   $0x1
 901:	e8 8a fb ff ff       	call   490 <printf>
  struct plink *pl = plink_freep;
 906:	a1 f8 0c 00 00       	mov    0xcf8,%eax
  while(pl){
 90b:	83 c4 10             	add    $0x10,%esp
 90e:	85 c0                	test   %eax,%eax
 910:	74 18                	je     92a <pfree+0x3a>
    if(pl == ap){
 912:	39 d8                	cmp    %ebx,%eax
 914:	75 0e                	jne    924 <pfree+0x34>
 916:	eb 20                	jmp    938 <pfree+0x48>
 918:	90                   	nop
 919:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 920:	39 c3                	cmp    %eax,%ebx
 922:	74 14                	je     938 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 934:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 938:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;

...
main(void)
{
  ...
  ab:	68 6a 09 00 00       	push   $0x96a
  b0:	e8 c5 02 00 00       	call   37a <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 6d 09 00 00       	push   $0x96d
  bc:	6a 01                	push   $0x1
  ...
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 3c 09 00 00       	push   $0x93c
  d2:	e8 b3 02 00 00       	call   38a <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 3c 09 00 00       	push   $0x93c
 ...
 3f9:	85 d2                	test   %edx,%edx
{
 ...
 427:	f7 f1                	div    %ecx
 429:	0f b6 92 94 09 00 00 	movzbl 0x994(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 644:	e9 8f fe ff ff       	jmp    4d8 <printf+0x48>
          s = "(null)";
 649:	bb 8c 09 00 00       	mov    $0x98c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 dc 0c 00 00       	mov    0xcdc,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 dc 0c 00 00       	mov    %eax,0xcdc
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
 ...
 6b6:	72 ce                	jb     686 <free+0x26>
{
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 dc 0c 00 00       	mov    %eax,0xcdc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6fc:	8b 15 dc 0c 00 00    	mov    0xcdc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 47                	jae    788 <malloc+0x98>
    ...
    if(p == freep)
 741:	39 05 dc 0c 00 00    	cmp    %eax,0xcdc
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
  return freep;
 76b:	8b 15 dc 0c 00 00    	mov    0xcdc,%edx
 ...
 794:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 797:	89 15 dc 0c 00 00    	mov    %edx,0xcdc
}
 ...
 7a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 dc 0c 00 00 e0 	movl   $0xce0,0xcdc
 7b7:	0c 00 00 
 7ba:	c7 05 e0 0c 00 00 e0 	movl   $0xce0,0xce0
 7c1:	0c 00 00 
    base.s.size = 0;
 7c4:	b8 e0 0c 00 00       	mov    $0xce0,%eax
 7c9:	c7 05 e4 0c 00 00 00 	movl   $0x0,0xce4
 7d0:	00 00 00 
...
void* pmalloc(){
 ...
 7f4:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 7f7:	68 a5 09 00 00       	push   $0x9a5
 7fc:	6a 01                	push   $0x1
 7fe:	e8 8d fc ff ff       	call   490 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 803:	8b 1d e8 0c 00 00    	mov    0xce8,%ebx
 ...
 843:	ff 35 d8 0c 00 00    	pushl  0xcd8
 849:	e8 7c fb ff ff       	call   3ca <sbrk>
 84e:	a3 e8 0c 00 00       	mov    %eax,0xce8
    plink_freep->next = 0;
 853:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 859:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 85c:	8b 1d e8 0c 00 00    	mov    0xce8,%ebx
 ...
 873:	ff 35 d8 0c 00 00    	pushl  0xcd8
...
int protect_page(void* ap){
 ...
 8a0:	a1 e8 0c 00 00       	mov    0xce8,%eax
int protect_page(void* ap){
 8a5:	55                   	push   %ebp
...
int protect_page(void* ap){
 8aa:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 8ad:	74 13                	je     8c2 <protect_page+0x22>
    if(pl == ap){
 8af:	39 d0                	cmp    %edx,%eax
 8b1:	75 09                	jne    8bc <protect_page+0x1c>
 8b3:	eb 1b                	jmp    8d0 <protect_page+0x30>
 8b5:	8d 76 00             	lea    0x0(%esi),%esi
 8b8:	39 c2                	cmp    %eax,%edx
 8ba:	74 14                	je     8d0 <protect_page+0x30>
      // add system call 
      return 1;
    }
    pl = pl->next;
 ...
 8c0:	75 f6                	jne    8b8 <protect_page+0x18>
  }
	return -1;
...
int pfree(void* ap){
 ...
 8e7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 8ea:	68 ae 09 00 00       	push   $0x9ae
 8ef:	6a 01                	push   $0x1
 8f1:	e8 9a fb ff ff       	call   490 <printf>
  struct plink *pl = plink_freep;
 8f6:	a1 e8 0c 00 00       	mov    0xce8,%eax
  while(pl){
 8fb:	83 c4 10             	add    $0x10,%esp
 8fe:	85 c0                	test   %eax,%eax
 900:	74 18                	je     91a <pfree+0x3a>
    if(pl == ap){
 902:	39 d8                	cmp    %ebx,%eax
 904:	75 0e                	jne    914 <pfree+0x34>
 906:	eb 20                	jmp    928 <pfree+0x48>
 908:	90                   	nop
 909:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 910:	39 c3                	cmp    %eax,%ebx
 912:	74 14                	je     928 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 924:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 928:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;
 92f:	b8 01 00 00 00       	mov    $0x1,%eax
}

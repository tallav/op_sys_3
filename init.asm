...
main(void)
{
  ...
  ab:	68 4e 09 00 00       	push   $0x94e
  b0:	e8 c5 02 00 00       	call   37a <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 51 09 00 00       	push   $0x951
  bc:	6a 01                	push   $0x1
  ...
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 20 09 00 00       	push   $0x920
  d2:	e8 b3 02 00 00       	call   38a <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 20 09 00 00       	push   $0x920
 ...
 3f9:	85 d2                	test   %edx,%edx
{
 ...
 427:	f7 f1                	div    %ecx
 429:	0f b6 92 78 09 00 00 	movzbl 0x978(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 644:	e9 8f fe ff ff       	jmp    4d8 <printf+0x48>
          s = "(null)";
 649:	bb 70 09 00 00       	mov    $0x970,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 b4 0c 00 00       	mov    0xcb4,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 b4 0c 00 00       	mov    %eax,0xcb4
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
 ...
 6b6:	72 ce                	jb     686 <free+0x26>
{
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 b4 0c 00 00       	mov    %eax,0xcb4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6fc:	8b 15 b4 0c 00 00    	mov    0xcb4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 47                	jae    788 <malloc+0x98>
    ...
    if(p == freep)
 741:	39 05 b4 0c 00 00    	cmp    %eax,0xcb4
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
  return freep;
 76b:	8b 15 b4 0c 00 00    	mov    0xcb4,%edx
 ...
 794:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 797:	89 15 b4 0c 00 00    	mov    %edx,0xcb4
}
 ...
 7a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 b4 0c 00 00 b8 	movl   $0xcb8,0xcb4
 7b7:	0c 00 00 
 7ba:	c7 05 b8 0c 00 00 b8 	movl   $0xcb8,0xcb8
 7c1:	0c 00 00 
    base.s.size = 0;
 7c4:	b8 b8 0c 00 00       	mov    $0xcb8,%eax
 7c9:	c7 05 bc 0c 00 00 00 	movl   $0x0,0xcbc
 7d0:	00 00 00 
...
void* pmalloc(){
 ...
 7f7:	8b 1d c0 0c 00 00    	mov    0xcc0,%ebx
 7fd:	85 db                	test   %ebx,%ebx
 7ff:	75 0d                	jne    80e <pmalloc+0x1e>
 801:	eb 5d                	jmp    860 <pmalloc+0x70>
 803:	90                   	nop
 ...
 80a:	75 0f                	jne    81b <pmalloc+0x2b>
 80c:	89 c3                	mov    %eax,%ebx
  while(pl->next){
 80e:	8b 03                	mov    (%ebx),%eax
 810:	8b 53 04             	mov    0x4(%ebx),%edx
 813:	85 c0                	test   %eax,%eax
 815:	75 f1                	jne    808 <pmalloc+0x18>
      pl->isFree = 0;
      return pl;
    }
    pl = pl->next;
 ...
 819:	74 15                	je     830 <pmalloc+0x40>
    pl->isFree = 0;
 81b:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    //printf(1, "plink=%d\n", pl->next);
    pl->next->next = 0;
    pl->next->isFree = 0;
    return pl->next;
 ...
 833:	ff 35 b0 0c 00 00    	pushl  0xcb0
 839:	e8 8c fb ff ff       	call   3ca <sbrk>
 83e:	89 03                	mov    %eax,(%ebx)
    pl->next->next = 0;
 840:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return pl->next;
 846:	83 c4 10             	add    $0x10,%esp
    pl->next->isFree = 0;
 849:	8b 03                	mov    (%ebx),%eax
 84b:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    return pl->next;
 852:	8b 1b                	mov    (%ebx),%ebx
}
 ...
 863:	ff 35 b0 0c 00 00    	pushl  0xcb0
 869:	e8 5c fb ff ff       	call   3ca <sbrk>
 86e:	a3 c0 0c 00 00       	mov    %eax,0xcc0
    plink_freep->next = 0;
 873:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 879:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 87c:	8b 1d c0 0c 00 00    	mov    0xcc0,%ebx
 882:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
...
int protect_page(void* ap){
 ...
 896:	a1 c0 0c 00 00       	mov    0xcc0,%eax
int protect_page(void* ap){
 89b:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 89e:	85 c0                	test   %eax,%eax
 8a0:	74 18                	je     8ba <protect_page+0x2a>
    if(pl == ap){
 8a2:	39 d0                	cmp    %edx,%eax
 8a4:	75 0e                	jne    8b4 <protect_page+0x24>
 8a6:	eb 20                	jmp    8c8 <protect_page+0x38>
 8a8:	90                   	nop
 8a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 8b0:	39 c2                	cmp    %eax,%edx
 8b2:	74 14                	je     8c8 <protect_page+0x38>
      protectPage(pl);
      return 1;
    }
    pl = pl->next;
 ...
 8b8:	75 f6                	jne    8b0 <protect_page+0x20>
  }
	return -1;
 ...
 8cb:	52                   	push   %edx
 8cc:	e8 11 fb ff ff       	call   3e2 <protectPage>
      return 1;
...
int pfree(void* ap){
  struct plink *pl = plink_freep;
 8e0:	a1 c0 0c 00 00       	mov    0xcc0,%eax
int pfree(void* ap){
 8e5:	55                   	push   %ebp
...
int pfree(void* ap){
 8ea:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 8ed:	74 13                	je     902 <pfree+0x22>
    if(pl == ap){
 8ef:	39 d0                	cmp    %edx,%eax
 8f1:	75 09                	jne    8fc <pfree+0x1c>
 8f3:	eb 1b                	jmp    910 <pfree+0x30>
 8f5:	8d 76 00             	lea    0x0(%esi),%esi
 8f8:	39 c2                	cmp    %eax,%edx
 8fa:	74 14                	je     910 <pfree+0x30>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 909:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 910:	c7 42 04 01 00 00 00 	movl   $0x1,0x4(%edx)
      return 1;
 917:	b8 01 00 00 00       	mov    $0x1,%eax
}
 91c:	5d                   	pop    %ebp
 91d:	c3                   	ret    

 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3b7:	f7 f1                	div    %ecx
 3b9:	0f b6 92 10 09 00 00 	movzbl 0x910(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb 09 09 00 00       	mov    $0x909,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 58 0c 00 00       	mov    0xc58,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 58 0c 00 00       	mov    %eax,0xc58
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 58 0c 00 00       	mov    %eax,0xc58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 68c:	8b 15 58 0c 00 00    	mov    0xc58,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
    ...
    if(p == freep)
 6d1:	39 05 58 0c 00 00    	cmp    %eax,0xc58
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
  return freep;
 6fb:	8b 15 58 0c 00 00    	mov    0xc58,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 727:	89 15 58 0c 00 00    	mov    %edx,0xc58
}
 ...
 739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 58 0c 00 00 5c 	movl   $0xc5c,0xc58
 747:	0c 00 00 
 74a:	c7 05 5c 0c 00 00 5c 	movl   $0xc5c,0xc5c
 751:	0c 00 00 
    base.s.size = 0;
 754:	b8 5c 0c 00 00       	mov    $0xc5c,%eax
 759:	c7 05 60 0c 00 00 00 	movl   $0x0,0xc60
 760:	00 00 00 
...
void* pmalloc(){
 ...
 784:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 787:	68 21 09 00 00       	push   $0x921
 78c:	6a 01                	push   $0x1
 78e:	e8 8d fc ff ff       	call   420 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 793:	8b 1d 64 0c 00 00    	mov    0xc64,%ebx
 ...
 7d3:	ff 35 54 0c 00 00    	pushl  0xc54
 7d9:	e8 7c fb ff ff       	call   35a <sbrk>
 7de:	a3 64 0c 00 00       	mov    %eax,0xc64
    plink_freep->next = 0;
 7e3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 7e9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 7ec:	8b 1d 64 0c 00 00    	mov    0xc64,%ebx
 ...
 803:	ff 35 54 0c 00 00    	pushl  0xc54
...
int protect_page(void* ap){
 ...
 836:	a1 64 0c 00 00       	mov    0xc64,%eax
int protect_page(void* ap){

 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3b7:	f7 f1                	div    %ecx
 3b9:	0f b6 92 00 09 00 00 	movzbl 0x900(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb f9 08 00 00       	mov    $0x8f9,%ebx
        while(*s != 0){
...
void* pmalloc(){
 ...
 784:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 787:	68 11 09 00 00       	push   $0x911
 78c:	6a 01                	push   $0x1
 78e:	e8 8d fc ff ff       	call   420 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 793:	8b 1d 54 0c 00 00    	mov    0xc54,%ebx
 ...
 7d3:	ff 35 44 0c 00 00    	pushl  0xc44
 7d9:	e8 7c fb ff ff       	call   35a <sbrk>
 7de:	a3 54 0c 00 00       	mov    %eax,0xc54
    plink_freep->next = 0;
 7e3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 7e9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 7ec:	8b 1d 54 0c 00 00    	mov    0xc54,%ebx
 ...
 803:	ff 35 44 0c 00 00    	pushl  0xc44
...
int protect_page(void* ap){
 ...
 830:	a1 54 0c 00 00       	mov    0xc54,%eax
int protect_page(void* ap){
 835:	55                   	push   %ebp
...
int pfree(void* ap){
 ...
 877:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 87a:	68 1a 09 00 00       	push   $0x91a
 87f:	6a 01                	push   $0x1
 881:	e8 9a fb ff ff       	call   420 <printf>
  struct plink *pl = plink_freep;
 886:	a1 54 0c 00 00       	mov    0xc54,%eax
  while(pl){

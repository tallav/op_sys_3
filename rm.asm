 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3b7:	f7 f1                	div    %ecx
 3b9:	0f b6 92 e4 08 00 00 	movzbl 0x8e4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb dd 08 00 00       	mov    $0x8dd,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 20 0c 00 00       	mov    0xc20,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 20 0c 00 00       	mov    %eax,0xc20
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 20 0c 00 00       	mov    %eax,0xc20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 68c:	8b 15 20 0c 00 00    	mov    0xc20,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
    ...
    if(p == freep)
 6d1:	39 05 20 0c 00 00    	cmp    %eax,0xc20
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
  return freep;
 6fb:	8b 15 20 0c 00 00    	mov    0xc20,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 727:	89 15 20 0c 00 00    	mov    %edx,0xc20
}
 ...
 739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 20 0c 00 00 24 	movl   $0xc24,0xc20
 747:	0c 00 00 
 74a:	c7 05 24 0c 00 00 24 	movl   $0xc24,0xc24
 751:	0c 00 00 
    base.s.size = 0;
 754:	b8 24 0c 00 00       	mov    $0xc24,%eax
 759:	c7 05 28 0c 00 00 00 	movl   $0x0,0xc28
 760:	00 00 00 
...
void* pmalloc(){
 ...
 787:	8b 1d 2c 0c 00 00    	mov    0xc2c,%ebx
 ...
 7fe:	a3 2c 0c 00 00       	mov    %eax,0xc2c
    plink_freep->next = 0;
 803:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 809:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 80c:	8b 1d 2c 0c 00 00    	mov    0xc2c,%ebx
...
int pfree(void* ap){
  struct plink *pl = plink_freep;
 870:	a1 2c 0c 00 00       	mov    0xc2c,%eax
int pfree(void* ap){
 875:	55                   	push   %ebp

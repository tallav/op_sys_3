...
00000100 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     10e:	68 0c 13 00 00       	push   $0x130c
     113:	6a 02                	push   $0x2
...
00000150 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     159:	68 a9 13 00 00       	push   $0x13a9
     15e:	6a 02                	push   $0x2
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     189:	ff 24 85 c4 13 00 00 	jmp    *0x13c4(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1a9:	68 16 13 00 00       	push   $0x1316
     1ae:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     1fd:	68 26 13 00 00       	push   $0x1326
     202:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     290:	68 0f 13 00 00       	push   $0x130f
     295:	e8 b6 fe ff ff       	call   150 <panic>
    panic("fork");
     29a:	83 ec 0c             	sub    $0xc,%esp
     29d:	68 36 13 00 00       	push   $0x1336
     ...
     2d8:	68 3b 13 00 00       	push   $0x133b
...
00000310 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     325:	68 36 13 00 00       	push   $0x1336
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 54 1a 00 00       	push   $0x1a54
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 54 1a 00 00       	push   $0x1a54
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 4c 1a 00 00       	push   $0x1a4c
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 54 1a 00 00       	push   $0x1a54
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 54 1a 00 00       	push   $0x1a54
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     653:	68 5d 13 00 00       	push   $0x135d
     658:	53                   	push   %ebx
     659:	56                   	push   %esi
  ...
  return cmd;
     ...
     6de:	68 40 13 00 00       	push   $0x1340
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     6ff:	68 60 13 00 00       	push   $0x1360
     704:	57                   	push   %edi
     705:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     74e:	68 77 13 00 00       	push   $0x1377
     753:	57                   	push   %edi
     754:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     798:	68 69 13 00 00       	push   $0x1369
  ...
  cmd->eargv[argc] = 0;
     ...
     7ea:	68 62 13 00 00       	push   $0x1362
...
00000800 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     81b:	68 7c 13 00 00       	push   $0x137c
     820:	56                   	push   %esi
     821:	53                   	push   %ebx
...
00000870 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8ab:	68 7e 13 00 00       	push   $0x137e
     8b0:	56                   	push   %esi
     8b1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8c1:	68 7a 13 00 00       	push   $0x137a
     8c6:	56                   	push   %esi
     8c7:	53                   	push   %ebx
...
00000910 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     91f:	68 60 13 00 00       	push   $0x1360
     924:	56                   	push   %esi
     925:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     94b:	68 9c 13 00 00       	push   $0x139c
     950:	56                   	push   %esi
     951:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9b5:	ff 24 85 dc 13 00 00 	jmp    *0x13dc(,%eax,4)
...
00000a50 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a77:	68 15 14 00 00       	push   $0x1415
     a7c:	53                   	push   %ebx
     a7d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     a9f:	52                   	push   %edx
     aa0:	50                   	push   %eax
     aa1:	68 9e 13 00 00       	push   $0x139e
     aa6:	6a 02                	push   $0x2
     aa8:	e8 b3 03 00 00       	call   e60 <printf>
    panic("syntax");
     aad:	c7 04 24 62 13 00 00 	movl   $0x1362,(%esp)
     ...
     dc9:	85 d2                	test   %edx,%edx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     df7:	f7 f1                	div    %ecx
     df9:	0f b6 92 fc 13 00 00 	movzbl 0x13fc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1014:	e9 8f fe ff ff       	jmp    ea8 <printf+0x48>
          s = "(null)";
    1019:	bb f4 13 00 00       	mov    $0x13f4,%ebx
        while(*s != 0){
...
void* pmalloc(){
  ...
  printf(1, "pmalloc\n");
    11c7:	68 0d 14 00 00       	push   $0x140d
    11cc:	6a 01                	push   $0x1
    11ce:	e8 8d fc ff ff       	call   e60 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
    11d3:	8b 1d d0 1a 00 00    	mov    0x1ad0,%ebx
  ...
  if(pl->isFree){ // reached last link
    ...
    1213:	ff 35 5c 1a 00 00    	pushl  0x1a5c
    1219:	e8 7c fb ff ff       	call   d9a <sbrk>
    121e:	a3 d0 1a 00 00       	mov    %eax,0x1ad0
    plink_freep->next = 0;
    1223:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
    1229:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
    122c:	8b 1d d0 1a 00 00    	mov    0x1ad0,%ebx
    ...
    1243:	ff 35 5c 1a 00 00    	pushl  0x1a5c
...
int protect_page(void* ap){
  struct plink *pl = plink_freep;
    1270:	a1 d0 1a 00 00       	mov    0x1ad0,%eax
int protect_page(void* ap){
    1275:	55                   	push   %ebp
...
int protect_page(void* ap){
    127a:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
    127d:	74 13                	je     1292 <protect_page+0x22>
    if(pl == ap){
    127f:	39 d0                	cmp    %edx,%eax
    1281:	75 09                	jne    128c <protect_page+0x1c>
    1283:	eb 1b                	jmp    12a0 <protect_page+0x30>
    1285:	8d 76 00             	lea    0x0(%esi),%esi
    1288:	39 c2                	cmp    %eax,%edx
    128a:	74 14                	je     12a0 <protect_page+0x30>
      // add system call 
      return 1;
    }
    pl = pl->next;
  ...
  while(pl){
    ...
    1290:	75 f6                	jne    1288 <protect_page+0x18>
  }
	return -1;
...
int pfree(void* ap){
    ...
    12b3:	53                   	push   %ebx
    12b4:	83 ec 0c             	sub    $0xc,%esp
    12b7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
    12ba:	68 16 14 00 00       	push   $0x1416
    12bf:	6a 01                	push   $0x1
    12c1:	e8 9a fb ff ff       	call   e60 <printf>
  struct plink *pl = plink_freep;
    12c6:	a1 d0 1a 00 00       	mov    0x1ad0,%eax
  while(pl){
    12cb:	83 c4 10             	add    $0x10,%esp
    12ce:	85 c0                	test   %eax,%eax
    12d0:	74 18                	je     12ea <pfree+0x3a>
    if(pl == ap){
    12d2:	39 d8                	cmp    %ebx,%eax
    12d4:	75 0e                	jne    12e4 <pfree+0x34>
    12d6:	eb 20                	jmp    12f8 <pfree+0x48>
    12d8:	90                   	nop
    12d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    12e0:	39 c3                	cmp    %eax,%ebx
    12e2:	74 14                	je     12f8 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
  ...
  while(pl){
    ...
    12e8:	75 f6                	jne    12e0 <pfree+0x30>
  }
	return -1;
    12ea:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    12ef:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    12f2:	c9                   	leave  
    12f3:	c3                   	ret    
    12f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
    12f8:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;
    12ff:	b8 01 00 00 00       	mov    $0x1,%eax
}
    1304:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    1307:	c9                   	leave  
    1308:	c3                   	ret    

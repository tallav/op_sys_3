...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      38:	80 3d 82 1a 00 00 20 	cmpb   $0x20,0x1a82
...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
      ...
      57:	6a 64                	push   $0x64
      59:	68 80 1a 00 00       	push   $0x1a80
      5e:	e8 9d 00 00 00       	call   100 <getcmd>
      63:	83 c4 10             	add    $0x10,%esp
      66:	85 c0                	test   %eax,%eax
      68:	78 37                	js     a1 <main+0xa1>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      6a:	80 3d 80 1a 00 00 63 	cmpb   $0x63,0x1a80
      71:	75 ce                	jne    41 <main+0x41>
      73:	80 3d 81 1a 00 00 64 	cmpb   $0x64,0x1a81
  ...
  exit();
      ...
      e6:	50                   	push   %eax
      e7:	68 83 1a 00 00       	push   $0x1a83
      ec:	68 c5 13 00 00       	push   $0x13c5
      f1:	6a 02                	push   $0x2
...
00000100 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     10e:	68 1c 13 00 00       	push   $0x131c
     113:	6a 02                	push   $0x2
...
00000150 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     159:	68 b9 13 00 00       	push   $0x13b9
     15e:	6a 02                	push   $0x2
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     189:	ff 24 85 d4 13 00 00 	jmp    *0x13d4(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1a9:	68 26 13 00 00       	push   $0x1326
     1ae:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     1fd:	68 36 13 00 00       	push   $0x1336
     202:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     290:	68 1f 13 00 00       	push   $0x131f
     295:	e8 b6 fe ff ff       	call   150 <panic>
    panic("fork");
     29a:	83 ec 0c             	sub    $0xc,%esp
     29d:	68 46 13 00 00       	push   $0x1346
     ...
     2d8:	68 4b 13 00 00       	push   $0x134b
...
00000310 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     325:	68 46 13 00 00       	push   $0x1346
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 64 1a 00 00       	push   $0x1a64
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 5c 1a 00 00       	push   $0x1a5c
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 64 1a 00 00       	push   $0x1a64
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 64 1a 00 00       	push   $0x1a64
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     653:	68 6d 13 00 00       	push   $0x136d
     658:	53                   	push   %ebx
     659:	56                   	push   %esi
  ...
  return cmd;
     ...
     6de:	68 50 13 00 00       	push   $0x1350
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     6ff:	68 70 13 00 00       	push   $0x1370
     704:	57                   	push   %edi
     705:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     74e:	68 87 13 00 00       	push   $0x1387
     753:	57                   	push   %edi
     754:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     798:	68 79 13 00 00       	push   $0x1379
  ...
  cmd->eargv[argc] = 0;
     ...
     7ea:	68 72 13 00 00       	push   $0x1372
...
00000800 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     81b:	68 8c 13 00 00       	push   $0x138c
     820:	56                   	push   %esi
     821:	53                   	push   %ebx
...
00000870 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8ab:	68 8e 13 00 00       	push   $0x138e
     8b0:	56                   	push   %esi
     8b1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8c1:	68 8a 13 00 00       	push   $0x138a
     8c6:	56                   	push   %esi
     8c7:	53                   	push   %ebx
...
00000910 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     91f:	68 70 13 00 00       	push   $0x1370
     924:	56                   	push   %esi
     925:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     94b:	68 ac 13 00 00       	push   $0x13ac
     950:	56                   	push   %esi
     951:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9b5:	ff 24 85 ec 13 00 00 	jmp    *0x13ec(,%eax,4)
...
00000a50 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a77:	68 25 14 00 00       	push   $0x1425
     a7c:	53                   	push   %ebx
     a7d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     a9f:	52                   	push   %edx
     aa0:	50                   	push   %eax
     aa1:	68 ae 13 00 00       	push   $0x13ae
     aa6:	6a 02                	push   $0x2
     aa8:	e8 b3 03 00 00       	call   e60 <printf>
    panic("syntax");
     aad:	c7 04 24 72 13 00 00 	movl   $0x1372,(%esp)
     ...
     dc9:	85 d2                	test   %edx,%edx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     df7:	f7 f1                	div    %ecx
     df9:	0f b6 92 0c 14 00 00 	movzbl 0x140c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1014:	e9 8f fe ff ff       	jmp    ea8 <printf+0x48>
          s = "(null)";
    1019:	bb 04 14 00 00       	mov    $0x1404,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1031:	a1 e4 1a 00 00       	mov    0x1ae4,%eax
{
  ...
  freep = p;
    106f:	a3 e4 1a 00 00       	mov    %eax,0x1ae4
}
    1074:	5b                   	pop    %ebx
    1075:	5e                   	pop    %esi
    1076:	5f                   	pop    %edi
    ...
    1086:	72 ce                	jb     1056 <free+0x26>
{
  ...
  freep = p;
    10aa:	a3 e4 1a 00 00       	mov    %eax,0x1ae4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){ // no free list yet
    10cc:	8b 15 e4 1a 00 00    	mov    0x1ae4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1111:	39 05 e4 1a 00 00    	cmp    %eax,0x1ae4
  ...
  return freep;
    113b:	8b 15 e4 1a 00 00    	mov    0x1ae4,%edx
    ...
    1164:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    1167:	89 15 e4 1a 00 00    	mov    %edx,0x1ae4
}
    ...
    base.s.ptr = freep = prevp = &base;
    1180:	c7 05 e4 1a 00 00 e8 	movl   $0x1ae8,0x1ae4
    1187:	1a 00 00 
    118a:	c7 05 e8 1a 00 00 e8 	movl   $0x1ae8,0x1ae8
    1191:	1a 00 00 
    base.s.size = 0;
    1194:	b8 e8 1a 00 00       	mov    $0x1ae8,%eax
    1199:	c7 05 ec 1a 00 00 00 	movl   $0x0,0x1aec
    11a0:	00 00 00 
...
void* pmalloc(){
  ...
  printf(1, "pmalloc\n");
    11c7:	68 1d 14 00 00       	push   $0x141d
    11cc:	6a 01                	push   $0x1
    11ce:	e8 8d fc ff ff       	call   e60 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
    11d3:	8b 1d f0 1a 00 00    	mov    0x1af0,%ebx
    11d9:	83 c4 10             	add    $0x10,%esp
    11dc:	85 db                	test   %ebx,%ebx
    11de:	75 0e                	jne    11ee <pmalloc+0x2e>
    11e0:	eb 2e                	jmp    1210 <pmalloc+0x50>
  ...
  while(pl->next){
    ...
    11ea:	75 0f                	jne    11fb <pmalloc+0x3b>
    11ec:	89 c3                	mov    %eax,%ebx
  while(pl->next){
    11ee:	8b 03                	mov    (%ebx),%eax
    11f0:	8b 53 04             	mov    0x4(%ebx),%edx
    11f3:	85 c0                	test   %eax,%eax
    11f5:	75 f1                	jne    11e8 <pmalloc+0x28>
      pl->isFree = 0;
      return pl;
    }
    pl = pl->next;
  ...
  if(pl->isFree){ // reached last link
    ...
    11f9:	74 45                	je     1240 <pmalloc+0x80>
    pl->isFree = 0;
    11fb:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    ...
    1213:	ff 35 6c 1a 00 00    	pushl  0x1a6c
    1219:	e8 7c fb ff ff       	call   d9a <sbrk>
    121e:	a3 f0 1a 00 00       	mov    %eax,0x1af0
    plink_freep->next = 0;
    1223:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
    1229:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
    122c:	8b 1d f0 1a 00 00    	mov    0x1af0,%ebx
    1232:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
    1239:	89 d8                	mov    %ebx,%eax
    123b:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    123e:	c9                   	leave  
    123f:	c3                   	ret    
    pl->next = (struct plink*)sbrk(pageSize);
    1240:	83 ec 0c             	sub    $0xc,%esp
    1243:	ff 35 6c 1a 00 00    	pushl  0x1a6c
    1249:	e8 4c fb ff ff       	call   d9a <sbrk>
    pl->next = 0;
    124e:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
    pl->isFree = 0;
    1254:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    return pl->next;
    125b:	83 c4 10             	add    $0x10,%esp
    125e:	31 db                	xor    %ebx,%ebx
    1260:	eb a0                	jmp    1202 <pmalloc+0x42>
    1262:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    1269:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00001270 <protect_page>:
...
int protect_page(void* ap){
  ...
  struct plink *pl = plink_freep;
    1276:	a1 f0 1a 00 00       	mov    0x1af0,%eax
int protect_page(void* ap){
    127b:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
    127e:	85 c0                	test   %eax,%eax
    1280:	74 18                	je     129a <protect_page+0x2a>
    if(pl == ap){
    1282:	39 d0                	cmp    %edx,%eax
    1284:	75 0e                	jne    1294 <protect_page+0x24>
    1286:	eb 20                	jmp    12a8 <protect_page+0x38>
    1288:	90                   	nop
    1289:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    1290:	39 c2                	cmp    %eax,%edx
    1292:	74 14                	je     12a8 <protect_page+0x38>
      protectPage(pl);
      return 1;
    }
    pl = pl->next;
  ...
  while(pl){
    ...
    1298:	75 f6                	jne    1290 <protect_page+0x20>
  }
	return -1;
    ...
    12ab:	52                   	push   %edx
    12ac:	e8 01 fb ff ff       	call   db2 <protectPage>
      return 1;
...
int pfree(void* ap){
    ...
    12c7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
    12ca:	68 26 14 00 00       	push   $0x1426
    12cf:	6a 01                	push   $0x1
    12d1:	e8 8a fb ff ff       	call   e60 <printf>
  struct plink *pl = plink_freep;
    12d6:	a1 f0 1a 00 00       	mov    0x1af0,%eax
  while(pl){
    12db:	83 c4 10             	add    $0x10,%esp
    12de:	85 c0                	test   %eax,%eax
    12e0:	74 18                	je     12fa <pfree+0x3a>
    if(pl == ap){
    12e2:	39 d8                	cmp    %ebx,%eax
    12e4:	75 0e                	jne    12f4 <pfree+0x34>
    12e6:	eb 20                	jmp    1308 <pfree+0x48>
    12e8:	90                   	nop
    12e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    12f0:	39 c3                	cmp    %eax,%ebx
    12f2:	74 14                	je     1308 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
  ...
  while(pl){
    ...
    12f8:	75 f6                	jne    12f0 <pfree+0x30>
  }
	return -1;
    ...
    1304:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
    1308:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;
    130f:	b8 01 00 00 00       	mov    $0x1,%eax
}
    1314:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    1317:	c9                   	leave  
    1318:	c3                   	ret    

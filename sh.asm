...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
      ...
      57:	6a 64                	push   $0x64
      59:	68 40 1a 00 00       	push   $0x1a40
      5e:	e8 9d 00 00 00       	call   100 <getcmd>
      63:	83 c4 10             	add    $0x10,%esp
      66:	85 c0                	test   %eax,%eax
      68:	78 37                	js     a1 <main+0xa1>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      6a:	80 3d 40 1a 00 00 63 	cmpb   $0x63,0x1a40
      71:	75 ce                	jne    41 <main+0x41>
      73:	80 3d 41 1a 00 00 64 	cmpb   $0x64,0x1a41
  ...
  exit();
      ...
      e6:	50                   	push   %eax
      e7:	68 43 1a 00 00       	push   $0x1a43
      ec:	68 99 13 00 00       	push   $0x1399
      f1:	6a 02                	push   $0x2
...
00000100 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     10e:	68 f0 12 00 00       	push   $0x12f0
     113:	6a 02                	push   $0x2
...
00000150 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     159:	68 8d 13 00 00       	push   $0x138d
     15e:	6a 02                	push   $0x2
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     189:	ff 24 85 a8 13 00 00 	jmp    *0x13a8(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1a9:	68 fa 12 00 00       	push   $0x12fa
     1ae:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     1fd:	68 0a 13 00 00       	push   $0x130a
     202:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     290:	68 f3 12 00 00       	push   $0x12f3
     295:	e8 b6 fe ff ff       	call   150 <panic>
    panic("fork");
     29a:	83 ec 0c             	sub    $0xc,%esp
     29d:	68 1a 13 00 00       	push   $0x131a
     ...
     2d8:	68 1f 13 00 00       	push   $0x131f
...
00000310 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     325:	68 1a 13 00 00       	push   $0x131a
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 28 1a 00 00       	push   $0x1a28
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 28 1a 00 00       	push   $0x1a28
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 20 1a 00 00       	push   $0x1a20
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 28 1a 00 00       	push   $0x1a28
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     653:	68 41 13 00 00       	push   $0x1341
     658:	53                   	push   %ebx
     659:	56                   	push   %esi
  ...
  return cmd;
     ...
     6de:	68 24 13 00 00       	push   $0x1324
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     6ff:	68 44 13 00 00       	push   $0x1344
     704:	57                   	push   %edi
     705:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     74e:	68 5b 13 00 00       	push   $0x135b
     753:	57                   	push   %edi
     754:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     798:	68 4d 13 00 00       	push   $0x134d
  ...
  cmd->eargv[argc] = 0;
     ...
     7ea:	68 46 13 00 00       	push   $0x1346
...
00000800 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     81b:	68 60 13 00 00       	push   $0x1360
     820:	56                   	push   %esi
     821:	53                   	push   %ebx
...
00000870 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8ab:	68 62 13 00 00       	push   $0x1362
     8b0:	56                   	push   %esi
     8b1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8c1:	68 5e 13 00 00       	push   $0x135e
     8c6:	56                   	push   %esi
     8c7:	53                   	push   %ebx
...
00000910 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     91f:	68 44 13 00 00       	push   $0x1344
     924:	56                   	push   %esi
     925:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     94b:	68 80 13 00 00       	push   $0x1380
     950:	56                   	push   %esi
     951:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9b5:	ff 24 85 c0 13 00 00 	jmp    *0x13c0(,%eax,4)
...
00000a50 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a77:	68 09 13 00 00       	push   $0x1309
     a7c:	53                   	push   %ebx
     a7d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     a9f:	52                   	push   %edx
     aa0:	50                   	push   %eax
     aa1:	68 82 13 00 00       	push   $0x1382
     aa6:	6a 02                	push   $0x2
     aa8:	e8 b3 03 00 00       	call   e60 <printf>
    panic("syntax");
     aad:	c7 04 24 46 13 00 00 	movl   $0x1346,(%esp)
     ...
     dc9:	85 d2                	test   %edx,%edx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     df7:	f7 f1                	div    %ecx
     df9:	0f b6 92 e0 13 00 00 	movzbl 0x13e0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1014:	e9 8f fe ff ff       	jmp    ea8 <printf+0x48>
          s = "(null)";
    1019:	bb d8 13 00 00       	mov    $0x13d8,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1031:	a1 a4 1a 00 00       	mov    0x1aa4,%eax
{
  ...
  freep = p;
    106f:	a3 a4 1a 00 00       	mov    %eax,0x1aa4
}
    1074:	5b                   	pop    %ebx
    1075:	5e                   	pop    %esi
    1076:	5f                   	pop    %edi
    ...
    1086:	72 ce                	jb     1056 <free+0x26>
{
  ...
  freep = p;
    10aa:	a3 a4 1a 00 00       	mov    %eax,0x1aa4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){ // no free list yet
    10cc:	8b 15 a4 1a 00 00    	mov    0x1aa4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1111:	39 05 a4 1a 00 00    	cmp    %eax,0x1aa4
  ...
  return freep;
    113b:	8b 15 a4 1a 00 00    	mov    0x1aa4,%edx
    ...
    1164:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    1167:	89 15 a4 1a 00 00    	mov    %edx,0x1aa4
}
    ...
    base.s.ptr = freep = prevp = &base;
    1180:	c7 05 a4 1a 00 00 a8 	movl   $0x1aa8,0x1aa4
    1187:	1a 00 00 
    118a:	c7 05 a8 1a 00 00 a8 	movl   $0x1aa8,0x1aa8
    1191:	1a 00 00 
    base.s.size = 0;
    1194:	b8 a8 1a 00 00       	mov    $0x1aa8,%eax
    1199:	c7 05 ac 1a 00 00 00 	movl   $0x0,0x1aac
    11a0:	00 00 00 
...
void* pmalloc(){
  ...
  if(!plink_freep){ // empty list
    11c7:	8b 1d b0 1a 00 00    	mov    0x1ab0,%ebx
    11cd:	85 db                	test   %ebx,%ebx
    11cf:	75 0d                	jne    11de <pmalloc+0x1e>
    11d1:	eb 5d                	jmp    1230 <pmalloc+0x70>
    11d3:	90                   	nop
  ...
  while(pl->next){
    ...
    11da:	75 0f                	jne    11eb <pmalloc+0x2b>
    11dc:	89 c3                	mov    %eax,%ebx
  while(pl->next){
    11de:	8b 03                	mov    (%ebx),%eax
    11e0:	8b 53 04             	mov    0x4(%ebx),%edx
    11e3:	85 c0                	test   %eax,%eax
    11e5:	75 f1                	jne    11d8 <pmalloc+0x18>
      pl->isFree = 0;
      return pl;
    }
    pl = pl->next;
  ...
  if(pl->isFree){ // reached last link
    ...
    11e9:	74 15                	je     1200 <pmalloc+0x40>
    pl->isFree = 0;
    11eb:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    //printf(1, "plink=%d\n", pl->next);
    pl->next->next = 0;
    pl->next->isFree = 0;
    return pl->next;
    ...
    1203:	ff 35 34 1a 00 00    	pushl  0x1a34
    1209:	e8 8c fb ff ff       	call   d9a <sbrk>
    120e:	89 03                	mov    %eax,(%ebx)
    pl->next->next = 0;
    1210:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return pl->next;
    1216:	83 c4 10             	add    $0x10,%esp
    pl->next->isFree = 0;
    1219:	8b 03                	mov    (%ebx),%eax
    121b:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    return pl->next;
    1222:	8b 1b                	mov    (%ebx),%ebx
}
    1224:	89 d8                	mov    %ebx,%eax
    ...
    1233:	ff 35 34 1a 00 00    	pushl  0x1a34
    1239:	e8 5c fb ff ff       	call   d9a <sbrk>
    123e:	a3 b0 1a 00 00       	mov    %eax,0x1ab0
    plink_freep->next = 0;
    1243:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
    1249:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
    124c:	8b 1d b0 1a 00 00    	mov    0x1ab0,%ebx
    1252:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
    1259:	89 d8                	mov    %ebx,%eax
    125b:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    125e:	c9                   	leave  
    125f:	c3                   	ret    

00001260 <protect_page>:
...
int protect_page(void* ap){
  ...
  struct plink *pl = plink_freep;
    1266:	a1 b0 1a 00 00       	mov    0x1ab0,%eax
int protect_page(void* ap){
    126b:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
    126e:	85 c0                	test   %eax,%eax
    1270:	74 18                	je     128a <protect_page+0x2a>
    if(pl == ap){
    1272:	39 d0                	cmp    %edx,%eax
    1274:	75 0e                	jne    1284 <protect_page+0x24>
    1276:	eb 20                	jmp    1298 <protect_page+0x38>
    1278:	90                   	nop
    1279:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    1280:	39 c2                	cmp    %eax,%edx
    1282:	74 14                	je     1298 <protect_page+0x38>
      protectPage(pl);
      return 1;
    }
    pl = pl->next;
  ...
  while(pl){
    ...
    1288:	75 f6                	jne    1280 <protect_page+0x20>
  }
	return -1;
    ...
    129b:	52                   	push   %edx
    129c:	e8 11 fb ff ff       	call   db2 <protectPage>
      return 1;
...
int pfree(void* ap){
  struct plink *pl = plink_freep;
    12b0:	a1 b0 1a 00 00       	mov    0x1ab0,%eax
int pfree(void* ap){
    12b5:	55                   	push   %ebp
...
int pfree(void* ap){
    12ba:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
    12bd:	74 13                	je     12d2 <pfree+0x22>
    if(pl == ap){
    12bf:	39 d0                	cmp    %edx,%eax
    12c1:	75 09                	jne    12cc <pfree+0x1c>
    12c3:	eb 1b                	jmp    12e0 <pfree+0x30>
    12c5:	8d 76 00             	lea    0x0(%esi),%esi
    12c8:	39 c2                	cmp    %eax,%edx
    12ca:	74 14                	je     12e0 <pfree+0x30>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
  ...
  while(pl){
    ...
    12d0:	75 f6                	jne    12c8 <pfree+0x18>
  }
	return -1;
    12d2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    12d7:	5d                   	pop    %ebp
    12d8:	c3                   	ret    
    12d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
    12e0:	c7 42 04 01 00 00 00 	movl   $0x1,0x4(%edx)
      return 1;

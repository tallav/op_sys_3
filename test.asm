 ...
 359:	85 d2                	test   %edx,%edx
{
 ...
 387:	f7 f1                	div    %ecx
 389:	0f b6 92 b4 08 00 00 	movzbl 0x8b4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5a4:	e9 8f fe ff ff       	jmp    438 <printf+0x48>
          s = "(null)";
 5a9:	bb ac 08 00 00       	mov    $0x8ac,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c1:	a1 f4 0b 00 00       	mov    0xbf4,%eax
{
 ...
 5fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ff:	a3 f4 0b 00 00       	mov    %eax,0xbf4
}
 604:	5b                   	pop    %ebx
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 f4 0b 00 00       	mov    %eax,0xbf4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 65c:	8b 15 f4 0b 00 00    	mov    0xbf4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 47                	jae    6e8 <malloc+0x98>
    ...
    if(p == freep)
 6a1:	39 05 f4 0b 00 00    	cmp    %eax,0xbf4
 ...
 6c6:	e8 f5 fe ff ff       	call   5c0 <free>
  return freep;
 6cb:	8b 15 f4 0b 00 00    	mov    0xbf4,%edx
 ...
 6f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6f7:	89 15 f4 0b 00 00    	mov    %edx,0xbf4
}
 ...
 709:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 f4 0b 00 00 f8 	movl   $0xbf8,0xbf4
 717:	0b 00 00 
 71a:	c7 05 f8 0b 00 00 f8 	movl   $0xbf8,0xbf8
 721:	0b 00 00 
    base.s.size = 0;
 724:	b8 f8 0b 00 00       	mov    $0xbf8,%eax
 729:	c7 05 fc 0b 00 00 00 	movl   $0x0,0xbfc
 730:	00 00 00 
...
void* pmalloc(){
 ...
 754:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 757:	68 c5 08 00 00       	push   $0x8c5
 75c:	6a 01                	push   $0x1
 75e:	e8 8d fc ff ff       	call   3f0 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 763:	8b 1d 00 0c 00 00    	mov    0xc00,%ebx
 ...
 7a3:	ff 35 f0 0b 00 00    	pushl  0xbf0
 7a9:	e8 7c fb ff ff       	call   32a <sbrk>
 7ae:	a3 00 0c 00 00       	mov    %eax,0xc00
    plink_freep->next = 0;
 7b3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 7b9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 7bc:	8b 1d 00 0c 00 00    	mov    0xc00,%ebx
 ...
 7d3:	ff 35 f0 0b 00 00    	pushl  0xbf0
...
int protect_page(void* ap){
 ...
 806:	a1 00 0c 00 00       	mov    0xc00,%eax
int protect_page(void* ap){
 80b:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 80e:	85 c0                	test   %eax,%eax
 810:	74 18                	je     82a <protect_page+0x2a>
    if(pl == ap){
 812:	39 d0                	cmp    %edx,%eax
 814:	75 0e                	jne    824 <protect_page+0x24>
 816:	eb 20                	jmp    838 <protect_page+0x38>
 818:	90                   	nop
 819:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 820:	39 c2                	cmp    %eax,%edx
 822:	74 14                	je     838 <protect_page+0x38>
      protectPage(pl);
      return 1;
    }
    pl = pl->next;
 ...
 828:	75 f6                	jne    820 <protect_page+0x20>
  }
	return -1;
 82a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 82f:	c9                   	leave  
 830:	c3                   	ret    
 ...
 83b:	52                   	push   %edx
 83c:	e8 01 fb ff ff       	call   342 <protectPage>
      return 1;
...
int pfree(void* ap){
 ...
 857:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 85a:	68 ce 08 00 00       	push   $0x8ce
 85f:	6a 01                	push   $0x1
 861:	e8 8a fb ff ff       	call   3f0 <printf>
  struct plink *pl = plink_freep;
 866:	a1 00 0c 00 00       	mov    0xc00,%eax
  while(pl){
 86b:	83 c4 10             	add    $0x10,%esp
 86e:	85 c0                	test   %eax,%eax
 870:	74 18                	je     88a <pfree+0x3a>
    if(pl == ap){
 872:	39 d8                	cmp    %ebx,%eax
 874:	75 0e                	jne    884 <pfree+0x34>
 876:	eb 20                	jmp    898 <pfree+0x48>
 878:	90                   	nop
 879:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 880:	39 c3                	cmp    %eax,%ebx
 882:	74 14                	je     898 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 888:	75 f6                	jne    880 <pfree+0x30>
  }
	return -1;
 88a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 88f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 892:	c9                   	leave  
 893:	c3                   	ret    
 894:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 898:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;

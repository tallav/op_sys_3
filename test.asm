...
#include "param.h"
 ...
 main(int argc, char *argv[])
 {
  ...
  16:	74 0a                	je     22 <main+0x22>
        void* page = malloc(sizeof(int)); 
        protectPage(page);
        free(page);
    }
    wait();
  18:	e8 8d 02 00 00       	call   2aa <wait>
    exit();
  1d:	e8 80 02 00 00       	call   2a2 <exit>
        void* page = malloc(sizeof(int)); 
  22:	83 ec 0c             	sub    $0xc,%esp
  25:	6a 04                	push   $0x4
  27:	e8 24 06 00 00       	call   650 <malloc>
  2c:	89 c3                	mov    %eax,%ebx
        protectPage(page);
  2e:	89 04 24             	mov    %eax,(%esp)
  31:	e8 0c 03 00 00       	call   342 <protectPage>
        free(page);
  36:	89 1c 24             	mov    %ebx,(%esp)
  39:	e8 82 05 00 00       	call   5c0 <free>
  3e:	83 c4 10             	add    $0x10,%esp
  41:	eb d5                	jmp    18 <main+0x18>
  43:	66 90                	xchg   %ax,%ax
  45:	66 90                	xchg   %ax,%ax
  47:	66 90                	xchg   %ax,%ax
  49:	66 90                	xchg   %ax,%ax
 ...
 359:	85 d2                	test   %edx,%edx
{
 ...
 387:	f7 f1                	div    %ecx
 389:	0f b6 92 a4 08 00 00 	movzbl 0x8a4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5a4:	e9 8f fe ff ff       	jmp    438 <printf+0x48>
          s = "(null)";
 5a9:	bb 9c 08 00 00       	mov    $0x89c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c1:	a1 e4 0b 00 00       	mov    0xbe4,%eax
{
 ...
 5fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ff:	a3 e4 0b 00 00       	mov    %eax,0xbe4
}
 604:	5b                   	pop    %ebx
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 e4 0b 00 00       	mov    %eax,0xbe4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 65c:	8b 15 e4 0b 00 00    	mov    0xbe4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 47                	jae    6e8 <malloc+0x98>
    ...
    if(p == freep)
 6a1:	39 05 e4 0b 00 00    	cmp    %eax,0xbe4
 ...
 6c6:	e8 f5 fe ff ff       	call   5c0 <free>
  return freep;
 6cb:	8b 15 e4 0b 00 00    	mov    0xbe4,%edx
 ...
 6f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6f7:	89 15 e4 0b 00 00    	mov    %edx,0xbe4
}
 ...
 709:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 e4 0b 00 00 e8 	movl   $0xbe8,0xbe4
 717:	0b 00 00 
 71a:	c7 05 e8 0b 00 00 e8 	movl   $0xbe8,0xbe8
 721:	0b 00 00 
    base.s.size = 0;
 724:	b8 e8 0b 00 00       	mov    $0xbe8,%eax
 729:	c7 05 ec 0b 00 00 00 	movl   $0x0,0xbec
 730:	00 00 00 
...
void* pmalloc(){
 ...
 754:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 757:	68 b5 08 00 00       	push   $0x8b5
 75c:	6a 01                	push   $0x1
 75e:	e8 8d fc ff ff       	call   3f0 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 763:	8b 1d f0 0b 00 00    	mov    0xbf0,%ebx
 769:	83 c4 10             	add    $0x10,%esp
 76c:	85 db                	test   %ebx,%ebx
 76e:	75 0e                	jne    77e <pmalloc+0x2e>
 770:	eb 2e                	jmp    7a0 <pmalloc+0x50>
 ...
 77a:	75 0f                	jne    78b <pmalloc+0x3b>
 77c:	89 c3                	mov    %eax,%ebx
  while(pl->next){
 77e:	8b 03                	mov    (%ebx),%eax
 780:	8b 53 04             	mov    0x4(%ebx),%edx
 783:	85 c0                	test   %eax,%eax
 785:	75 f1                	jne    778 <pmalloc+0x28>
      pl->isFree = 0;
      return pl;
    }
    pl = pl->next;
 ...
 789:	74 45                	je     7d0 <pmalloc+0x80>
    pl->isFree = 0;
 78b:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
 ...
 7a3:	ff 35 e0 0b 00 00    	pushl  0xbe0
 7a9:	e8 7c fb ff ff       	call   32a <sbrk>
 7ae:	a3 f0 0b 00 00       	mov    %eax,0xbf0
    plink_freep->next = 0;
 7b3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 7b9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 7bc:	8b 1d f0 0b 00 00    	mov    0xbf0,%ebx
 7c2:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
 7c9:	89 d8                	mov    %ebx,%eax
 7cb:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 7ce:	c9                   	leave  
 7cf:	c3                   	ret    
    pl->next = (struct plink*)sbrk(pageSize);
 7d0:	83 ec 0c             	sub    $0xc,%esp
 7d3:	ff 35 e0 0b 00 00    	pushl  0xbe0
 7d9:	e8 4c fb ff ff       	call   32a <sbrk>
    pl->next = 0;
 7de:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
    pl->isFree = 0;
 7e4:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    return pl->next;
 7eb:	83 c4 10             	add    $0x10,%esp
 7ee:	31 db                	xor    %ebx,%ebx
 7f0:	eb a0                	jmp    792 <pmalloc+0x42>
...
int protect_page(void* ap){
 ...
 800:	a1 f0 0b 00 00       	mov    0xbf0,%eax
int protect_page(void* ap){
 805:	55                   	push   %ebp
...
int protect_page(void* ap){
 80a:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 80d:	74 13                	je     822 <protect_page+0x22>
    if(pl == ap){
 80f:	39 d0                	cmp    %edx,%eax
 811:	75 09                	jne    81c <protect_page+0x1c>
 813:	eb 1b                	jmp    830 <protect_page+0x30>
 815:	8d 76 00             	lea    0x0(%esi),%esi
 818:	39 c2                	cmp    %eax,%edx
 81a:	74 14                	je     830 <protect_page+0x30>
      // add system call 
      return 1;
    }
    pl = pl->next;
 ...
 820:	75 f6                	jne    818 <protect_page+0x18>
  }
	return -1;
 822:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 827:	5d                   	pop    %ebp
 828:	c3                   	ret    
...
int pfree(void* ap){
 ...
 847:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 84a:	68 be 08 00 00       	push   $0x8be
 84f:	6a 01                	push   $0x1
 851:	e8 9a fb ff ff       	call   3f0 <printf>
  struct plink *pl = plink_freep;
 856:	a1 f0 0b 00 00       	mov    0xbf0,%eax
  while(pl){
 85b:	83 c4 10             	add    $0x10,%esp
 85e:	85 c0                	test   %eax,%eax
 860:	74 18                	je     87a <pfree+0x3a>
    if(pl == ap){
 862:	39 d8                	cmp    %ebx,%eax
 864:	75 0e                	jne    874 <pfree+0x34>
 866:	eb 20                	jmp    888 <pfree+0x48>
 868:	90                   	nop
 869:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 870:	39 c3                	cmp    %eax,%ebx
 872:	74 14                	je     888 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 884:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 888:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;
 88f:	b8 01 00 00 00       	mov    $0x1,%eax
}

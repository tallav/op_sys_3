 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3b7:	f7 f1                	div    %ecx
 3b9:	0f b6 92 ec 08 00 00 	movzbl 0x8ec(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb e3 08 00 00       	mov    $0x8e3,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 28 0c 00 00       	mov    0xc28,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 28 0c 00 00       	mov    %eax,0xc28
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 28 0c 00 00       	mov    %eax,0xc28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 68c:	8b 15 28 0c 00 00    	mov    0xc28,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
    ...
    if(p == freep)
 6d1:	39 05 28 0c 00 00    	cmp    %eax,0xc28
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
  return freep;
 6fb:	8b 15 28 0c 00 00    	mov    0xc28,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 727:	89 15 28 0c 00 00    	mov    %edx,0xc28
}
 ...
 739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 28 0c 00 00 2c 	movl   $0xc2c,0xc28
 747:	0c 00 00 
 74a:	c7 05 2c 0c 00 00 2c 	movl   $0xc2c,0xc2c
 751:	0c 00 00 
    base.s.size = 0;
 754:	b8 2c 0c 00 00       	mov    $0xc2c,%eax
 759:	c7 05 30 0c 00 00 00 	movl   $0x0,0xc30
 760:	00 00 00 
...
void* pmalloc(){
 ...
 787:	8b 1d 34 0c 00 00    	mov    0xc34,%ebx
 78d:	85 db                	test   %ebx,%ebx
 78f:	75 0d                	jne    79e <pmalloc+0x1e>
 791:	eb 5d                	jmp    7f0 <pmalloc+0x70>
 793:	90                   	nop
 ...
 7c3:	ff 35 24 0c 00 00    	pushl  0xc24
 7c9:	e8 8c fb ff ff       	call   35a <sbrk>
 7ce:	89 03                	mov    %eax,(%ebx)
    pl->next->next = 0;
 7d0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return pl->next;
 7d6:	83 c4 10             	add    $0x10,%esp
    pl->next->isFree = 0;
 7d9:	8b 03                	mov    (%ebx),%eax
 7db:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    return pl->next;
 7e2:	8b 1b                	mov    (%ebx),%ebx
}
 ...
 7f3:	ff 35 24 0c 00 00    	pushl  0xc24
 7f9:	e8 5c fb ff ff       	call   35a <sbrk>
 7fe:	a3 34 0c 00 00       	mov    %eax,0xc34
    plink_freep->next = 0;
 803:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 809:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 80c:	8b 1d 34 0c 00 00    	mov    0xc34,%ebx
 812:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
...
int protect_page(void* ap){
 ...
 826:	a1 34 0c 00 00       	mov    0xc34,%eax
int protect_page(void* ap){
 ...
 85b:	52                   	push   %edx
 85c:	e8 11 fb ff ff       	call   372 <protectPage>
      return 1;
...
int pfree(void* ap){
  struct plink *pl = plink_freep;
 870:	a1 34 0c 00 00       	mov    0xc34,%eax
int pfree(void* ap){
 875:	55                   	push   %ebp
...
int pfree(void* ap){
 87a:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 87d:	74 13                	je     892 <pfree+0x22>
    if(pl == ap){
 87f:	39 d0                	cmp    %edx,%eax
 881:	75 09                	jne    88c <pfree+0x1c>
 883:	eb 1b                	jmp    8a0 <pfree+0x30>
 885:	8d 76 00             	lea    0x0(%esi),%esi
 888:	39 c2                	cmp    %eax,%edx
 88a:	74 14                	je     8a0 <pfree+0x30>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 899:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 8a0:	c7 42 04 01 00 00 00 	movl   $0x1,0x4(%edx)
      return 1;

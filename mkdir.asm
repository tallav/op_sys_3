 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3b7:	f7 f1                	div    %ecx
 3b9:	0f b6 92 18 09 00 00 	movzbl 0x918(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb 0f 09 00 00       	mov    $0x90f,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 60 0c 00 00       	mov    0xc60,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 60 0c 00 00       	mov    %eax,0xc60
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 60 0c 00 00       	mov    %eax,0xc60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 68c:	8b 15 60 0c 00 00    	mov    0xc60,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
    ...
    if(p == freep)
 6d1:	39 05 60 0c 00 00    	cmp    %eax,0xc60
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
  return freep;
 6fb:	8b 15 60 0c 00 00    	mov    0xc60,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 727:	89 15 60 0c 00 00    	mov    %edx,0xc60
}
 ...
 739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 60 0c 00 00 64 	movl   $0xc64,0xc60
 747:	0c 00 00 
 74a:	c7 05 64 0c 00 00 64 	movl   $0xc64,0xc64
 751:	0c 00 00 
    base.s.size = 0;
 754:	b8 64 0c 00 00       	mov    $0xc64,%eax
 759:	c7 05 68 0c 00 00 00 	movl   $0x0,0xc68
 760:	00 00 00 
...
void* pmalloc(){
 ...
 784:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 787:	68 29 09 00 00       	push   $0x929
 78c:	6a 01                	push   $0x1
 78e:	e8 8d fc ff ff       	call   420 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 793:	8b 1d 6c 0c 00 00    	mov    0xc6c,%ebx
 799:	83 c4 10             	add    $0x10,%esp
 79c:	85 db                	test   %ebx,%ebx
 79e:	75 0e                	jne    7ae <pmalloc+0x2e>
 7a0:	eb 2e                	jmp    7d0 <pmalloc+0x50>
 ...
 7aa:	75 0f                	jne    7bb <pmalloc+0x3b>
 7ac:	89 c3                	mov    %eax,%ebx
  while(pl->next){
 7ae:	8b 03                	mov    (%ebx),%eax
 7b0:	8b 53 04             	mov    0x4(%ebx),%edx
 7b3:	85 c0                	test   %eax,%eax
 7b5:	75 f1                	jne    7a8 <pmalloc+0x28>
      pl->isFree = 0;
      return pl;
    }
    pl = pl->next;
 ...
 7b7:	85 d2                	test   %edx,%edx
 7b9:	74 45                	je     800 <pmalloc+0x80>
    pl->isFree = 0;
 7bb:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
 ...
 7d3:	ff 35 5c 0c 00 00    	pushl  0xc5c
 7d9:	e8 7c fb ff ff       	call   35a <sbrk>
 7de:	a3 6c 0c 00 00       	mov    %eax,0xc6c
    plink_freep->next = 0;
 7e3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 7e9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 7ec:	8b 1d 6c 0c 00 00    	mov    0xc6c,%ebx
 7f2:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
 ...
 803:	ff 35 5c 0c 00 00    	pushl  0xc5c
 809:	e8 4c fb ff ff       	call   35a <sbrk>
    pl->next = 0;
 80e:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
    pl->isFree = 0;
 814:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    return pl->next;
 81b:	83 c4 10             	add    $0x10,%esp
 81e:	31 db                	xor    %ebx,%ebx
 820:	eb a0                	jmp    7c2 <pmalloc+0x42>
...
int protect_page(void* ap){
 ...
 836:	a1 6c 0c 00 00       	mov    0xc6c,%eax
int protect_page(void* ap){
 83b:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 83e:	85 c0                	test   %eax,%eax
 840:	74 18                	je     85a <protect_page+0x2a>
    if(pl == ap){
 842:	39 d0                	cmp    %edx,%eax
 844:	75 0e                	jne    854 <protect_page+0x24>
 846:	eb 20                	jmp    868 <protect_page+0x38>
 848:	90                   	nop
 849:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 850:	39 c2                	cmp    %eax,%edx
 852:	74 14                	je     868 <protect_page+0x38>
      protectPage(pl);
      return 1;
    }
    pl = pl->next;
 ...
 858:	75 f6                	jne    850 <protect_page+0x20>
  }
	return -1;
 ...
 86b:	52                   	push   %edx
 86c:	e8 01 fb ff ff       	call   372 <protectPage>
      return 1;
 871:	83 c4 10             	add    $0x10,%esp
 874:	b8 01 00 00 00       	mov    $0x1,%eax
}
 879:	c9                   	leave  
 87a:	c3                   	ret    
 87b:	90                   	nop
...
int pfree(void* ap){
 ...
 887:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 88a:	68 32 09 00 00       	push   $0x932
 88f:	6a 01                	push   $0x1
 891:	e8 8a fb ff ff       	call   420 <printf>
  struct plink *pl = plink_freep;
 896:	a1 6c 0c 00 00       	mov    0xc6c,%eax
  while(pl){
 89b:	83 c4 10             	add    $0x10,%esp
 89e:	85 c0                	test   %eax,%eax
 8a0:	74 18                	je     8ba <pfree+0x3a>
    if(pl == ap){
 8a2:	39 d8                	cmp    %ebx,%eax
 8a4:	75 0e                	jne    8b4 <pfree+0x34>
 8a6:	eb 20                	jmp    8c8 <pfree+0x48>
 8a8:	90                   	nop
 8a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 8b0:	39 c3                	cmp    %eax,%ebx
 8b2:	74 14                	je     8c8 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 8c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 8c8:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;
 8cf:	b8 01 00 00 00       	mov    $0x1,%eax
}

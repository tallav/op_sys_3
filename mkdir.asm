 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3b7:	f7 f1                	div    %ecx
 3b9:	0f b6 92 08 09 00 00 	movzbl 0x908(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb ff 08 00 00       	mov    $0x8ff,%ebx
        while(*s != 0){
...
void* pmalloc(){
 ...
 784:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 787:	68 19 09 00 00       	push   $0x919
 78c:	6a 01                	push   $0x1
 78e:	e8 8d fc ff ff       	call   420 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 793:	8b 1d 5c 0c 00 00    	mov    0xc5c,%ebx
 ...
 7d3:	ff 35 4c 0c 00 00    	pushl  0xc4c
 7d9:	e8 7c fb ff ff       	call   35a <sbrk>
 7de:	a3 5c 0c 00 00       	mov    %eax,0xc5c
    plink_freep->next = 0;
 7e3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 7e9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 7ec:	8b 1d 5c 0c 00 00    	mov    0xc5c,%ebx
 ...
 803:	ff 35 4c 0c 00 00    	pushl  0xc4c
...
int protect_page(void* ap){
 ...
 830:	a1 5c 0c 00 00       	mov    0xc5c,%eax
int protect_page(void* ap){
 835:	55                   	push   %ebp
...
int protect_page(void* ap){
 83a:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 83d:	74 13                	je     852 <protect_page+0x22>
    if(pl == ap){
 83f:	39 d0                	cmp    %edx,%eax
 841:	75 09                	jne    84c <protect_page+0x1c>
 843:	eb 1b                	jmp    860 <protect_page+0x30>
 845:	8d 76 00             	lea    0x0(%esi),%esi
 848:	39 c2                	cmp    %eax,%edx
 84a:	74 14                	je     860 <protect_page+0x30>
      // add system call 
      return 1;
    }
    pl = pl->next;
 ...
 850:	75 f6                	jne    848 <protect_page+0x18>
  }
	return -1;
 852:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 857:	5d                   	pop    %ebp
 858:	c3                   	ret    
...
int pfree(void* ap){
 ...
 877:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 87a:	68 22 09 00 00       	push   $0x922
 87f:	6a 01                	push   $0x1
 881:	e8 9a fb ff ff       	call   420 <printf>
  struct plink *pl = plink_freep;
 886:	a1 5c 0c 00 00       	mov    0xc5c,%eax
  while(pl){

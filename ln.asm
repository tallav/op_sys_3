 ...
 369:	85 d2                	test   %edx,%edx
{
 ...
 397:	f7 f1                	div    %ecx
 399:	0f b6 92 c0 08 00 00 	movzbl 0x8c0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb b7 08 00 00       	mov    $0x8b7,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 f4 0b 00 00       	mov    0xbf4,%eax
{
 ...
 60d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 60f:	a3 f4 0b 00 00       	mov    %eax,0xbf4
}
 614:	5b                   	pop    %ebx
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 f4 0b 00 00       	mov    %eax,0xbf4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 66c:	8b 15 f4 0b 00 00    	mov    0xbf4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 47                	jae    6f8 <malloc+0x98>
    ...
    if(p == freep)
 6b1:	39 05 f4 0b 00 00    	cmp    %eax,0xbf4
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
  return freep;
 6db:	8b 15 f4 0b 00 00    	mov    0xbf4,%edx
 ...
 704:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 707:	89 15 f4 0b 00 00    	mov    %edx,0xbf4
}
 ...
 719:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 f4 0b 00 00 f8 	movl   $0xbf8,0xbf4
 727:	0b 00 00 
 72a:	c7 05 f8 0b 00 00 f8 	movl   $0xbf8,0xbf8
 731:	0b 00 00 
    base.s.size = 0;
 734:	b8 f8 0b 00 00       	mov    $0xbf8,%eax
 739:	c7 05 fc 0b 00 00 00 	movl   $0x0,0xbfc
 740:	00 00 00 
...
void* pmalloc(){
 ...
 767:	8b 1d 00 0c 00 00    	mov    0xc00,%ebx
 76d:	85 db                	test   %ebx,%ebx
 76f:	75 0d                	jne    77e <pmalloc+0x1e>
 771:	eb 5d                	jmp    7d0 <pmalloc+0x70>
 773:	90                   	nop
 ...
 7a9:	e8 8c fb ff ff       	call   33a <sbrk>
 7ae:	89 03                	mov    %eax,(%ebx)
    pl->next->next = 0;
 7b0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return pl->next;
 7b6:	83 c4 10             	add    $0x10,%esp
    pl->next->isFree = 0;
 7b9:	8b 03                	mov    (%ebx),%eax
 7bb:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    return pl->next;
 7c2:	8b 1b                	mov    (%ebx),%ebx
}
 7c4:	89 d8                	mov    %ebx,%eax
 ...
 7d9:	e8 5c fb ff ff       	call   33a <sbrk>
 7de:	a3 00 0c 00 00       	mov    %eax,0xc00
    plink_freep->next = 0;
 7e3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 7e9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 7ec:	8b 1d 00 0c 00 00    	mov    0xc00,%ebx
...
int protect_page(void* ap){
 ...
 83b:	52                   	push   %edx
 83c:	e8 11 fb ff ff       	call   352 <protectPage>
      return 1;
...
int pfree(void* ap){
  struct plink *pl = plink_freep;
 850:	a1 00 0c 00 00       	mov    0xc00,%eax
int pfree(void* ap){
 855:	55                   	push   %ebp
...
int pfree(void* ap){
 85a:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 85d:	74 13                	je     872 <pfree+0x22>
    if(pl == ap){
 85f:	39 d0                	cmp    %edx,%eax
 861:	75 09                	jne    86c <pfree+0x1c>
 863:	eb 1b                	jmp    880 <pfree+0x30>
 865:	8d 76 00             	lea    0x0(%esi),%esi
 868:	39 c2                	cmp    %eax,%edx
 86a:	74 14                	je     880 <pfree+0x30>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 870:	75 f6                	jne    868 <pfree+0x18>
  }
	return -1;
 872:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 877:	5d                   	pop    %ebp
 878:	c3                   	ret    
 879:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 880:	c7 42 04 01 00 00 00 	movl   $0x1,0x4(%edx)
      return 1;

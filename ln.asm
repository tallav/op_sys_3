 ...
 369:	85 d2                	test   %edx,%edx
{
 ...
 397:	f7 f1                	div    %ecx
 399:	0f b6 92 ec 08 00 00 	movzbl 0x8ec(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb e3 08 00 00       	mov    $0x8e3,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 2c 0c 00 00       	mov    0xc2c,%eax
{
 ...
 60d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 60f:	a3 2c 0c 00 00       	mov    %eax,0xc2c
}
 614:	5b                   	pop    %ebx
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 2c 0c 00 00       	mov    %eax,0xc2c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 66c:	8b 15 2c 0c 00 00    	mov    0xc2c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 47                	jae    6f8 <malloc+0x98>
    ...
    if(p == freep)
 6b1:	39 05 2c 0c 00 00    	cmp    %eax,0xc2c
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
  return freep;
 6db:	8b 15 2c 0c 00 00    	mov    0xc2c,%edx
 ...
 704:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 707:	89 15 2c 0c 00 00    	mov    %edx,0xc2c
}
 ...
 719:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 2c 0c 00 00 30 	movl   $0xc30,0xc2c
 727:	0c 00 00 
 72a:	c7 05 30 0c 00 00 30 	movl   $0xc30,0xc30
 731:	0c 00 00 
    base.s.size = 0;
 734:	b8 30 0c 00 00       	mov    $0xc30,%eax
 739:	c7 05 34 0c 00 00 00 	movl   $0x0,0xc34
 740:	00 00 00 
...
void* pmalloc(){
 ...
 764:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 767:	68 fd 08 00 00       	push   $0x8fd
 76c:	6a 01                	push   $0x1
 76e:	e8 8d fc ff ff       	call   400 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 773:	8b 1d 38 0c 00 00    	mov    0xc38,%ebx
 ...
 7b3:	ff 35 28 0c 00 00    	pushl  0xc28
 7b9:	e8 7c fb ff ff       	call   33a <sbrk>
 7be:	a3 38 0c 00 00       	mov    %eax,0xc38
    plink_freep->next = 0;
 7c3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 7c9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 7cc:	8b 1d 38 0c 00 00    	mov    0xc38,%ebx
 ...
 7e3:	ff 35 28 0c 00 00    	pushl  0xc28
...
int protect_page(void* ap){
 ...
 816:	a1 38 0c 00 00       	mov    0xc38,%eax
int protect_page(void* ap){
 ...
 84b:	52                   	push   %edx
 84c:	e8 01 fb ff ff       	call   352 <protectPage>
      return 1;
...
int pfree(void* ap){
 ...
 867:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 86a:	68 06 09 00 00       	push   $0x906
 86f:	6a 01                	push   $0x1
 871:	e8 8a fb ff ff       	call   400 <printf>
  struct plink *pl = plink_freep;
 876:	a1 38 0c 00 00       	mov    0xc38,%eax
  while(pl){
 87b:	83 c4 10             	add    $0x10,%esp
 87e:	85 c0                	test   %eax,%eax
 880:	74 18                	je     89a <pfree+0x3a>
    if(pl == ap){
 882:	39 d8                	cmp    %ebx,%eax
 884:	75 0e                	jne    894 <pfree+0x34>
 886:	eb 20                	jmp    8a8 <pfree+0x48>
 888:	90                   	nop
 889:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 890:	39 c3                	cmp    %eax,%ebx
 892:	74 14                	je     8a8 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 898:	75 f6                	jne    890 <pfree+0x30>
  }
	return -1;
 89a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 ...
 8a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 8a8:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;

 ...
 369:	85 d2                	test   %edx,%edx
{
 ...
 397:	f7 f1                	div    %ecx
 399:	0f b6 92 dc 08 00 00 	movzbl 0x8dc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb d3 08 00 00       	mov    $0x8d3,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 1c 0c 00 00       	mov    0xc1c,%eax
{
 ...
 60d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 60f:	a3 1c 0c 00 00       	mov    %eax,0xc1c
}
 614:	5b                   	pop    %ebx
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 1c 0c 00 00       	mov    %eax,0xc1c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 66c:	8b 15 1c 0c 00 00    	mov    0xc1c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 47                	jae    6f8 <malloc+0x98>
    ...
    if(p == freep)
 6b1:	39 05 1c 0c 00 00    	cmp    %eax,0xc1c
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
  return freep;
 6db:	8b 15 1c 0c 00 00    	mov    0xc1c,%edx
 ...
 704:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 707:	89 15 1c 0c 00 00    	mov    %edx,0xc1c
}
 ...
 719:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 1c 0c 00 00 20 	movl   $0xc20,0xc1c
 727:	0c 00 00 
 72a:	c7 05 20 0c 00 00 20 	movl   $0xc20,0xc20
 731:	0c 00 00 
    base.s.size = 0;
 734:	b8 20 0c 00 00       	mov    $0xc20,%eax
 739:	c7 05 24 0c 00 00 00 	movl   $0x0,0xc24
 740:	00 00 00 
...
void* pmalloc(){
 ...
 764:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 767:	68 ed 08 00 00       	push   $0x8ed
 76c:	6a 01                	push   $0x1
 76e:	e8 8d fc ff ff       	call   400 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 773:	8b 1d 28 0c 00 00    	mov    0xc28,%ebx
 779:	83 c4 10             	add    $0x10,%esp
 77c:	85 db                	test   %ebx,%ebx
 77e:	75 0e                	jne    78e <pmalloc+0x2e>
 780:	eb 2e                	jmp    7b0 <pmalloc+0x50>
 ...
 78a:	75 0f                	jne    79b <pmalloc+0x3b>
 78c:	89 c3                	mov    %eax,%ebx
  while(pl->next){
 78e:	8b 03                	mov    (%ebx),%eax
 790:	8b 53 04             	mov    0x4(%ebx),%edx
 793:	85 c0                	test   %eax,%eax
 795:	75 f1                	jne    788 <pmalloc+0x28>
      pl->isFree = 0;
      return pl;
    }
    pl = pl->next;
 ...
 797:	85 d2                	test   %edx,%edx
 799:	74 45                	je     7e0 <pmalloc+0x80>
    pl->isFree = 0;
 79b:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
 ...
 7b3:	ff 35 18 0c 00 00    	pushl  0xc18
 7b9:	e8 7c fb ff ff       	call   33a <sbrk>
 7be:	a3 28 0c 00 00       	mov    %eax,0xc28
    plink_freep->next = 0;
 7c3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 7c9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 7cc:	8b 1d 28 0c 00 00    	mov    0xc28,%ebx
 7d2:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
 ...
 7e3:	ff 35 18 0c 00 00    	pushl  0xc18
 7e9:	e8 4c fb ff ff       	call   33a <sbrk>
    pl->next = 0;
 7ee:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
    pl->isFree = 0;
 7f4:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    return pl->next;
 7fb:	83 c4 10             	add    $0x10,%esp
 7fe:	31 db                	xor    %ebx,%ebx
 800:	eb a0                	jmp    7a2 <pmalloc+0x42>
 802:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 809:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00000810 <protect_page>:
...
int protect_page(void* ap){
 ...
 810:	a1 28 0c 00 00       	mov    0xc28,%eax
int protect_page(void* ap){
 815:	55                   	push   %ebp
...
int protect_page(void* ap){
 81a:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 81d:	74 13                	je     832 <protect_page+0x22>
    if(pl == ap){
 81f:	39 d0                	cmp    %edx,%eax
 821:	75 09                	jne    82c <protect_page+0x1c>
 823:	eb 1b                	jmp    840 <protect_page+0x30>
 825:	8d 76 00             	lea    0x0(%esi),%esi
 828:	39 c2                	cmp    %eax,%edx
 82a:	74 14                	je     840 <protect_page+0x30>
      // add system call 
      return 1;
    }
    pl = pl->next;
 ...
 830:	75 f6                	jne    828 <protect_page+0x18>
  }
	return -1;
 832:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 837:	5d                   	pop    %ebp
 838:	c3                   	ret    
...
int pfree(void* ap){
 ...
 857:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 85a:	68 f6 08 00 00       	push   $0x8f6
 85f:	6a 01                	push   $0x1
 861:	e8 9a fb ff ff       	call   400 <printf>
  struct plink *pl = plink_freep;
 866:	a1 28 0c 00 00       	mov    0xc28,%eax
  while(pl){

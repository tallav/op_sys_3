 ...
 369:	85 d2                	test   %edx,%edx
{
 ...
 397:	f7 f1                	div    %ecx
 399:	0f b6 92 c8 08 00 00 	movzbl 0x8c8(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb c0 08 00 00       	mov    $0x8c0,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 0c 0c 00 00       	mov    0xc0c,%eax
{
 ...
 60d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 60f:	a3 0c 0c 00 00       	mov    %eax,0xc0c
}
 614:	5b                   	pop    %ebx
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 0c 0c 00 00       	mov    %eax,0xc0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 66c:	8b 15 0c 0c 00 00    	mov    0xc0c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 47                	jae    6f8 <malloc+0x98>
    ...
    if(p == freep)
 6b1:	39 05 0c 0c 00 00    	cmp    %eax,0xc0c
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
  return freep;
 6db:	8b 15 0c 0c 00 00    	mov    0xc0c,%edx
 ...
 704:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 707:	89 15 0c 0c 00 00    	mov    %edx,0xc0c
}
 ...
 719:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 0c 0c 00 00 10 	movl   $0xc10,0xc0c
 727:	0c 00 00 
 72a:	c7 05 10 0c 00 00 10 	movl   $0xc10,0xc10
 731:	0c 00 00 
    base.s.size = 0;
 734:	b8 10 0c 00 00       	mov    $0xc10,%eax
 739:	c7 05 14 0c 00 00 00 	movl   $0x0,0xc14
 740:	00 00 00 
...
void* pmalloc(){
 ...
 764:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 767:	68 d9 08 00 00       	push   $0x8d9
 76c:	6a 01                	push   $0x1
 76e:	e8 8d fc ff ff       	call   400 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 773:	8b 1d 18 0c 00 00    	mov    0xc18,%ebx
 ...
 7b3:	ff 35 08 0c 00 00    	pushl  0xc08
 7b9:	e8 7c fb ff ff       	call   33a <sbrk>
 7be:	a3 18 0c 00 00       	mov    %eax,0xc18
    plink_freep->next = 0;
 7c3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 7c9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 7cc:	8b 1d 18 0c 00 00    	mov    0xc18,%ebx
 ...
 7e3:	ff 35 08 0c 00 00    	pushl  0xc08
...
int protect_page(void* ap){
 ...
 810:	a1 18 0c 00 00       	mov    0xc18,%eax
int protect_page(void* ap){
 815:	55                   	push   %ebp

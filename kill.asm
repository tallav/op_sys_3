 ...
 369:	85 d2                	test   %edx,%edx
{
 ...
 397:	f7 f1                	div    %ecx
 399:	0f b6 92 ac 08 00 00 	movzbl 0x8ac(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb a4 08 00 00       	mov    $0x8a4,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 e4 0b 00 00       	mov    0xbe4,%eax
{
 ...
 60d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 60f:	a3 e4 0b 00 00       	mov    %eax,0xbe4
}
 614:	5b                   	pop    %ebx
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 e4 0b 00 00       	mov    %eax,0xbe4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 66c:	8b 15 e4 0b 00 00    	mov    0xbe4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 47                	jae    6f8 <malloc+0x98>
    ...
    if(p == freep)
 6b1:	39 05 e4 0b 00 00    	cmp    %eax,0xbe4
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
  return freep;
 6db:	8b 15 e4 0b 00 00    	mov    0xbe4,%edx
 ...
 704:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 707:	89 15 e4 0b 00 00    	mov    %edx,0xbe4
}
 ...
 719:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 e4 0b 00 00 e8 	movl   $0xbe8,0xbe4
 727:	0b 00 00 
 72a:	c7 05 e8 0b 00 00 e8 	movl   $0xbe8,0xbe8
 731:	0b 00 00 
    base.s.size = 0;
 734:	b8 e8 0b 00 00       	mov    $0xbe8,%eax
 739:	c7 05 ec 0b 00 00 00 	movl   $0x0,0xbec
 740:	00 00 00 
...
void* pmalloc(){
 ...
 767:	8b 1d f0 0b 00 00    	mov    0xbf0,%ebx
 ...
 7de:	a3 f0 0b 00 00       	mov    %eax,0xbf0
    plink_freep->next = 0;
 7e3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 7e9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 7ec:	8b 1d f0 0b 00 00    	mov    0xbf0,%ebx
...
int protect_page(void* ap){
 ...
 806:	a1 f0 0b 00 00       	mov    0xbf0,%eax
int protect_page(void* ap){
...
int pfree(void* ap){
  struct plink *pl = plink_freep;
 850:	a1 f0 0b 00 00       	mov    0xbf0,%eax
int pfree(void* ap){
 855:	55                   	push   %ebp

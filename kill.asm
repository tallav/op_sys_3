 ...
 369:	85 d2                	test   %edx,%edx
{
 ...
 397:	f7 f1                	div    %ecx
 399:	0f b6 92 d8 08 00 00 	movzbl 0x8d8(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb d0 08 00 00       	mov    $0x8d0,%ebx
        while(*s != 0){
...
int protect_page(void* ap){
 ...
 816:	a1 28 0c 00 00       	mov    0xc28,%eax
int protect_page(void* ap){

 ...
 639:	85 d2                	test   %edx,%edx
{
 ...
 667:	f7 f1                	div    %ecx
 669:	0f b6 92 cc 0b 00 00 	movzbl 0xbcc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 884:	e9 8f fe ff ff       	jmp    718 <printf+0x48>
          s = "(null)";
 889:	bb c2 0b 00 00       	mov    $0xbc2,%ebx
        while(*s != 0){
...
void* pmalloc(){
 ...
 a34:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 a37:	68 dd 0b 00 00       	push   $0xbdd
 a3c:	6a 01                	push   $0x1
 a3e:	e8 8d fc ff ff       	call   6d0 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 a43:	8b 1d 20 14 00 00    	mov    0x1420,%ebx
 ...
 a83:	ff 35 f8 0f 00 00    	pushl  0xff8
 a89:	e8 7c fb ff ff       	call   60a <sbrk>
 a8e:	a3 20 14 00 00       	mov    %eax,0x1420
    plink_freep->next = 0;
 a93:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 a99:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 a9c:	8b 1d 20 14 00 00    	mov    0x1420,%ebx
 ...
 ab3:	ff 35 f8 0f 00 00    	pushl  0xff8
...
int protect_page(void* ap){
 ...
 ae6:	a1 20 14 00 00       	mov    0x1420,%eax
int protect_page(void* ap){
...
int pfree(void* ap){
 ...
 b37:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 b3a:	68 e6 0b 00 00       	push   $0xbe6
 b3f:	6a 01                	push   $0x1
 b41:	e8 8a fb ff ff       	call   6d0 <printf>
  struct plink *pl = plink_freep;
 b46:	a1 20 14 00 00       	mov    0x1420,%eax
  while(pl){

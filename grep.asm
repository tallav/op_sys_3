 ...
 236:	31 f6                	xor    %esi,%esi
{
 ...
 24a:	50                   	push   %eax
 24b:	8d 86 00 10 00 00    	lea    0x1000(%esi),%eax
 251:	50                   	push   %eax
 ...
 265:	01 c6                	add    %eax,%esi
    p = buf;
 267:	bb 00 10 00 00       	mov    $0x1000,%ebx
    buf[m] = '\0';
 26c:	c6 86 00 10 00 00 00 	movb   $0x0,0x1000(%esi)
 ...
 2d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(p == buf)
 2d8:	81 fb 00 10 00 00    	cmp    $0x1000,%ebx
 ...
 2ed:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2f0:	2d 00 10 00 00       	sub    $0x1000,%eax
 2f5:	29 c6                	sub    %eax,%esi
      memmove(buf, p, m);
 2f7:	56                   	push   %esi
 2f8:	53                   	push   %ebx
 2f9:	68 00 10 00 00       	push   $0x1000
 ...
 639:	85 d2                	test   %edx,%edx
{
 ...
 667:	f7 f1                	div    %ecx
 669:	0f b6 92 a0 0b 00 00 	movzbl 0xba0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 884:	e9 8f fe ff ff       	jmp    718 <printf+0x48>
          s = "(null)";
 889:	bb 96 0b 00 00       	mov    $0xb96,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8a1:	a1 e0 0f 00 00       	mov    0xfe0,%eax
{
 ...
 8dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 8df:	a3 e0 0f 00 00       	mov    %eax,0xfe0
}
 8e4:	5b                   	pop    %ebx
 8e5:	5e                   	pop    %esi
 8e6:	5f                   	pop    %edi
 ...
 8f6:	72 ce                	jb     8c6 <free+0x26>
{
 ...
 917:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 91a:	a3 e0 0f 00 00       	mov    %eax,0xfe0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 93c:	8b 15 e0 0f 00 00    	mov    0xfe0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 97f:	73 47                	jae    9c8 <malloc+0x98>
    ...
    if(p == freep)
 981:	39 05 e0 0f 00 00    	cmp    %eax,0xfe0
 ...
 9a6:	e8 f5 fe ff ff       	call   8a0 <free>
  return freep;
 9ab:	8b 15 e0 0f 00 00    	mov    0xfe0,%edx
 ...
 9d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 9d7:	89 15 e0 0f 00 00    	mov    %edx,0xfe0
}
 ...
 9e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 9f0:	c7 05 e0 0f 00 00 e4 	movl   $0xfe4,0xfe0
 9f7:	0f 00 00 
 9fa:	c7 05 e4 0f 00 00 e4 	movl   $0xfe4,0xfe4
 a01:	0f 00 00 
    base.s.size = 0;
 a04:	b8 e4 0f 00 00       	mov    $0xfe4,%eax
 a09:	c7 05 e8 0f 00 00 00 	movl   $0x0,0xfe8
 a10:	00 00 00 
...
void* pmalloc(){
 ...
 a37:	8b 1d 00 14 00 00    	mov    0x1400,%ebx
 ...
 a73:	ff 35 c0 0f 00 00    	pushl  0xfc0
 ...
 aa3:	ff 35 c0 0f 00 00    	pushl  0xfc0
 aa9:	e8 5c fb ff ff       	call   60a <sbrk>
 aae:	a3 00 14 00 00       	mov    %eax,0x1400
    plink_freep->next = 0;
 ab3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 ab9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 abc:	8b 1d 00 14 00 00    	mov    0x1400,%ebx
...
int protect_page(void* ap){
 ...
 ad6:	a1 00 14 00 00       	mov    0x1400,%eax
int protect_page(void* ap){
...
int pfree(void* ap){
  struct plink *pl = plink_freep;
 b20:	a1 00 14 00 00       	mov    0x1400,%eax
int pfree(void* ap){
 b25:	55                   	push   %ebp

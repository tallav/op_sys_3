 ...
 639:	85 d2                	test   %edx,%edx
{
 ...
 667:	f7 f1                	div    %ecx
 669:	0f b6 92 bc 0b 00 00 	movzbl 0xbbc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 884:	e9 8f fe ff ff       	jmp    718 <printf+0x48>
          s = "(null)";
 889:	bb b2 0b 00 00       	mov    $0xbb2,%ebx
        while(*s != 0){
...
void* pmalloc(){
 ...
 a83:	ff 35 e8 0f 00 00    	pushl  0xfe8
 ...
 ab3:	ff 35 e8 0f 00 00    	pushl  0xfe8
...
int protect_page(void* ap){
 ...
 ae0:	a1 20 14 00 00       	mov    0x1420,%eax
int protect_page(void* ap){
 ae5:	55                   	push   %ebp
...
int pfree(void* ap){
 ...
 b27:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 b2a:	68 d6 0b 00 00       	push   $0xbd6
 b2f:	6a 01                	push   $0x1
 b31:	e8 9a fb ff ff       	call   6d0 <printf>
  struct plink *pl = plink_freep;
 b36:	a1 20 14 00 00       	mov    0x1420,%eax
  while(pl){

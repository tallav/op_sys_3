  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  f4:	74 42                	je     138 <wc+0x98>
      if(buf[i] == '\n')
  f6:	0f be 87 80 0d 00 00 	movsbl 0xd80(%edi),%eax
        l++;
 ...
 489:	85 d2                	test   %edx,%edx
{
 ...
 4b7:	f7 f1                	div    %ecx
 4b9:	0f b6 92 f0 09 00 00 	movzbl 0x9f0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 6d4:	e9 8f fe ff ff       	jmp    568 <printf+0x48>
          s = "(null)";
 6d9:	bb e7 09 00 00       	mov    $0x9e7,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f1:	a1 60 0d 00 00       	mov    0xd60,%eax
{
 ...
 72d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 72f:	a3 60 0d 00 00       	mov    %eax,0xd60
}
 734:	5b                   	pop    %ebx
 735:	5e                   	pop    %esi
 736:	5f                   	pop    %edi
 ...
 746:	72 ce                	jb     716 <free+0x26>
{
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 60 0d 00 00       	mov    %eax,0xd60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 78c:	8b 15 60 0d 00 00    	mov    0xd60,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cf:	73 47                	jae    818 <malloc+0x98>
    ...
    if(p == freep)
 7d1:	39 05 60 0d 00 00    	cmp    %eax,0xd60
 ...
 7f6:	e8 f5 fe ff ff       	call   6f0 <free>
  return freep;
 7fb:	8b 15 60 0d 00 00    	mov    0xd60,%edx
 ...
 824:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 827:	89 15 60 0d 00 00    	mov    %edx,0xd60
}
 ...
 839:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 60 0d 00 00 64 	movl   $0xd64,0xd60
 847:	0d 00 00 
 84a:	c7 05 64 0d 00 00 64 	movl   $0xd64,0xd64
 851:	0d 00 00 
    base.s.size = 0;
 854:	b8 64 0d 00 00       	mov    $0xd64,%eax
 859:	c7 05 68 0d 00 00 00 	movl   $0x0,0xd68
 860:	00 00 00 
...
void* pmalloc(){
 ...
 887:	8b 1d 80 0f 00 00    	mov    0xf80,%ebx
 88d:	85 db                	test   %ebx,%ebx
 88f:	75 0d                	jne    89e <pmalloc+0x1e>
 891:	eb 5d                	jmp    8f0 <pmalloc+0x70>
 893:	90                   	nop
 ...
 89a:	75 0f                	jne    8ab <pmalloc+0x2b>
 89c:	89 c3                	mov    %eax,%ebx
  while(pl->next){
 89e:	8b 03                	mov    (%ebx),%eax
 8a0:	8b 53 04             	mov    0x4(%ebx),%edx
 8a3:	85 c0                	test   %eax,%eax
 8a5:	75 f1                	jne    898 <pmalloc+0x18>
      pl->isFree = 0;
      return pl;
    }
    pl = pl->next;
 ...
 8a9:	74 15                	je     8c0 <pmalloc+0x40>
    pl->isFree = 0;
 8ab:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    //printf(1, "plink=%d\n", pl->next);
    pl->next->next = 0;
    pl->next->isFree = 0;
    return pl->next;
 ...
 8c3:	ff 35 58 0d 00 00    	pushl  0xd58
 8c9:	e8 8c fb ff ff       	call   45a <sbrk>
 8ce:	89 03                	mov    %eax,(%ebx)
    pl->next->next = 0;
 8d0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return pl->next;
 8d6:	83 c4 10             	add    $0x10,%esp
    pl->next->isFree = 0;
 8d9:	8b 03                	mov    (%ebx),%eax
 8db:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    return pl->next;
 8e2:	8b 1b                	mov    (%ebx),%ebx
}
 ...
 8f3:	ff 35 58 0d 00 00    	pushl  0xd58
 8f9:	e8 5c fb ff ff       	call   45a <sbrk>
 8fe:	a3 80 0f 00 00       	mov    %eax,0xf80
    plink_freep->next = 0;
 903:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 909:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 90c:	8b 1d 80 0f 00 00    	mov    0xf80,%ebx
 912:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
 919:	89 d8                	mov    %ebx,%eax
 91b:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 91e:	c9                   	leave  
 91f:	c3                   	ret    
...
int protect_page(void* ap){
 ...
 926:	a1 80 0f 00 00       	mov    0xf80,%eax
int protect_page(void* ap){
 92b:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 92e:	85 c0                	test   %eax,%eax
 930:	74 18                	je     94a <protect_page+0x2a>
    if(pl == ap){
 932:	39 d0                	cmp    %edx,%eax
 934:	75 0e                	jne    944 <protect_page+0x24>
 936:	eb 20                	jmp    958 <protect_page+0x38>
 938:	90                   	nop
 939:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 940:	39 c2                	cmp    %eax,%edx
 942:	74 14                	je     958 <protect_page+0x38>
      protectPage(pl);
      return 1;
    }
    pl = pl->next;
 ...
 948:	75 f6                	jne    940 <protect_page+0x20>
  }
	return -1;
 ...
 95b:	52                   	push   %edx
 95c:	e8 11 fb ff ff       	call   472 <protectPage>
      return 1;
...
int pfree(void* ap){
  struct plink *pl = plink_freep;
 970:	a1 80 0f 00 00       	mov    0xf80,%eax
int pfree(void* ap){
 975:	55                   	push   %ebp
...
int pfree(void* ap){
 97a:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 97d:	74 13                	je     992 <pfree+0x22>
    if(pl == ap){
 97f:	39 d0                	cmp    %edx,%eax
 981:	75 09                	jne    98c <pfree+0x1c>
 983:	eb 1b                	jmp    9a0 <pfree+0x30>
 985:	8d 76 00             	lea    0x0(%esi),%esi
 988:	39 c2                	cmp    %eax,%edx
 98a:	74 14                	je     9a0 <pfree+0x30>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 999:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 9a0:	c7 42 04 01 00 00 00 	movl   $0x1,0x4(%edx)
      return 1;
 9a7:	b8 01 00 00 00       	mov    $0x1,%eax
}
 9ac:	5d                   	pop    %ebp
 9ad:	c3                   	ret    

  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  f4:	74 42                	je     138 <wc+0x98>
      if(buf[i] == '\n')
  f6:	0f be 87 c0 0d 00 00 	movsbl 0xdc0(%edi),%eax
        l++;
 ...
 489:	85 d2                	test   %edx,%edx
{
 ...
 4b7:	f7 f1                	div    %ecx
 4b9:	0f b6 92 1c 0a 00 00 	movzbl 0xa1c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 6d4:	e9 8f fe ff ff       	jmp    568 <printf+0x48>
          s = "(null)";
 6d9:	bb 13 0a 00 00       	mov    $0xa13,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f1:	a1 a0 0d 00 00       	mov    0xda0,%eax
{
 ...
 72d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 72f:	a3 a0 0d 00 00       	mov    %eax,0xda0
}
 734:	5b                   	pop    %ebx
 735:	5e                   	pop    %esi
 736:	5f                   	pop    %edi
 ...
 746:	72 ce                	jb     716 <free+0x26>
{
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 a0 0d 00 00       	mov    %eax,0xda0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 78c:	8b 15 a0 0d 00 00    	mov    0xda0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cf:	73 47                	jae    818 <malloc+0x98>
    ...
    if(p == freep)
 7d1:	39 05 a0 0d 00 00    	cmp    %eax,0xda0
 ...
 7f6:	e8 f5 fe ff ff       	call   6f0 <free>
  return freep;
 7fb:	8b 15 a0 0d 00 00    	mov    0xda0,%edx
 ...
 824:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 827:	89 15 a0 0d 00 00    	mov    %edx,0xda0
}
 ...
 839:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 a0 0d 00 00 a4 	movl   $0xda4,0xda0
 847:	0d 00 00 
 84a:	c7 05 a4 0d 00 00 a4 	movl   $0xda4,0xda4
 851:	0d 00 00 
    base.s.size = 0;
 854:	b8 a4 0d 00 00       	mov    $0xda4,%eax
 859:	c7 05 a8 0d 00 00 00 	movl   $0x0,0xda8
 860:	00 00 00 
...
void* pmalloc(){
 ...
 884:	83 ec 0c             	sub    $0xc,%esp
  printf(1, "pmalloc\n");
 887:	68 2d 0a 00 00       	push   $0xa2d
 88c:	6a 01                	push   $0x1
 88e:	e8 8d fc ff ff       	call   520 <printf>
  struct plink *pl;
  if(!plink_freep){ // empty list
 893:	8b 1d c0 0f 00 00    	mov    0xfc0,%ebx
 899:	83 c4 10             	add    $0x10,%esp
 89c:	85 db                	test   %ebx,%ebx
 89e:	75 0e                	jne    8ae <pmalloc+0x2e>
 8a0:	eb 2e                	jmp    8d0 <pmalloc+0x50>
 ...
 8aa:	75 0f                	jne    8bb <pmalloc+0x3b>
 8ac:	89 c3                	mov    %eax,%ebx
  while(pl->next){
 8ae:	8b 03                	mov    (%ebx),%eax
 8b0:	8b 53 04             	mov    0x4(%ebx),%edx
 8b3:	85 c0                	test   %eax,%eax
 8b5:	75 f1                	jne    8a8 <pmalloc+0x28>
      pl->isFree = 0;
      return pl;
    }
    pl = pl->next;
 ...
 8b7:	85 d2                	test   %edx,%edx
 8b9:	74 45                	je     900 <pmalloc+0x80>
    pl->isFree = 0;
 8bb:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
 ...
 8d3:	ff 35 90 0d 00 00    	pushl  0xd90
 8d9:	e8 7c fb ff ff       	call   45a <sbrk>
 8de:	a3 c0 0f 00 00       	mov    %eax,0xfc0
    plink_freep->next = 0;
 8e3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    return plink_freep;
 8e9:	83 c4 10             	add    $0x10,%esp
    plink_freep->isFree = 0;
 8ec:	8b 1d c0 0f 00 00    	mov    0xfc0,%ebx
 8f2:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
 8f9:	89 d8                	mov    %ebx,%eax
 8fb:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 8fe:	c9                   	leave  
 8ff:	c3                   	ret    
    pl->next = (struct plink*)sbrk(pageSize);
 900:	83 ec 0c             	sub    $0xc,%esp
 903:	ff 35 90 0d 00 00    	pushl  0xd90
 909:	e8 4c fb ff ff       	call   45a <sbrk>
    pl->next = 0;
 90e:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
    pl->isFree = 0;
 914:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
    return pl->next;
 91b:	83 c4 10             	add    $0x10,%esp
 91e:	31 db                	xor    %ebx,%ebx
 920:	eb a0                	jmp    8c2 <pmalloc+0x42>
...
int protect_page(void* ap){
 ...
 936:	a1 c0 0f 00 00       	mov    0xfc0,%eax
int protect_page(void* ap){
 93b:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 93e:	85 c0                	test   %eax,%eax
 940:	74 18                	je     95a <protect_page+0x2a>
    if(pl == ap){
 942:	39 d0                	cmp    %edx,%eax
 944:	75 0e                	jne    954 <protect_page+0x24>
 946:	eb 20                	jmp    968 <protect_page+0x38>
 948:	90                   	nop
 949:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 950:	39 c2                	cmp    %eax,%edx
 952:	74 14                	je     968 <protect_page+0x38>
      protectPage(pl);
      return 1;
    }
    pl = pl->next;
 ...
 958:	75 f6                	jne    950 <protect_page+0x20>
  }
	return -1;
 ...
 96b:	52                   	push   %edx
 96c:	e8 01 fb ff ff       	call   472 <protectPage>
      return 1;
 971:	83 c4 10             	add    $0x10,%esp
 974:	b8 01 00 00 00       	mov    $0x1,%eax
}
 979:	c9                   	leave  
 97a:	c3                   	ret    
 97b:	90                   	nop
...
int pfree(void* ap){
 ...
 987:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 98a:	68 36 0a 00 00       	push   $0xa36
 98f:	6a 01                	push   $0x1
 991:	e8 8a fb ff ff       	call   520 <printf>
  struct plink *pl = plink_freep;
 996:	a1 c0 0f 00 00       	mov    0xfc0,%eax
  while(pl){
 99b:	83 c4 10             	add    $0x10,%esp
 99e:	85 c0                	test   %eax,%eax
 9a0:	74 18                	je     9ba <pfree+0x3a>
    if(pl == ap){
 9a2:	39 d8                	cmp    %ebx,%eax
 9a4:	75 0e                	jne    9b4 <pfree+0x34>
 9a6:	eb 20                	jmp    9c8 <pfree+0x48>
 9a8:	90                   	nop
 9a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 9b0:	39 c3                	cmp    %eax,%ebx
 9b2:	74 14                	je     9c8 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 9b8:	75 f6                	jne    9b0 <pfree+0x30>
  }
	return -1;
 9ba:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 9bf:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 9c2:	c9                   	leave  
 9c3:	c3                   	ret    
 9c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 9c8:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;
 9cf:	b8 01 00 00 00       	mov    $0x1,%eax
}

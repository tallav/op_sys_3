 ...
 489:	85 d2                	test   %edx,%edx
{
 ...
 4b7:	f7 f1                	div    %ecx
 4b9:	0f b6 92 0c 0a 00 00 	movzbl 0xa0c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 6d4:	e9 8f fe ff ff       	jmp    568 <printf+0x48>
          s = "(null)";
 6d9:	bb 03 0a 00 00       	mov    $0xa03,%ebx
        while(*s != 0){
...
void* pmalloc(){
 ...
 8d3:	ff 35 80 0d 00 00    	pushl  0xd80
 ...
 903:	ff 35 80 0d 00 00    	pushl  0xd80
...
int protect_page(void* ap){
 ...
 930:	a1 c0 0f 00 00       	mov    0xfc0,%eax
int protect_page(void* ap){
 935:	55                   	push   %ebp
...
int protect_page(void* ap){
 93a:	8b 55 08             	mov    0x8(%ebp),%edx
  while(pl){
 93d:	74 13                	je     952 <protect_page+0x22>
    if(pl == ap){
 93f:	39 d0                	cmp    %edx,%eax
 941:	75 09                	jne    94c <protect_page+0x1c>
 943:	eb 1b                	jmp    960 <protect_page+0x30>
 945:	8d 76 00             	lea    0x0(%esi),%esi
 948:	39 c2                	cmp    %eax,%edx
 94a:	74 14                	je     960 <protect_page+0x30>
      // add system call 
      return 1;
    }
    pl = pl->next;
 ...
 950:	75 f6                	jne    948 <protect_page+0x18>
  }
	return -1;
 952:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 957:	5d                   	pop    %ebp
 958:	c3                   	ret    
...
int pfree(void* ap){
 ...
 977:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "pfree\n");
 97a:	68 26 0a 00 00       	push   $0xa26
 97f:	6a 01                	push   $0x1
 981:	e8 9a fb ff ff       	call   520 <printf>
  struct plink *pl = plink_freep;
 986:	a1 c0 0f 00 00       	mov    0xfc0,%eax
  while(pl){
 98b:	83 c4 10             	add    $0x10,%esp
 98e:	85 c0                	test   %eax,%eax
 990:	74 18                	je     9aa <pfree+0x3a>
    if(pl == ap){
 992:	39 d8                	cmp    %ebx,%eax
 994:	75 0e                	jne    9a4 <pfree+0x34>
 996:	eb 20                	jmp    9b8 <pfree+0x48>
 998:	90                   	nop
 999:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 9a0:	39 c3                	cmp    %eax,%ebx
 9a2:	74 14                	je     9b8 <pfree+0x48>
      pl->isFree = 1;
      return 1;
    }
    pl = pl->next;
 ...
 9b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      pl->isFree = 1;
 9b8:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      return 1;
